...
print("    => t3-conservation forces the Hu x Hd block ANTIDIAGONAL.")
print("    *** CORRECTION (BENCH ERROR #13), caught by CODEX and upheld: this")
print("        cell originally concluded 'antidiagonal => rank in {0,2}, rank 1")
print("        IMPOSSIBLE'.  THAT IS A NON-SEQUITUR — an antidiagonal block")
print("        [[0,b],[c,0]] with exactly ONE nonzero entry has RANK 1, and it")
print("        conserves t3 perfectly.  Cartan conservation does NOT exclude")
print("        rank 1.  WHAT DOES: FULL SU(2) INVARIANCE — the invariant pairing")
print("        of two doublets to a singlet is UNIQUE up to scale (eps^{ab}), so")
print("        the block must be lambda*[[0,1],[-1,0]], giving rank 0 or 2 and")
print("        never 1.  THE VERDICT IS UNCHANGED (the observed block IS eps, and")
print("        the count of invariant functionals is still ONE); the STATED")
print("        REASON was too weak and is repaired here.  codex's wording is the")
print("        correct one: 'full SU(2), rather than merely Cartan conservation,")
print("        forces the lambda block to rank zero or two'.")
print("    The observed block is [[0,1],[-1,0]] — the SU(2) epsilon tensor.")
print("    => colour-conservation likewise constrains the D x Dc block; by the")
print("       SAME correction, it is FULL SU(3) invariance (the unique delta^i_j")
print("       contraction), not Cartan colour-weight conservation alone, that")
print("       forces rank in {0, 3}.  The observed block is the delta.")
