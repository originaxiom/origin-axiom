...
PAPER_TITLES = {
 ...
 9: "the manifold group is congruence of level (4) in PSL(2,O_K), index 12, and is not itself a principal congruence subgroup",
 ...
 57: "the door: Q(sqrt-3) ramifies only at 3, its residue field is F_3, pi_1 surjects onto SL(2,3) = 2T in two classes, and McKay(2T) at the faithful 2-dim rep IS the affine E6 diagram (controls: Q8 gives affine D4; no 2I quotient)",
 ...
 35: "the replication shape: an su(3) index replicates fixed colour x su(2) types (sealed cell; the index is trinification structure, NOT a generation index)",
