...
CLAIMS = [
 ...
 ("4",  "the fork is a rank obstruction: the branch carrying Lorentz signature and compact colour has maximal compact f4 of rank four, which no torus element of e6 reaches -- crossing needs an outer automorphism",
        ["B1265"], "settled"),
 ("4",  "the door, verified end to end: Q(sqrt-3) ramifies only at 3 with residue field F_3, SL(2,O/(sqrt-3)) = SL(2,3) = 2T, pi_1(m004) surjects onto 2T in exactly two classes up to automorphism, and the McKay graph of 2T at its faithful 2-dimensional representation IS the affine E6 diagram (7 nodes, 6 edges, marks 1,1,1,2,2,2,3); controls fire -- Q8 gives affine D4 and there is no surjection onto SL(2,5) = 2I, so the door does not open onto E8",
        ["B266", "B1423"], "settled"),
