...
PATH = Path(__file__).resolve().parents[1]/'reports/physical_bridge_2026_09_05/mirror_quartic_normal_form_control_v2.py'
SPEC = importlib.util.spec_from_file_location('physical_bridge_mirror_quartic_control_v2', PATH)
