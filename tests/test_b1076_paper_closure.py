"""B1076 locks -- the paper-closure campaign cannot silently lose an item.
...
LEDGER = os.path.join(ROOT, "frontier", "B1076_paper_closure", "CAMPAIGN.md")
PREREG = os.path.join(ROOT, "frontier", "B1076_paper_closure", "PREREGISTRATION.md")
