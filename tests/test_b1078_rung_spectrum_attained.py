...
RES = os.path.join(HERE, "..", "frontier", "B1078_rung_spectrum_attained", "results.json")
...
def test_the_sample_was_a_strict_subset_of_the_truth(r):
    """B1075's 16 coordinate subsets gave {12,30,78}. If that had been the whole
...
def test_every_independently_banked_rung_value_is_in_the_spectrum(r):
    """12 (B874/B1075), 14 and 18 (B892), 30 (B874/B1075), 46 (B866), 78. None of these
