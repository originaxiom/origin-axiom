...
This `philosophy/` folder holds the **motivation** layer (P000–P008 below + P1–P5 above + the foundations doc).
...
- `P000`–`P007` (here) — the foundational philosophical layer (what-is-not-nothing; architecture-not-furniture;
  necessity-given-chosen-premises; dead-ends-as-boundaries; expansion-is-interaction-born; laws-and-states;
  two-headed-time; maximal-probe-not-seed; non-cancellation-is-Fricke-Vogt), distinct from the P1–P5 argument register above.
