...
\begin{itemize}
  ...
  \item \textbf{Ledger incompatibility:} when the Phase~3 $\theta$-filter is injected
        into the Phase~0 corridor ledger, the resulting combined corridor becomes empty
        (no $\theta$ survives simultaneous application of the Phase~0--2 and Phase~3
        filters). This is treated as evidence against the locked Phase~3 ansatz/target
        combination until the ansatz or external targets are revised.
\end{itemize}
