...
**780 recorded closures — of which 613 are CLASSIFIED by mechanism and
...
| `verified pairwise non-isolation: all 30 actual A1-plane/E6-plane intersections have dimension one. Scope correction 2026-09-06: the element census does not exclude point-like common-stabilizer strata or compute all localized physical matter` | 1 |  |
