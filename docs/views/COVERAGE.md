...
|---|---|---|---|
| arcs with `FINDINGS.md` | **751** | — | 100 % |
| arcs with an authored verdict (W1) | **616** | 751 | 82.0 % |
...
|---|---|---|---|
| **A** | explicit `## Verdict` block — directly extractable | 186 | 24.8 % |
| **B** | no block, but the title carries the verdict | 554 | 73.8 % |
