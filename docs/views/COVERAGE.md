...
|---|---|---|---|
| arcs with `FINDINGS.md` | **748** | — | 100 % |
| arcs with an authored verdict (W1) | **616** | 748 | 82.4 % |
...
|---|---|---|---|
| **A** | explicit `## Verdict` block — directly extractable | 184 | 24.6 % |
| **B** | no block, but the title carries the verdict | 553 | 73.9 % |
