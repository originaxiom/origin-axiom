...
|---|---|---|---|
| arcs with `FINDINGS.md` | **755** | — | 100 % |
| arcs with an authored verdict (W1) | **616** | 755 | 81.6 % |
...
|---|---|---|---|
| **A** | explicit `## Verdict` block — directly extractable | 188 | 24.9 % |
| **B** | no block, but the title carries the verdict | 556 | 73.6 % |
