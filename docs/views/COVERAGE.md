...
|---|---|---|---|
| arcs with `FINDINGS.md` | **752** | — | 100 % |
| arcs with an authored verdict (W1) | **616** | 752 | 81.9 % |
...
|---|---|---|---|
| **A** | explicit `## Verdict` block — directly extractable | 186 | 24.7 % |
| **B** | no block, but the title carries the verdict | 555 | 73.8 % |
