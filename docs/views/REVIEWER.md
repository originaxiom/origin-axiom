...
| words of findings prose | **650,771** |
| test lock files referenced | **601** |
| arcs carrying an authored verdict | **954** (98.7 %) |
| recorded closures | **751** (584 classified, 167 routed-only) |
...
| *(all 31 mechanisms in `CLOSED_DOORS.md`)* | |
