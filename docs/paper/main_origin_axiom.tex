...
\input{act3_frw_observables}
\input{act3_hubble_diagram}

% --- Final discussion / outlook will go here

%------------------------------------------------------------
% Act II: theta* prior from flavour
% (You already have detailed Act II TeX fragments in docs/paper;
%  adapt the paths below to match your repo layout.)
%------------------------------------------------------------
\section{Act II: Flavour constraints and the $\thetastar$ prior}
\label{sec:act2-theta-star}

% Example: break Act II into subsections and input existing files.
% Adjust file names/paths as needed.
% \input{docs/paper/act2_theta_star_section.tex}

%------------------------------------------------------------
% Act II 1/2: Vacuum toy models and microcavity
%------------------------------------------------------------
\section{Act II.5: Vacuum toy models and microcavity}
\label{sec:act2-vacuum-toys}

% Example includes; update to your actual TeX fragment names:
% \input{docs/paper/act2_frw_vacuum_demo.tex}
% \input{docs/paper/act2_frw_from_microcavity.tex}
% \input{docs/paper/act2_lambda_scaling_check.tex}

%------------------------------------------------------------
% Act III: Effective vacuum, FRW toy universe, observables
%------------------------------------------------------------
\section{Act III: Effective vacuum and FRW toy universe}
\label{sec:act3-effective-vacuum}

% Example includes; update to your actual TeX fragment names:
% \input{docs/paper/ACTIII_effective_vacuum_interface.tex}
% \input{docs/paper/ACTIII_frw_observables.tex}
% \input{docs/paper/ACTIII_hubble_diagram.tex}
