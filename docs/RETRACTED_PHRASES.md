...
| 11 | `all 83 members` | **B1235** | Same retraction, as the paper actually worded it (`all $83$ members ... are amphichiral`). Registered separately because the sweep matches phrases, and the paper's wording is not the record's. |
| "all 83 members of the family" (are amphichiral / with no exceptions — the family-wide amphichirality claim of B1181) | B1235, 2026-09-02; the paper's instance found by two fresh-seat reads on 2026-09-09 (S9; E53 instance #30) | **FALSE.** The mirror-isometry test used was orientation-blind; the orientation-aware test gives **38 of 112** amphichiral members, and m004 stands. The paper's observer section carried the sentence a week after the retraction because the sweep did not read `.tex`; the sweep now does, and the paper records the withdrawal in a footnote. |
