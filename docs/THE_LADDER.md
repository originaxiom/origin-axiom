...
| **X11** | Hypercharge **normalisation** — not derivable *in principle* (anomaly conditions are homogeneous) | B951; state it, don't chase it |
...
| **X14** | **L98 one-organ-or-two denied.** Not boundary-condition-robust (periodic → 2, open → 1); one golden-row word; no non-commensurable control; asks a **binary** where B730 forces a **V₄** | full MST/gap redo with silver as control |
