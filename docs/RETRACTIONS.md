...
| The trefoil(5,1) trace-field inheritance reading (Tr τ ∈ ℚ(√5)) | the child-transfer thread | RETRACTED as inheritance — numerator-forced, not inherited | PROGRESS_LOG 2026-07 (the (5,1)-filling control) |
| The "entropy log β" reading of the growth rate | the criticality thread | RETRACTED — primitive subshifts have zero entropy; the quantity is the inflation growth rate | PROGRESS_LOG 2026-07-15 |
| The quadratic-arrow verdict (first form) | the L85 campaign, first pass | RETRACTED — the longitude convention corrected; the arrow re-derived (quadratic stands in corrected form) | B598-P2 + the freshness addendum D1–D10 |
| The Kubota–Leopoldt attribution claim | the dictionary thread | RETRACTED with the discriminating fact computed | REVIEWS (the 2026-07-15 sweep) |
