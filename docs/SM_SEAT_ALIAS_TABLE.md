...
| **B1400** | **TAKEN 2026-09-13** — `the_six_sweeps_intaken` (the chat1 SWEEPS audit, verified). *(This row previously read “this bench's next free number”; it is now spent, and **B1401** is spent too — `the_kappa_lower_bound`, 2026-09-13 — and **B1402** is spent too — `the_three_cuts_are_one`, 2026-09-13 — and **B1403** is spent too — `the_conductors_domain`, 2026-09-13 — so **B1404** is next.)* The reasoning that opened it stands: B1349 exhausted the run below the reserved block, and B1326–B1349 had been banked past the stale “next free = B1325” line this row replaces. B1400 is clear of **every** reserved range on this table (B1278–B1289, B1300–B1301, B1308–B1319, B1350–B1399), so it needs no grant from the other seat — recorded here rather than asked for by relay, per **E71**'s fix rule (*reserved ranges are granted in the alias table, not by relay alone*). Arcs B1400+ are this bench's; the SM seat's block is untouched. | — |
