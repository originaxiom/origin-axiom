...
> Last generated: 2026-08-20 from 996 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 996 frontier probes; status {'open': 63, 'banked': 657, 'dead': 257, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 229x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(566), firewall(553), eisenstein(525), figure_eight(416), metallic(405), trace_map(381)
  recurrence is: structural-invariant 3319 mentions | conserved-integral 229 | TOOL 381
...
|---|---|---|---|---|---|---|
| golden | 566 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| amphichiral_cp | 341 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| kappa | 229 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **229** probes (22%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3319** mentions — invariants of the object's transforms.
...
| observable | 38 | golden | golden(29), metallic(19), torsion(18), firewall(17) |
