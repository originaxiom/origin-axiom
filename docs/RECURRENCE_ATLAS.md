...
> Last generated: 2026-07-29 from 737 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 737 frontier probes; status {'banked': 497, 'dead': 171, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 189x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(479), firewall(475), eisenstein(404), figure_eight(354), metallic(345), trace_map(337)
  recurrence is: structural-invariant 2694 mentions | conserved-integral 189 | TOOL 337
...
| kappa | 189 | 25% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2694** mentions — invariants of the object's transforms.
