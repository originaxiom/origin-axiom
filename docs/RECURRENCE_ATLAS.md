...
THE RECURRENCE ATLAS -- context card
  ...
  top recurring motifs: golden(655), eisenstein(648), firewall(626), figure_eight(493), metallic(433), amphichiral_cp(427)
  recurrence is: structural-invariant 4504 mentions | conserved-integral 262 | TOOL 426
...
| figure_eight | 493 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 433 | 36% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| amphichiral_cp | 427 | 36% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4504** mentions — invariants of the object's transforms.
