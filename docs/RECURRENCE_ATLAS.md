...
> Last generated: 2026-08-22 from 1034 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1034 frontier probes; status {'open': 63, 'banked': 689, 'dead': 263, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 234x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(584), firewall(560), eisenstein(547), figure_eight(425), metallic(417), trace_map(393)
  recurrence is: structural-invariant 3413 mentions | conserved-integral 234 | TOOL 393
...
|---|---|---|---|---|---|---|
| golden | 584 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 560 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 547 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| lorentzian | 186 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3413** mentions — invariants of the object's transforms.
