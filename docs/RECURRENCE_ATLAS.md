...
> Last generated: 2026-07-25 from 716 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 716 frontier probes; status {'banked': 481, 'dead': 167, 'open': 51, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 188x, 26%) -- genuine unity, MUST recur
  top recurring motifs: firewall(471), golden(468), eisenstein(392), figure_eight(340), metallic(339), trace_map(332)
  recurrence is: structural-invariant 2638 mentions | conserved-integral 188 | TOOL 332
...
|---|---|---|---|---|---|---|
| firewall | 471 | 65% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 468 | 65% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 392 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 340 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 339 | 47% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 332 | 46% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 267 | 37% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| dickson_tower | 100 | 13% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2638** mentions — invariants of the object's transforms.
