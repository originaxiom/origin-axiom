...
> Last generated: 2026-07-29 from 727 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 727 frontier probes; status {'banked': 491, 'dead': 167, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 188x, 25%) -- genuine unity, MUST recur
  top recurring motifs: firewall(474), golden(472), eisenstein(400), figure_eight(348), metallic(342), trace_map(333)
  recurrence is: structural-invariant 2664 mentions | conserved-integral 188 | TOOL 333
...
| golden | 472 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 400 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 348 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 342 | 47% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2664** mentions — invariants of the object's transforms.
