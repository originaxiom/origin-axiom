...
> Last generated: 2026-08-28 from 1088 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1088 frontier probes; status {'open': 63, 'banked': 722, 'dead': 283, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 241x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(619), firewall(600), eisenstein(590), figure_eight(456), metallic(420), trace_map(403)
  recurrence is: structural-invariant 3597 mentions | conserved-integral 241 | TOOL 403
  the honest split: the trace-map TOOL is in 403 probes (37%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
| firewall | 600 | 55% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 590 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 456 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 420 | 38% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 403 | 37% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 387 | 35% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 333 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3597** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **403** probes (37%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
