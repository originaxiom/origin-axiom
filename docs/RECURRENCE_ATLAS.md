...
> Last generated: 2026-07-18 from 629 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 629 frontier probes; status {'banked': 427, 'dead': 137, 'open': 48, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 180x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(424), golden(406), eisenstein(327), metallic(311), trace_map(294), figure_eight(285)
  recurrence is: structural-invariant 2319 mentions | conserved-integral 180 | TOOL 294
...
|---|---|---|---|---|---|---|
| firewall | 424 | 67% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 406 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 327 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| figure_eight | 285 | 45% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2319** mentions — invariants of the object's transforms.
