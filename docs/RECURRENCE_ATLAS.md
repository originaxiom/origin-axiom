...
> Last generated: 2026-08-12 from 967 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 967 frontier probes; status {'open': 62, 'banked': 633, 'dead': 252, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 231x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(554), firewall(547), eisenstein(509), figure_eight(411), metallic(408), trace_map(389)
  recurrence is: structural-invariant 3267 mentions | conserved-integral 231 | TOOL 389
  the honest split: the trace-map TOOL is in 389 probes (40%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 554 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 547 | 56% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 509 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 411 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 408 | 42% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 389 | 40% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 316 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 309 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| kappa | 231 | 23% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| wrt_quantum | 229 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 214 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 171 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| dickson_tower | 112 | 11% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| symplectic | 99 | 10% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| apolynomial | 78 | 8% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
| markov_cubic | 74 | 7% | invariant | structural | topology | the trace-triple SURFACE the trace map acts on: the Markov/Fricke cubic x^2+y^2+z^2-xyz=c and SL(2,Z) triples (tr A, tr B, tr AB). Deliberately EXCLUDES the bare phrase 'character variety', which B824 measured at 13.8%% of the corpus -- this programme's subject matter, not a topic within it |
| quasicrystal | 68 | 7% | dynamics | structural | quantum | the Fibonacci quasicrystal / Suto / Damanik-Gorodetski |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **231** probes (23%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3267** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **389** probes (40%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| cancellation | 49 | golden | golden(31), firewall(29), eisenstein(28), trace_map(22) |
| selector | 19 | firewall | firewall(13), trace_map(12), eisenstein(12), golden(12) |
| measure | 96 | golden | golden(51), eisenstein(47), firewall(46), figure_eight(37) |
| units_scale | 97 | firewall | firewall(66), golden(62), metallic(52), eisenstein(48) |
| gauge_dict | 56 | eisenstein | eisenstein(34), firewall(32), amphichiral_cp(28), figure_eight(28) |
| particle_dict | 76 | eisenstein | eisenstein(54), firewall(52), z3_generation(49), golden(45) |
| spacetime_3p1 | 108 | golden | golden(66), figure_eight(66), eisenstein(61), trace_map(55) |
...
| B1050 | 19 | banked | two_ends+physics_bridge+symplectic_casimir | arithmetic, dynamics, geometry, meta, physics, topology |
