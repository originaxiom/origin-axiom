...
> Last generated: 2026-08-22 from 1036 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1036 frontier probes; status {'open': 63, 'banked': 691, 'dead': 263, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 234x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(586), firewall(562), eisenstein(549), figure_eight(425), metallic(417), trace_map(395)
  recurrence is: structural-invariant 3420 mentions | conserved-integral 234 | TOOL 395
...
| eisenstein | 549 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| lorentzian | 188 | 18% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3420** mentions — invariants of the object's transforms.
...
| gauge_dict | 60 | eisenstein | eisenstein(36), firewall(34), golden(29), amphichiral_cp(29) |
