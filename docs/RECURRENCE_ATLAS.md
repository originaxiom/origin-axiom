...
> Last generated: 2026-08-27 from 1072 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1072 frontier probes; status {'open': 63, 'banked': 717, 'dead': 272, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 239x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(611), firewall(586), eisenstein(579), figure_eight(446), metallic(419), trace_map(401)
  recurrence is: structural-invariant 3547 mentions | conserved-integral 239 | TOOL 401
...
| firewall | 586 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 579 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3547** mentions — invariants of the object's transforms.
