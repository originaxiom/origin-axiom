...
> Last generated: 2026-08-10 from 934 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 934 frontier probes; status {'open': 60, 'banked': 613, 'dead': 242, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 220x, 23%) -- genuine unity, MUST recur
  top recurring motifs: firewall(538), golden(537), eisenstein(493), figure_eight(403), metallic(394), trace_map(371)
  recurrence is: structural-invariant 3172 mentions | conserved-integral 220 | TOOL 371
...
| golden | 537 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 493 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 403 | 43% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 394 | 42% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 371 | 39% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 308 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3172** mentions — invariants of the object's transforms.
...
| measure | 85 | golden | golden(48), firewall(45), eisenstein(42), figure_eight(36) |
| units_scale | 94 | firewall | firewall(66), golden(60), metallic(51), eisenstein(47) |
...
| spacetime_3p1 | 106 | golden | figure_eight(66), golden(65), eisenstein(61), trace_map(54) |
