...
> Last generated: 2026-08-03 from 783 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 783 frontier probes; status {'banked': 510, 'dead': 200, 'open': 54, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 201x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(493), firewall(483), eisenstein(421), figure_eight(368), metallic(359), trace_map(347)
  recurrence is: structural-invariant 2841 mentions | conserved-integral 201 | TOOL 347
...
| firewall | 483 | 61% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 421 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| torsion | 283 | 36% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 259 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| z3_generation | 159 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 136 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2841** mentions — invariants of the object's transforms.
...
| gauge_dict | 43 | firewall | firewall(29), eisenstein(29), figure_eight(26), golden(25) |
