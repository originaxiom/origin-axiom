...
> Last generated: 2026-08-11 from 948 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 948 frontier probes; status {'open': 60, 'banked': 621, 'dead': 248, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 221x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(543), firewall(538), eisenstein(499), figure_eight(403), metallic(396), trace_map(371)
  recurrence is: structural-invariant 3196 mentions | conserved-integral 221 | TOOL 371
...
| eisenstein | 499 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3196** mentions — invariants of the object's transforms.
