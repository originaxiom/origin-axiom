...
> Last generated: 2026-09-17 from 1249 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1249 frontier probes; status {'open': 70, 'banked': 817, 'dead': 338, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 281x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(706), golden(696), firewall(642), figure_eight(547), amphichiral_cp(477), metallic(466)
  recurrence is: structural-invariant 4989 mentions | conserved-integral 281 | TOOL 456
  the honest split: the trace-map TOOL is in 456 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| eisenstein | 706 | 56% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| golden | 696 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 642 | 51% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 547 | 43% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| amphichiral_cp | 477 | 38% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| metallic | 466 | 37% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 456 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| closing | 394 | 31% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
| coupling | 392 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
| torsion | 382 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| z3_generation | 323 | 25% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| measurement | 310 | 24% | question | no | dynamics | collapse, decoherence, the measurement postulate as a structural shape rather than an added axiom |
| wrt_quantum | 290 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 281 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| lorentzian | 223 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| choice | 191 | 15% | question | structural | arithmetic | the residual bit(s): the torsor of closings, the basepoint bit, what the object can and cannot select (A7/B766/B1183/B1225) |
| symplectic | 129 | 10% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| dickson_tower | 127 | 10% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
...
| markov_cubic | 84 | 6% | invariant | structural | topology | the trace-triple SURFACE the trace map acts on: the Markov/Fricke cubic x^2+y^2+z^2-xyz=c and SL(2,Z) triples (tr A, tr B, tr AB). Deliberately EXCLUDES the bare phrase 'character variety', which B824 measured at 13.8%% of the corpus -- this programme's subject matter, not a topic within it |
| action | 80 | 6% | question | structural | dynamics | is there a least-action principle, and at which step -- the variational structure the object supplies rather than one lifted onto it (B6's derived potential, B21's bracket, B1341's theorem that the half step is generated by no Lagrangian and the monodromy is) |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **281** probes (22%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4989** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **456** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| cancellation | 65 | golden | golden(41), eisenstein(40), firewall(35), trace_map(28) |
...
| particle_dict | 108 | eisenstein | eisenstein(78), z3_generation(74), golden(64), firewall(63) |
| spacetime_3p1 | 145 | eisenstein | eisenstein(88), golden(83), figure_eight(79), closing(70) |
| observable | 50 | golden | golden(38), coupling(27), measurement(25), eisenstein(24) |
