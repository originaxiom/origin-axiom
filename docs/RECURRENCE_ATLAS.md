...
> Last generated: 2026-07-18 from 625 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 625 frontier probes; status {'banked': 425, 'dead': 136, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 180x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(420), golden(403), eisenstein(325), metallic(309), trace_map(294), figure_eight(283)
  recurrence is: structural-invariant 2306 mentions | conserved-integral 180 | TOOL 294
...
|---|---|---|---|---|---|---|
| firewall | 420 | 67% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 403 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 325 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2306** mentions — invariants of the object's transforms.
