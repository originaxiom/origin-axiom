...
> Last generated: 2026-08-20 from 993 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 993 frontier probes; status {'open': 65, 'banked': 649, 'dead': 258, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 227x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(563), firewall(549), eisenstein(522), figure_eight(412), metallic(400), trace_map(377)
  recurrence is: structural-invariant 3296 mentions | conserved-integral 227 | TOOL 377
...
|---|---|---|---|---|---|---|
| golden | 563 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3296** mentions — invariants of the object's transforms.
