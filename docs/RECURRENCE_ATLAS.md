...
> Last generated: 2026-08-09 from 918 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 918 frontier probes; status {'open': 60, 'banked': 602, 'dead': 237, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 219x, 23%) -- genuine unity, MUST recur
  top recurring motifs: firewall(534), golden(526), eisenstein(482), figure_eight(399), metallic(388), trace_map(367)
  recurrence is: structural-invariant 3125 mentions | conserved-integral 219 | TOOL 367
  the honest split: the trace-map TOOL is in 367 probes (39%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 534 | 58% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 526 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 482 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 399 | 43% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 388 | 42% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 367 | 39% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 301 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 299 | 32% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| z3_generation | 206 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3125** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **367** probes (39%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| measure | 81 | golden | golden(44), firewall(44), eisenstein(39), figure_eight(34) |
