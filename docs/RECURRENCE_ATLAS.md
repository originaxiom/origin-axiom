...
> Last generated: 2026-08-02 from 778 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 778 frontier probes; status {'banked': 507, 'dead': 198, 'open': 54, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 200x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(492), firewall(483), eisenstein(417), figure_eight(367), metallic(358), trace_map(347)
  recurrence is: structural-invariant 2827 mentions | conserved-integral 200 | TOOL 347
...
|---|---|---|---|---|---|---|
| golden | 492 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 483 | 62% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 417 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 367 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 358 | 46% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 347 | 44% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 282 | 36% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2827** mentions — invariants of the object's transforms.
