...
> Last generated: 2026-08-28 from 1092 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1092 frontier probes; status {'open': 63, 'banked': 723, 'dead': 285, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 243x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(621), firewall(603), eisenstein(594), figure_eight(458), metallic(421), trace_map(403)
  recurrence is: structural-invariant 3614 mentions | conserved-integral 243 | TOOL 403
...
| firewall | 603 | 55% | structure | structural | meta | the firewall / structural theorem / form-not-values |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3614** mentions — invariants of the object's transforms.
