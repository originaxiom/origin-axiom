...
> Last generated: 2026-09-03 from 1150 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1150 frontier probes; status {'open': 66, 'banked': 755, 'dead': 307, 'dormant': 22}
  the ONE conserved first integral: kappa (recurs 255x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(646), eisenstein(630), firewall(621), figure_eight(485), metallic(430), amphichiral_cp(420)
  recurrence is: structural-invariant 3779 mentions | conserved-integral 255 | TOOL 418
...
| eisenstein | 630 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| torsion | 352 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| lorentzian | 207 | 18% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3779** mentions — invariants of the object's transforms.
