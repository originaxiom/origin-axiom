...
> Last generated: 2026-07-02 from 348 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 348 frontier probes; status {'banked': 236, 'dead': 56, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(229), golden(210), trace_map(200), metallic(190), figure_eight(185), eisenstein(175)
  recurrence is: structural-invariant 1275 mentions | conserved-integral 98 | TOOL 200
  the honest split: the trace-map TOOL is in 200 probes (57%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 229 | 65% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 210 | 60% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| trace_map | 200 | 57% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| metallic | 190 | 54% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| figure_eight | 185 | 53% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| eisenstein | 175 | 50% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| torsion | 94 | 27% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 87 | 25% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| dickson_tower | 77 | 22% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| z3_generation | 67 | 19% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| symplectic | 65 | 18% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| lorentzian | 57 | 16% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1275** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **200** probes (57%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| particle_dict | 27 | eisenstein | eisenstein(24), firewall(24), z3_generation(21), golden(18) |
| spacetime_3p1 | 55 | metallic | figure_eight(39), metallic(37), trace_map(35), dickson_tower(35) |
| observable | 4 | firewall | firewall(4), wrt_quantum(3), metallic(2), eisenstein(2) |
