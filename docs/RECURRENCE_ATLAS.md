...
> Last generated: 2026-09-16 from 1241 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1241 frontier probes; status {'open': 70, 'banked': 814, 'dead': 333, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 280x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(700), golden(691), firewall(642), figure_eight(539), amphichiral_cp(471), metallic(463)
  recurrence is: structural-invariant 4953 mentions | conserved-integral 280 | TOOL 453
...
|---|---|---|---|---|---|---|
| eisenstein | 700 | 56% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| figure_eight | 539 | 43% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| closing | 390 | 31% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
...
| torsion | 380 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| z3_generation | 320 | 25% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| wrt_quantum | 288 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
| dickson_tower | 124 | 9% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4953** mentions — invariants of the object's transforms.
...
| particle_dict | 107 | eisenstein | eisenstein(77), z3_generation(73), golden(63), firewall(63) |
