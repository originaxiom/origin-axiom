...
> Last generated: 2026-08-11 from 949 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 949 frontier probes; status {'open': 60, 'banked': 622, 'dead': 248, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 221x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(544), firewall(538), eisenstein(500), figure_eight(403), metallic(396), trace_map(371)
  recurrence is: structural-invariant 3200 mentions | conserved-integral 221 | TOOL 371
...
|---|---|---|---|---|---|---|
| golden | 544 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 538 | 56% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 500 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| lorentzian | 171 | 18% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3200** mentions — invariants of the object's transforms.
