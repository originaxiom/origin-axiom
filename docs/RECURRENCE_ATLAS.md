...
> Last generated: 2026-07-29 from 730 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 730 frontier probes; status {'banked': 493, 'dead': 168, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 188x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(475), firewall(474), eisenstein(402), figure_eight(350), metallic(342), trace_map(334)
  recurrence is: structural-invariant 2672 mentions | conserved-integral 188 | TOOL 334
  the honest split: the trace-map TOOL is in 334 probes (45%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 475 | 65% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 474 | 64% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 402 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 350 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 342 | 46% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 334 | 45% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 272 | 37% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 245 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2672** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **334** probes (45%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
