...
> Last generated: 2026-08-01 from 767 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 767 frontier probes; status {'banked': 505, 'dead': 190, 'open': 54, 'dormant': 18}
  ...
  recurrence is: structural-invariant 2790 mentions | conserved-integral 199 | TOOL 341
...
| torsion | 279 | 36% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| lorentzian | 130 | 16% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2790** mentions — invariants of the object's transforms.
