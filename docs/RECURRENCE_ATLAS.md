...
> Last generated: 2026-08-21 from 1024 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1024 frontier probes; status {'open': 63, 'banked': 681, 'dead': 261, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 234x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(577), firewall(557), eisenstein(540), figure_eight(424), metallic(413), trace_map(391)
  recurrence is: structural-invariant 3390 mentions | conserved-integral 234 | TOOL 391
...
|---|---|---|---|---|---|---|
| golden | 577 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| metallic | 413 | 40% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| lorentzian | 183 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3390** mentions — invariants of the object's transforms.
