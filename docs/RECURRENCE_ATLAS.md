...
> Last generated: 2026-08-10 from 927 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 927 frontier probes; status {'open': 60, 'banked': 607, 'dead': 241, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 220x, 23%) -- genuine unity, MUST recur
  top recurring motifs: firewall(537), golden(533), eisenstein(490), figure_eight(402), metallic(393), trace_map(371)
  recurrence is: structural-invariant 3155 mentions | conserved-integral 220 | TOOL 371
  the honest split: the trace-map TOOL is in 371 probes (40%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 537 | 57% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 533 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 490 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 402 | 43% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 393 | 42% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 371 | 40% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 304 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 301 | 32% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 225 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3155** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **371** probes (40%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
