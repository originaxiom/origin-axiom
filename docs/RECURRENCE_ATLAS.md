...
> Last generated: 2026-08-19 from 989 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 989 frontier probes; status {'open': 64, 'banked': 648, 'dead': 256, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 227x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(561), firewall(549), eisenstein(521), figure_eight(411), metallic(400), trace_map(375)
  recurrence is: structural-invariant 3290 mentions | conserved-integral 227 | TOOL 375
  the honest split: the trace-map TOOL is in 375 probes (37%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 561 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 549 | 55% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 521 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 411 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 400 | 40% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 375 | 37% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
...
- **The hammer (selection effect):** the trace-map **tool** appears in **375** probes (37%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| units_scale | 100 | firewall | firewall(68), golden(61), metallic(51), eisenstein(48) |
