...
> Last generated: 2026-07-18 from 615 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 615 frontier probes; status {'banked': 418, 'dead': 133, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 177x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(415), golden(394), eisenstein(319), metallic(304), trace_map(294), figure_eight(279)
  recurrence is: structural-invariant 2268 mentions | conserved-integral 177 | TOOL 294
...
| golden | 394 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 319 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| metallic | 304 | 49% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| wrt_quantum | 158 | 25% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 126 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2268** mentions — invariants of the object's transforms.
