...
THE RECURRENCE ATLAS -- context card
  ...
  top recurring motifs: eisenstein(669), golden(668), firewall(630), figure_eight(509), amphichiral_cp(442), metallic(439)
  recurrence is: structural-invariant 4621 mentions | conserved-integral 266 | TOOL 435
...
|---|---|---|---|---|---|---|
| eisenstein | 669 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| metallic | 439 | 36% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| z3_generation | 295 | 24% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4621** mentions — invariants of the object's transforms.
