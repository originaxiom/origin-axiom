...
> Last generated: 2026-08-27 from 1069 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1069 frontier probes; status {'open': 63, 'banked': 715, 'dead': 271, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 238x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(609), firewall(584), eisenstein(576), figure_eight(445), metallic(419), trace_map(400)
  recurrence is: structural-invariant 3538 mentions | conserved-integral 238 | TOOL 400
...
|---|---|---|---|---|---|---|
| golden | 609 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 584 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
...
| amphichiral_cp | 377 | 35% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3538** mentions — invariants of the object's transforms.
