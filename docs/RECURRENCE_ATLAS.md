...
> Last generated: 2026-09-06 from 1176 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1176 frontier probes; status {'open': 67, 'banked': 771, 'dead': 315, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 263x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(657), eisenstein(651), firewall(626), figure_eight(494), metallic(433), amphichiral_cp(428)
  recurrence is: structural-invariant 4514 mentions | conserved-integral 263 | TOOL 427
...
|---|---|---|---|---|---|---|
| golden | 657 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 651 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| firewall | 626 | 53% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 494 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 433 | 36% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| amphichiral_cp | 428 | 36% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| trace_map | 427 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| coupling | 365 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
| torsion | 357 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| closing | 349 | 29% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
...
| z3_generation | 280 | 23% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| dickson_tower | 110 | 9% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4514** mentions — invariants of the object's transforms.
