...
> Last generated: 2026-09-08 from 1188 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1188 frontier probes; status {'open': 67, 'banked': 778, 'dead': 319, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 266x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(664), eisenstein(663), firewall(629), figure_eight(504), amphichiral_cp(439), metallic(435)
  recurrence is: structural-invariant 4584 mentions | conserved-integral 266 | TOOL 433
  the honest split: the trace-map TOOL is in 433 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
| eisenstein | 663 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| firewall | 629 | 52% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 504 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| trace_map | 433 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| coupling | 368 | 30% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
...
| z3_generation | 290 | 24% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| dickson_tower | 114 | 9% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4584** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **433** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| particle_dict | 101 | eisenstein | eisenstein(72), z3_generation(67), firewall(62), golden(61) |
