...
> Last generated: 2026-07-28 from 725 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 725 frontier probes; status {'banked': 490, 'dead': 167, 'open': 51, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 188x, 25%) -- genuine unity, MUST recur
  top recurring motifs: firewall(474), golden(472), eisenstein(400), figure_eight(347), metallic(341), trace_map(333)
  recurrence is: structural-invariant 2663 mentions | conserved-integral 188 | TOOL 333
...
| figure_eight | 347 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2663** mentions — invariants of the object's transforms.
