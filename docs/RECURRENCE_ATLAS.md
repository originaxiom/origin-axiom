...
> Last generated: 2026-08-27 from 1078 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1078 frontier probes; status {'open': 63, 'banked': 718, 'dead': 277, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 240x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(613), firewall(590), eisenstein(582), figure_eight(450), metallic(420), trace_map(401)
  recurrence is: structural-invariant 3562 mentions | conserved-integral 240 | TOOL 401
...
| firewall | 590 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 582 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3562** mentions — invariants of the object's transforms.
