...
> Last generated: 2026-08-28 from 1089 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1089 frontier probes; status {'open': 63, 'banked': 722, 'dead': 283, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 241x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(619), firewall(600), eisenstein(591), figure_eight(457), metallic(420), trace_map(403)
  recurrence is: structural-invariant 3599 mentions | conserved-integral 241 | TOOL 403
...
| eisenstein | 591 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| amphichiral_cp | 388 | 35% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3599** mentions — invariants of the object's transforms.
