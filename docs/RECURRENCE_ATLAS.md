...
> Last generated: 2026-07-13 from 522 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 522 frontier probes; status {'banked': 345, 'dead': 113, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 139x, 26%) -- genuine unity, MUST recur
  top recurring motifs: firewall(378), golden(330), metallic(264), trace_map(262), eisenstein(255), figure_eight(248)
  recurrence is: structural-invariant 1935 mentions | conserved-integral 139 | TOOL 262
...
|---|---|---|---|---|---|---|
| firewall | 378 | 72% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 330 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| metallic | 264 | 50% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 262 | 50% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| eisenstein | 255 | 48% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 248 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| torsion | 183 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 159 | 30% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 139 | 26% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| wrt_quantum | 127 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 102 | 19% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 96 | 18% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1935** mentions — invariants of the object's transforms.
...
| units_scale | 62 | firewall | firewall(52), golden(42), trace_map(35), metallic(35) |
...
| numerology | 18 | firewall | firewall(15), golden(14), metallic(13), torsion(13) |
