...
> Last generated: 2026-09-09 from 1195 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1195 frontier probes; status {'open': 68, 'banked': 784, 'dead': 319, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 266x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(670), golden(668), firewall(630), figure_eight(509), amphichiral_cp(442), metallic(440)
  recurrence is: structural-invariant 4627 mentions | conserved-integral 266 | TOOL 436
  the honest split: the trace-map TOOL is in 436 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| eisenstein | 670 | 56% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| golden | 668 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 630 | 52% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 509 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| amphichiral_cp | 442 | 36% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| metallic | 440 | 36% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 436 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| coupling | 374 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
| torsion | 364 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| closing | 362 | 30% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
| z3_generation | 296 | 24% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| measurement | 289 | 24% | question | no | dynamics | collapse, decoherence, the measurement postulate as a structural shape rather than an added axiom |
| wrt_quantum | 277 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 266 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| lorentzian | 213 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| choice | 182 | 15% | question | structural | arithmetic | the residual bit(s): the torsor of closings, the basepoint bit, what the object can and cannot select (A7/B766/B1183/B1225) |
| dickson_tower | 116 | 9% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| symplectic | 113 | 9% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| monoid | 93 | 7% | question | structural | dynamics | End(F2) beyond the units: the four Hopfian-det strata, the non-invertible verbs the programme has never computed |
| apolynomial | 84 | 7% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
...
| quasicrystal | 70 | 5% | dynamics | structural | quantum | the Fibonacci quasicrystal / Suto / Damanik-Gorodetski |
| naming | 42 | 3% | question | structural | arithmetic | self-reference, the quine, self-name vs self-sign -- naming and choosing proved complementary (B762/B1184) |
| five_web | 34 | 2% | arithmetic | structural | arithmetic | the '5' recurrence web (H2): 40a1, conductor 40, Pisano |
| hyperbolicity_split | 29 | 2% | structure | structural | topology | the hyperbolicity-split motif (H4): object on both sides of the divide |

### The honest split — unity vs the hammer

- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **266** probes (22%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4627** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **436** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| cancellation | 63 | golden | golden(40), eisenstein(38), firewall(35), trace_map(28) |
| selector | 23 | eisenstein | eisenstein(16), golden(13), figure_eight(12), firewall(12) |
| measure | 118 | eisenstein | eisenstein(63), golden(62), firewall(57), measurement(51) |
| units_scale | 113 | firewall | firewall(76), golden(67), eisenstein(60), metallic(54) |
| gauge_dict | 66 | eisenstein | eisenstein(41), firewall(34), golden(33), amphichiral_cp(32) |
| particle_dict | 102 | eisenstein | eisenstein(73), z3_generation(68), firewall(63), golden(61) |
| spacetime_3p1 | 138 | eisenstein | eisenstein(83), golden(80), figure_eight(75), trace_map(68) |
...
|---|---|---|---|---|
| B497 | 25 | banked | two_ends+object=dynamics+physics_bridge+quantum_meeting+symplectic_casimir | arithmetic, dynamics, geometry, meta, physics, quantum, topology |
...
| B1297 | 20 | banked | two_ends+object=dynamics+symplectic_casimir | arithmetic, dynamics, geometry, meta, physics, representation, topology |
...
| B1296 | 19 | dead | two_ends+object=dynamics+physics_bridge+quantum_meeting | arithmetic, dynamics, meta, physics, quantum, topology |
...
|---|---|
| source_free | 1/3 |
| bridge_construction | 11/23 |
| measure | 118/199 |
| gauge_dict | 66/107 |
| numerology | 25/39 |
| spacetime_3p1 | 138/215 |
| selector | 23/35 |
| units_scale | 113/168 |
