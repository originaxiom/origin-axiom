...
> Last generated: 2026-07-12 from 514 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 514 frontier probes; status {'banked': 340, 'dead': 110, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 137x, 26%) -- genuine unity, MUST recur
  top recurring motifs: firewall(374), golden(324), metallic(260), trace_map(258), eisenstein(252), figure_eight(246)
  recurrence is: structural-invariant 1907 mentions | conserved-integral 137 | TOOL 258
...
|---|---|---|---|---|---|---|
| firewall | 374 | 72% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 324 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| metallic | 260 | 50% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| lorentzian | 94 | 18% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1907** mentions — invariants of the object's transforms.
