...
> Last generated: 2026-09-08 from 1192 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1192 frontier probes; status {'open': 67, 'banked': 782, 'dead': 319, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 266x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(667), eisenstein(667), firewall(630), figure_eight(507), amphichiral_cp(441), metallic(437)
  recurrence is: structural-invariant 4611 mentions | conserved-integral 266 | TOOL 435
...
|---|---|---|---|---|---|---|
| golden | 667 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 667 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| coupling | 371 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
| torsion | 363 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| wrt_quantum | 275 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 266 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| lorentzian | 212 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4611** mentions — invariants of the object's transforms.
