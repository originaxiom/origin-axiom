...
> Last generated: 2026-08-29 from 1109 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1109 frontier probes; status {'open': 63, 'banked': 738, 'dead': 287, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 251x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(624), firewall(611), eisenstein(603), figure_eight(462), metallic(423), trace_map(407)
  recurrence is: structural-invariant 3655 mentions | conserved-integral 251 | TOOL 407
...
| firewall | 611 | 55% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 603 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 462 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 404 | 36% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3655** mentions — invariants of the object's transforms.
