...
> Last generated: 2026-08-27 from 1073 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1073 frontier probes; status {'open': 63, 'banked': 717, 'dead': 273, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 239x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(611), firewall(587), eisenstein(579), figure_eight(446), metallic(419), trace_map(401)
  recurrence is: structural-invariant 3548 mentions | conserved-integral 239 | TOOL 401
...
|---|---|---|---|---|---|---|
| golden | 611 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 587 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 579 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 446 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 419 | 39% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 401 | 37% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 379 | 35% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 328 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 258 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 240 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| kappa | 239 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **239** probes (22%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3548** mentions — invariants of the object's transforms.
