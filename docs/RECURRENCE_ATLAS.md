...
> Last generated: 2026-08-10 from 936 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 936 frontier probes; status {'open': 60, 'banked': 614, 'dead': 243, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 220x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(538), firewall(538), eisenstein(494), figure_eight(403), metallic(395), trace_map(371)
  recurrence is: structural-invariant 3176 mentions | conserved-integral 220 | TOOL 371
...
|---|---|---|---|---|---|---|
| golden | 538 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 538 | 57% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 494 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| amphichiral_cp | 309 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3176** mentions — invariants of the object's transforms.
