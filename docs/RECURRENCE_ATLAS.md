...
> Last generated: 2026-07-18 from 626 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 626 frontier probes; status {'banked': 425, 'dead': 137, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 180x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(421), golden(404), eisenstein(326), metallic(309), trace_map(294), figure_eight(283)
  recurrence is: structural-invariant 2310 mentions | conserved-integral 180 | TOOL 294
...
|---|---|---|---|---|---|---|
| firewall | 421 | 67% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 404 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 326 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| z3_generation | 131 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2310** mentions — invariants of the object's transforms.
