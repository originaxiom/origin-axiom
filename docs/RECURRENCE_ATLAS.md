...
> Last generated: 2026-07-17 from 601 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 601 frontier probes; status {'banked': 409, 'dead': 128, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 173x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(412), golden(382), eisenstein(308), trace_map(292), metallic(292), figure_eight(277)
  recurrence is: structural-invariant 2216 mentions | conserved-integral 173 | TOOL 292
...
| golden | 382 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 308 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| trace_map | 292 | 48% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| metallic | 292 | 48% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| figure_eight | 277 | 46% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| torsion | 215 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 202 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| z3_generation | 120 | 19% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 106 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| dickson_tower | 93 | 15% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| symplectic | 87 | 14% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2216** mentions — invariants of the object's transforms.
