...
> Last generated: 2026-08-02 from 771 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 771 frontier probes; status {'banked': 505, 'dead': 193, 'open': 54, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 199x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(487), firewall(481), eisenstein(411), figure_eight(363), metallic(354), trace_map(341)
  recurrence is: structural-invariant 2801 mentions | conserved-integral 199 | TOOL 341
...
|---|---|---|---|---|---|---|
| golden | 487 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 481 | 62% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 411 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 363 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 354 | 45% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 341 | 44% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 281 | 36% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| lorentzian | 131 | 16% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2801** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **341** probes (44%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| measure | 55 | golden | golden(35), firewall(33), eisenstein(25), figure_eight(23) |
