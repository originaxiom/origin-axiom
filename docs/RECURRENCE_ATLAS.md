...
> Last generated: 2026-08-12 from 965 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 965 frontier probes; status {'open': 62, 'banked': 632, 'dead': 251, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 230x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(552), firewall(546), eisenstein(508), figure_eight(411), metallic(407), trace_map(388)
  recurrence is: structural-invariant 3259 mentions | conserved-integral 230 | TOOL 388
  the honest split: the trace-map TOOL is in 388 probes (40%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 552 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 546 | 56% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 508 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 411 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 407 | 42% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 388 | 40% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 316 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 309 | 32% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3259** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **388** probes (40%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| units_scale | 98 | firewall | firewall(67), golden(63), metallic(53), eisenstein(49) |
