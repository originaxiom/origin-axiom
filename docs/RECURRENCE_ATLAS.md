...
> Last generated: 2026-07-12 from 516 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 516 frontier probes; status {'banked': 342, 'dead': 110, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 137x, 26%) -- genuine unity, MUST recur
  top recurring motifs: firewall(375), golden(325), metallic(261), trace_map(260), eisenstein(253), figure_eight(246)
  recurrence is: structural-invariant 1913 mentions | conserved-integral 137 | TOOL 260
  the honest split: the trace-map TOOL is in 260 probes (50%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 375 | 72% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 325 | 62% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| metallic | 261 | 50% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 260 | 50% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| eisenstein | 253 | 49% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 246 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| torsion | 181 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| quasicrystal | 55 | 10% | dynamics | structural | quantum | the Fibonacci quasicrystal / Suto / Damanik-Gorodetski |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1913** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **260** probes (50%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
