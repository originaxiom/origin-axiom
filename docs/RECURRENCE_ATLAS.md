...
> Last generated: 2026-07-18 from 616 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 616 frontier probes; status {'banked': 418, 'dead': 134, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 178x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(415), golden(395), eisenstein(319), metallic(305), trace_map(294), figure_eight(279)
  recurrence is: structural-invariant 2271 mentions | conserved-integral 178 | TOOL 294
...
| golden | 395 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 319 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| metallic | 305 | 49% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| kappa | 178 | 28% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **178** probes (28%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2271** mentions — invariants of the object's transforms.
