...
> Last generated: 2026-09-15 from 1239 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1239 frontier probes; status {'open': 70, 'banked': 812, 'dead': 333, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 280x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(698), golden(690), firewall(641), figure_eight(537), amphichiral_cp(469), metallic(462)
  recurrence is: structural-invariant 4938 mentions | conserved-integral 280 | TOOL 451
  the honest split: the trace-map TOOL is in 451 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| eisenstein | 698 | 56% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| golden | 690 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 641 | 51% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 537 | 43% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| amphichiral_cp | 469 | 37% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| metallic | 462 | 37% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 451 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| coupling | 389 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
| closing | 388 | 31% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
| torsion | 378 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| z3_generation | 318 | 25% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| measurement | 307 | 24% | question | no | dynamics | collapse, decoherence, the measurement postulate as a structural shape rather than an added axiom |
| wrt_quantum | 287 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 280 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| lorentzian | 221 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| choice | 190 | 15% | question | structural | arithmetic | the residual bit(s): the torsor of closings, the basepoint bit, what the object can and cannot select (A7/B766/B1183/B1225) |
| symplectic | 127 | 10% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| dickson_tower | 124 | 10% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| monoid | 109 | 8% | question | structural | dynamics | End(F2) beyond the units: the four Hopfian-det strata, the non-invertible verbs the programme has never computed |
...
| action | 79 | 6% | question | structural | dynamics | is there a least-action principle, and at which step -- the variational structure the object supplies rather than one lifted onto it (B6's derived potential, B21's bracket, B1341's theorem that the half step is generated by no Lagrangian and the monodromy is) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4938** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **451** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| units_scale | 115 | firewall | firewall(76), golden(69), eisenstein(62), metallic(56) |
| gauge_dict | 67 | eisenstein | eisenstein(42), firewall(34), golden(33), amphichiral_cp(32) |
| particle_dict | 106 | eisenstein | eisenstein(76), z3_generation(72), golden(63), firewall(63) |
