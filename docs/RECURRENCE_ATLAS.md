...
> Last generated: 2026-07-17 from 611 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 611 frontier probes; status {'banked': 415, 'dead': 132, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 177x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(415), golden(391), eisenstein(316), metallic(301), trace_map(293), figure_eight(279)
  recurrence is: structural-invariant 2255 mentions | conserved-integral 177 | TOOL 293
...
| eisenstein | 316 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| z3_generation | 122 | 19% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2255** mentions — invariants of the object's transforms.
