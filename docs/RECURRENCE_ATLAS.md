...
> Last generated: 2026-08-10 from 939 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 939 frontier probes; status {'open': 60, 'banked': 617, 'dead': 243, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 220x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(540), firewall(538), eisenstein(495), figure_eight(403), metallic(395), trace_map(371)
  recurrence is: structural-invariant 3180 mentions | conserved-integral 220 | TOOL 371
...
| eisenstein | 495 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| amphichiral_cp | 310 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3180** mentions — invariants of the object's transforms.
