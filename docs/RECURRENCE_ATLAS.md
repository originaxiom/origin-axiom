...
> Last generated: 2026-09-02 from 1146 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1146 frontier probes; status {'open': 65, 'banked': 755, 'dead': 304, 'dormant': 22}
  the ONE conserved first integral: kappa (recurs 255x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(643), eisenstein(626), firewall(619), figure_eight(482), metallic(428), amphichiral_cp(419)
  recurrence is: structural-invariant 3761 mentions | conserved-integral 255 | TOOL 416
...
|---|---|---|---|---|---|---|
| golden | 643 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| figure_eight | 482 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3761** mentions — invariants of the object's transforms.
