...
> Last generated: 2026-07-02 from 337 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 337 frontier probes; status {'banked': 229, 'dead': 52, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 29%) -- genuine unity, MUST recur
  top recurring motifs: firewall(218), golden(203), trace_map(199), metallic(187), figure_eight(184), eisenstein(168)
  recurrence is: structural-invariant 1235 mentions | conserved-integral 98 | TOOL 199
  the honest split: the trace-map TOOL is in 199 probes (59%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 218 | 64% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 203 | 60% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| trace_map | 199 | 59% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
...
| eisenstein | 168 | 49% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| torsion | 88 | 26% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1235** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **199** probes (59%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
