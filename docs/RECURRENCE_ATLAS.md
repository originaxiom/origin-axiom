...
THE RECURRENCE ATLAS -- context card
  ...
  recurrence is: structural-invariant 1270 mentions | conserved-integral 98 | TOOL 200
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1270** mentions — invariants of the object's transforms.
