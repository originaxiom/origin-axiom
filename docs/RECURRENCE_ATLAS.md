...
> Last generated: 2026-07-02 from 334 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 334 frontier probes; status {'banked': 226, 'dead': 52, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 97x, 29%) -- genuine unity, MUST recur
  top recurring motifs: firewall(215), golden(200), trace_map(197), metallic(185), figure_eight(183), eisenstein(165)
  recurrence is: structural-invariant 1218 mentions | conserved-integral 97 | TOOL 197
  the honest split: the trace-map TOOL is in 197 probes (58%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 215 | 64% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 200 | 59% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| trace_map | 197 | 58% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| metallic | 185 | 55% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| figure_eight | 183 | 54% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| eisenstein | 165 | 49% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| torsion | 86 | 25% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| z3_generation | 64 | 19% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| apolynomial | 48 | 14% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1218** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **197** probes (58%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
