...
> Last generated: 2026-07-12 from 503 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 503 frontier probes; status {'banked': 333, 'dead': 106, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 135x, 26%) -- genuine unity, MUST recur
  top recurring motifs: firewall(371), golden(317), metallic(257), trace_map(255), eisenstein(250), figure_eight(246)
  recurrence is: structural-invariant 1887 mentions | conserved-integral 135 | TOOL 255
...
|---|---|---|---|---|---|---|
| firewall | 371 | 73% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 317 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| metallic | 257 | 51% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1887** mentions — invariants of the object's transforms.
