...
> Last generated: 2026-07-18 from 623 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 623 frontier probes; status {'banked': 424, 'dead': 135, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 180x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(418), golden(401), eisenstein(323), metallic(309), trace_map(294), figure_eight(282)
  recurrence is: structural-invariant 2298 mentions | conserved-integral 180 | TOOL 294
...
|---|---|---|---|---|---|---|
| firewall | 418 | 67% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 401 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 323 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| figure_eight | 282 | 45% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| torsion | 219 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| wrt_quantum | 160 | 25% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 129 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2298** mentions — invariants of the object's transforms.
