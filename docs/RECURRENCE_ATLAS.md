...
> Last generated: 2026-07-02 from 335 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 335 frontier probes; status {'banked': 227, 'dead': 52, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 29%) -- genuine unity, MUST recur
  top recurring motifs: firewall(216), golden(201), trace_map(198), metallic(186), figure_eight(184), eisenstein(166)
  recurrence is: structural-invariant 1224 mentions | conserved-integral 98 | TOOL 198
  the honest split: the trace-map TOOL is in 198 probes (59%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 216 | 64% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 201 | 60% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| trace_map | 198 | 59% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| metallic | 186 | 55% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| figure_eight | 184 | 54% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| eisenstein | 166 | 49% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| wrt_quantum | 82 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| dickson_tower | 75 | 22% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1224** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **198** probes (59%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
