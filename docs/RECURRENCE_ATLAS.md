...
> Last generated: 2026-08-31 from 1127 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1127 frontier probes; status {'open': 64, 'banked': 744, 'dead': 297, 'dormant': 22}
  the ONE conserved first integral: kappa (recurs 252x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(631), firewall(617), eisenstein(614), figure_eight(469), metallic(425), trace_map(410)
  recurrence is: structural-invariant 3698 mentions | conserved-integral 252 | TOOL 410
...
|---|---|---|---|---|---|---|
| golden | 631 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 617 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 614 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 469 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 409 | 36% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 341 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 265 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 252 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| z3_generation | 251 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3698** mentions — invariants of the object's transforms.
