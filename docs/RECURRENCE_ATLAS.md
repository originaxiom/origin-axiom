...
> Last generated: 2026-08-26 from 1065 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1065 frontier probes; status {'open': 63, 'banked': 713, 'dead': 269, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 238x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(608), firewall(580), eisenstein(573), figure_eight(441), metallic(419), trace_map(400)
  recurrence is: structural-invariant 3523 mentions | conserved-integral 238 | TOOL 400
...
| firewall | 580 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 573 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| amphichiral_cp | 373 | 35% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 325 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3523** mentions — invariants of the object's transforms.
