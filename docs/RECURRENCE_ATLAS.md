...
> Last generated: 2026-08-21 from 1028 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1028 frontier probes; status {'open': 63, 'banked': 684, 'dead': 262, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 234x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(578), firewall(560), eisenstein(542), figure_eight(424), metallic(415), trace_map(393)
  recurrence is: structural-invariant 3399 mentions | conserved-integral 234 | TOOL 393
  the honest split: the trace-map TOOL is in 393 probes (38%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
| firewall | 560 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 542 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| trace_map | 393 | 38% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 360 | 35% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 315 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 251 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
| lorentzian | 186 | 18% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3399** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **393** probes (38%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| measure | 102 | golden | golden(57), eisenstein(53), firewall(51), figure_eight(41) |
