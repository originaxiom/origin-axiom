...
> Last generated: 2026-08-21 from 1015 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1015 frontier probes; status {'open': 66, 'banked': 664, 'dead': 264, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 231x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(571), firewall(551), eisenstein(529), figure_eight(423), metallic(404), trace_map(379)
  recurrence is: structural-invariant 3340 mentions | conserved-integral 231 | TOOL 379
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3340** mentions — invariants of the object's transforms.
