...
> Last generated: 2026-08-02 from 774 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 774 frontier probes; status {'banked': 507, 'dead': 194, 'open': 54, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 199x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(488), firewall(482), eisenstein(414), figure_eight(365), metallic(355), trace_map(344)
  recurrence is: structural-invariant 2809 mentions | conserved-integral 199 | TOOL 344
  the honest split: the trace-map TOOL is in 344 probes (44%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
| firewall | 482 | 62% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 414 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| trace_map | 344 | 44% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 282 | 36% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 253 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2809** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **344** probes (44%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
