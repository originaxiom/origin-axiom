...
THE RECURRENCE ATLAS -- context card
  corpus: 1009 frontier probes; status {'open': 66, 'banked': 659, 'dead': 263, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 230x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(568), firewall(549), eisenstein(528), figure_eight(419), metallic(403), trace_map(379)
  recurrence is: structural-invariant 3322 mentions | conserved-integral 230 | TOOL 379
...
| torsion | 317 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| dickson_tower | 107 | 10% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3322** mentions — invariants of the object's transforms.
...
| measure | 101 | golden | golden(54), eisenstein(49), firewall(46), figure_eight(45) |
