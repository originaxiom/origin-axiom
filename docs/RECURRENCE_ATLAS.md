...
> Last generated: 2026-07-29 from 733 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 733 frontier probes; status {'banked': 496, 'dead': 168, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 188x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(476), firewall(474), eisenstein(404), figure_eight(353), metallic(342), trace_map(336)
  recurrence is: structural-invariant 2679 mentions | conserved-integral 188 | TOOL 336
...
|---|---|---|---|---|---|---|
| golden | 476 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 474 | 64% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 404 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 353 | 48% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| z3_generation | 152 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2679** mentions — invariants of the object's transforms.
