...
THE RECURRENCE ATLAS -- context card
  ...
  top recurring motifs: firewall(407), golden(369), eisenstein(292), metallic(286), trace_map(283), figure_eight(274)
  recurrence is: structural-invariant 2145 mentions | conserved-integral 165 | TOOL 283
...
|---|---|---|---|---|---|---|
| firewall | 407 | 69% | structure | structural | meta | the firewall / structural theorem / form-not-values |
...
| amphichiral_cp | 192 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2145** mentions — invariants of the object's transforms.
