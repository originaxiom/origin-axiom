...
> Last generated: 2026-09-12 from 1217 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1217 frontier probes; status {'open': 70, 'banked': 798, 'dead': 325, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 270x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(682), golden(675), firewall(635), figure_eight(524), amphichiral_cp(456), metallic(448)
  recurrence is: structural-invariant 4813 mentions | conserved-integral 270 | TOOL 440
  the honest split: the trace-map TOOL is in 440 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| eisenstein | 682 | 56% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| golden | 675 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 635 | 52% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 524 | 43% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| amphichiral_cp | 456 | 37% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| metallic | 448 | 36% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 440 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| coupling | 380 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
| closing | 377 | 30% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
| torsion | 373 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| z3_generation | 308 | 25% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| wrt_quantum | 277 | 22% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 270 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
...
| symplectic | 122 | 10% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| monoid | 96 | 7% | question | structural | dynamics | End(F2) beyond the units: the four Hopfian-det strata, the non-invertible verbs the programme has never computed |
| apolynomial | 84 | 6% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
| arrow | 78 | 6% | question | no | dynamics | time's direction and/or its irreversibility -- the two are NOT the same question (B766 = the direction bit, the golden branch; S063 = irreversibility, entering at det != +-1) |
| markov_cubic | 78 | 6% | invariant | structural | topology | the trace-triple SURFACE the trace map acts on: the Markov/Fricke cubic x^2+y^2+z^2-xyz=c and SL(2,Z) triples (tr A, tr B, tr AB). Deliberately EXCLUDES the bare phrase 'character variety', which B824 measured at 13.8%% of the corpus -- this programme's subject matter, not a topic within it |
| action | 74 | 6% | question | structural | dynamics | is there a least-action principle, and at which step -- the variational structure the object supplies rather than one lifted onto it (B6's derived potential, B21's bracket, B1341's theorem that the half step is generated by no Lagrangian and the monodromy is) |
| quasicrystal | 71 | 5% | dynamics | structural | quantum | the Fibonacci quasicrystal / Suto / Damanik-Gorodetski |
| naming | 44 | 3% | question | structural | arithmetic | self-reference, the quine, self-name vs self-sign -- naming and choosing proved complementary (B762/B1184) |
...
| feedback | 12 | 0% | question | no | dynamics | does the object act on its own state, and does it READ what it acts on -- B37's operational split (feedback and an invariant: yes; self-model: no), fenced against awareness readings, and the closed-blanket question X31 poses |

### The honest split — unity vs the hammer

- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **270** probes (22%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4813** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **440** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| particle_dict | 103 | eisenstein | eisenstein(74), z3_generation(69), firewall(63), golden(61) |
...
| B1341 | 19 | banked | two_ends+object=dynamics+physics_bridge+symplectic_casimir | arithmetic, dynamics, geometry, physics, topology |
