...
> Last generated: 2026-09-26 from 1222 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1222 frontier probes; status {'open': 68, 'banked': 811, 'dead': 320, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 269x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(692), golden(683), firewall(632), figure_eight(525), amphichiral_cp(458), metallic(452)
  recurrence is: structural-invariant 4781 mentions | conserved-integral 269 | TOOL 444
  the honest split: the trace-map TOOL is in 444 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| eisenstein | 692 | 56% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| golden | 683 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 632 | 51% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 525 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| amphichiral_cp | 458 | 37% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| metallic | 452 | 36% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 444 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| closing | 392 | 32% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
| coupling | 386 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
| torsion | 383 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| z3_generation | 319 | 26% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| wrt_quantum | 299 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| measurement | 289 | 23% | question | no | dynamics | collapse, decoherence, the measurement postulate as a structural shape rather than an added axiom |
| kappa | 269 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| lorentzian | 213 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| choice | 181 | 14% | question | structural | arithmetic | the residual bit(s): the torsor of closings, the basepoint bit, what the object can and cannot select (A7/B766/B1183/B1225) |
| symplectic | 122 | 9% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| dickson_tower | 111 | 9% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| monoid | 108 | 8% | question | structural | dynamics | End(F2) beyond the units: the four Hopfian-det strata, the non-invertible verbs the programme has never computed |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **269** probes (22%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4781** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **444** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| cancellation | 68 | eisenstein | eisenstein(43), golden(42), firewall(35), trace_map(32) |
...
| gauge_dict | 70 | eisenstein | eisenstein(45), golden(36), amphichiral_cp(35), figure_eight(35) |
| particle_dict | 117 | eisenstein | eisenstein(86), z3_generation(83), golden(73), firewall(64) |
| spacetime_3p1 | 145 | eisenstein | eisenstein(88), golden(82), figure_eight(77), closing(69) |
...
| B1280 | 20 | banked | two_ends+object=dynamics+quantum_meeting+symplectic_casimir | arithmetic, dynamics, geometry, quantum, representation, topology |
