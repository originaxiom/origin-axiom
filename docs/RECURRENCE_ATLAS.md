...
> Last generated: 2026-08-26 from 1060 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1060 frontier probes; status {'open': 63, 'banked': 708, 'dead': 269, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 238x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(604), firewall(575), eisenstein(570), figure_eight(439), metallic(419), trace_map(399)
  recurrence is: structural-invariant 3502 mentions | conserved-integral 238 | TOOL 399
...
|---|---|---|---|---|---|---|
| golden | 604 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 575 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 570 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 439 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 370 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 322 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 256 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3502** mentions — invariants of the object's transforms.
...
| units_scale | 104 | firewall | firewall(70), golden(63), metallic(54), eisenstein(53) |
| gauge_dict | 62 | eisenstein | eisenstein(38), firewall(34), golden(30), figure_eight(30) |
| particle_dict | 88 | eisenstein | eisenstein(64), z3_generation(56), firewall(56), golden(53) |
