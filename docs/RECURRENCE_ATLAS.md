...
> Last generated: 2026-09-12 from 1211 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1211 frontier probes; status {'open': 70, 'banked': 794, 'dead': 323, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 268x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(678), golden(674), firewall(635), figure_eight(520), amphichiral_cp(454), metallic(446)
  recurrence is: structural-invariant 4715 mentions | conserved-integral 268 | TOOL 439
...
|---|---|---|---|---|---|---|
| eisenstein | 678 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| golden | 674 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 635 | 52% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 520 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| amphichiral_cp | 454 | 37% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| metallic | 446 | 36% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 439 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| coupling | 379 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
| closing | 373 | 30% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
| torsion | 372 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| z3_generation | 304 | 25% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| measurement | 290 | 23% | question | no | dynamics | collapse, decoherence, the measurement postulate as a structural shape rather than an added axiom |
...
| symplectic | 121 | 9% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4715** mentions — invariants of the object's transforms.
