...
> Last generated: 2026-08-29 from 1117 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1117 frontier probes; status {'open': 64, 'banked': 739, 'dead': 292, 'dormant': 22}
  the ONE conserved first integral: kappa (recurs 252x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(628), firewall(613), eisenstein(608), figure_eight(465), metallic(424), trace_map(408)
  recurrence is: structural-invariant 3672 mentions | conserved-integral 252 | TOOL 408
...
|---|---|---|---|---|---|---|
| golden | 628 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 613 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 608 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 465 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| wrt_quantum | 261 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 252 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| z3_generation | 247 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3672** mentions — invariants of the object's transforms.
...
| units_scale | 111 | firewall | firewall(75), golden(67), eisenstein(59), metallic(54) |
