...
THE RECURRENCE ATLAS -- context card
  corpus: 1017 frontier probes; status {'open': 63, 'banked': 675, 'dead': 260, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 234x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(574), firewall(557), eisenstein(535), figure_eight(422), metallic(410), trace_map(389)
  recurrence is: structural-invariant 3374 mentions | conserved-integral 234 | TOOL 389
  the honest split: the trace-map TOOL is in 389 probes (38%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
| firewall | 557 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 535 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 422 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 410 | 40% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 389 | 38% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 354 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 315 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 248 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 234 | 23% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| z3_generation | 230 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 180 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **234** probes (23%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3374** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **389** probes (38%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| cancellation | 56 | golden | golden(34), eisenstein(33), firewall(31), trace_map(24) |
...
| units_scale | 100 | firewall | firewall(68), golden(61), metallic(52), eisenstein(49) |
...
| spacetime_3p1 | 118 | golden | golden(69), eisenstein(68), figure_eight(68), trace_map(58) |
