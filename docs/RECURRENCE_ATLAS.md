...
> Last generated: 2026-09-05 from 1159 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1159 frontier probes; status {'open': 67, 'banked': 759, 'dead': 311, 'dormant': 22}
  the ONE conserved first integral: kappa (recurs 259x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(649), eisenstein(638), firewall(625), figure_eight(489), metallic(431), trace_map(421)
  recurrence is: structural-invariant 4452 mentions | conserved-integral 259 | TOOL 421
...
|---|---|---|---|---|---|---|
| golden | 649 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 638 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| z3_generation | 268 | 23% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4452** mentions — invariants of the object's transforms.
