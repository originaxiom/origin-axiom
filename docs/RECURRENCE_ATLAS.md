...
> Last generated: 2026-08-26 from 1058 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1058 frontier probes; status {'open': 63, 'banked': 706, 'dead': 269, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 238x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(602), firewall(573), eisenstein(568), figure_eight(438), metallic(419), trace_map(399)
  recurrence is: structural-invariant 3495 mentions | conserved-integral 238 | TOOL 399
...
|---|---|---|---|---|---|---|
| golden | 602 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 573 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 568 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 438 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3495** mentions — invariants of the object's transforms.
