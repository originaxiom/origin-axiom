...
THE RECURRENCE ATLAS -- context card
  ...
  top recurring motifs: golden(477), firewall(474), eisenstein(404), figure_eight(353), metallic(343), trace_map(336)
  recurrence is: structural-invariant 2682 mentions | conserved-integral 188 | TOOL 336
...
|---|---|---|---|---|---|---|
| golden | 477 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| metallic | 343 | 46% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 336 | 45% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 274 | 37% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2682** mentions — invariants of the object's transforms.
