...
> Last generated: 2026-07-15 from 582 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 582 frontier probes; status {'banked': 392, 'dead': 126, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 165x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(408), golden(369), eisenstein(292), metallic(286), trace_map(283), figure_eight(274)
  recurrence is: structural-invariant 2147 mentions | conserved-integral 165 | TOOL 283
...
|---|---|---|---|---|---|---|
| firewall | 408 | 70% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 369 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 292 | 50% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| amphichiral_cp | 193 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| z3_generation | 114 | 19% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2147** mentions — invariants of the object's transforms.
