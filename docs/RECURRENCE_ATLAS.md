...
> Last generated: 2026-08-27 from 1079 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1079 frontier probes; status {'open': 63, 'banked': 719, 'dead': 277, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 240x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(614), firewall(591), eisenstein(583), figure_eight(450), metallic(420), trace_map(401)
  recurrence is: structural-invariant 3566 mentions | conserved-integral 240 | TOOL 401
...
|---|---|---|---|---|---|---|
| golden | 614 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 591 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 583 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 450 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 383 | 35% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 329 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| lorentzian | 195 | 18% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3566** mentions — invariants of the object's transforms.
