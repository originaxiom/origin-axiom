...
> Last generated: 2026-08-20 from 998 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 998 frontier probes; status {'open': 63, 'banked': 659, 'dead': 257, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 229x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(567), firewall(553), eisenstein(525), figure_eight(416), metallic(405), trace_map(382)
  recurrence is: structural-invariant 3323 mentions | conserved-integral 229 | TOOL 382
  the honest split: the trace-map TOOL is in 382 probes (38%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 567 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| trace_map | 382 | 38% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 342 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 310 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 240 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 229 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| z3_generation | 225 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3323** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **382** probes (38%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| observable | 39 | golden | golden(30), metallic(19), torsion(18), firewall(17) |
