...
> Last generated: 2026-09-08 from 1191 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1191 frontier probes; status {'open': 67, 'banked': 781, 'dead': 319, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 266x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(666), eisenstein(666), firewall(630), figure_eight(506), amphichiral_cp(440), metallic(436)
  recurrence is: structural-invariant 4604 mentions | conserved-integral 266 | TOOL 435
...
| eisenstein | 666 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| firewall | 630 | 52% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 506 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| amphichiral_cp | 440 | 36% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| metallic | 436 | 36% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 435 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| coupling | 370 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
| torsion | 362 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| closing | 360 | 30% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
| z3_generation | 293 | 24% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| lorentzian | 211 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4604** mentions — invariants of the object's transforms.
