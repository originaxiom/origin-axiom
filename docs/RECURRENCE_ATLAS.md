...
> Last generated: 2026-08-28 from 1086 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1086 frontier probes; status {'open': 63, 'banked': 721, 'dead': 282, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 241x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(619), firewall(598), eisenstein(590), figure_eight(455), metallic(420), trace_map(402)
  recurrence is: structural-invariant 3593 mentions | conserved-integral 241 | TOOL 402
...
|---|---|---|---|---|---|---|
| golden | 619 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 598 | 55% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 590 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 455 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 386 | 35% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 332 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3593** mentions — invariants of the object's transforms.
...
| measure | 105 | golden | golden(58), eisenstein(56), firewall(53), figure_eight(43) |
