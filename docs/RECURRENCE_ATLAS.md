...
> Last generated: 2026-07-02 from 339 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 339 frontier probes; status {'banked': 231, 'dead': 52, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(220), golden(205), trace_map(199), metallic(187), figure_eight(185), eisenstein(170)
  recurrence is: structural-invariant 1244 mentions | conserved-integral 98 | TOOL 199
...
|---|---|---|---|---|---|---|
| firewall | 220 | 64% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 205 | 60% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| eisenstein | 170 | 50% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| torsion | 89 | 26% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 84 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1244** mentions — invariants of the object's transforms.
