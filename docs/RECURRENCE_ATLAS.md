...
> Last generated: 2026-08-28 from 1081 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1081 frontier probes; status {'open': 63, 'banked': 719, 'dead': 279, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 240x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(615), firewall(593), eisenstein(585), figure_eight(451), metallic(420), trace_map(401)
  recurrence is: structural-invariant 3573 mentions | conserved-integral 240 | TOOL 401
...
| firewall | 593 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 585 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 451 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3573** mentions — invariants of the object's transforms.
