...
> Last generated: 2026-08-28 from 1084 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1084 frontier probes; status {'open': 63, 'banked': 720, 'dead': 281, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 241x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(617), firewall(596), eisenstein(588), figure_eight(454), metallic(420), trace_map(402)
  recurrence is: structural-invariant 3585 mentions | conserved-integral 241 | TOOL 402
...
|---|---|---|---|---|---|---|
| golden | 617 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 596 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 588 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 454 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3585** mentions — invariants of the object's transforms.
