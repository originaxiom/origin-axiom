...
> Last generated: 2026-08-11 from 944 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 944 frontier probes; status {'open': 60, 'banked': 618, 'dead': 247, 'dormant': 19}
  ...
  recurrence is: structural-invariant 3188 mentions | conserved-integral 220 | TOOL 371
...
| amphichiral_cp | 313 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3188** mentions — invariants of the object's transforms.
