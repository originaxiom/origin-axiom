...
> Last generated: 2026-09-06 from 1177 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1177 frontier probes; status {'open': 67, 'banked': 771, 'dead': 315, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 263x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(658), eisenstein(652), firewall(626), figure_eight(495), metallic(433), amphichiral_cp(429)
  recurrence is: structural-invariant 4519 mentions | conserved-integral 263 | TOOL 427
...
| eisenstein | 652 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| amphichiral_cp | 429 | 36% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4519** mentions — invariants of the object's transforms.
