...
> Last generated: 2026-09-06 from 1174 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1174 frontier probes; status {'open': 67, 'banked': 770, 'dead': 314, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 262x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(655), eisenstein(650), firewall(626), figure_eight(495), metallic(433), amphichiral_cp(430)
  recurrence is: structural-invariant 4512 mentions | conserved-integral 262 | TOOL 425
  the honest split: the trace-map TOOL is in 425 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 655 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 650 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| trace_map | 425 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
...
| z3_generation | 279 | 23% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4512** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **425** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
