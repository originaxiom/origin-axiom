...
THE RECURRENCE ATLAS -- context card
  corpus: 1180 frontier probes; status {'open': 67, 'banked': 774, 'dead': 316, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 263x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(659), eisenstein(656), firewall(627), figure_eight(499), amphichiral_cp(434), metallic(434)
  recurrence is: structural-invariant 4540 mentions | conserved-integral 263 | TOOL 427
...
| closing | 354 | 30% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
