...
> Last generated: 2026-07-17 from 602 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 602 frontier probes; status {'banked': 409, 'dead': 129, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 173x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(412), golden(383), eisenstein(309), metallic(293), trace_map(292), figure_eight(277)
  recurrence is: structural-invariant 2220 mentions | conserved-integral 173 | TOOL 292
...
| golden | 383 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 309 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| amphichiral_cp | 203 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2220** mentions — invariants of the object's transforms.
