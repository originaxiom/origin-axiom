...
> Last generated: 2026-08-02 from 770 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 770 frontier probes; status {'banked': 505, 'dead': 192, 'open': 54, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 199x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(487), firewall(480), eisenstein(410), figure_eight(362), metallic(353), trace_map(341)
  recurrence is: structural-invariant 2796 mentions | conserved-integral 199 | TOOL 341
...
| firewall | 480 | 62% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 410 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 362 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 353 | 45% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 341 | 44% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 280 | 36% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 251 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| lorentzian | 131 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2796** mentions — invariants of the object's transforms.
