...
> Last generated: 2026-08-10 from 933 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 933 frontier probes; status {'open': 60, 'banked': 613, 'dead': 241, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 220x, 23%) -- genuine unity, MUST recur
  top recurring motifs: firewall(538), golden(536), eisenstein(492), figure_eight(403), metallic(394), trace_map(371)
  recurrence is: structural-invariant 3169 mentions | conserved-integral 220 | TOOL 371
...
| golden | 536 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 492 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| amphichiral_cp | 307 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| lorentzian | 168 | 18% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3169** mentions — invariants of the object's transforms.
...
| spacetime_3p1 | 106 | golden | figure_eight(66), golden(64), eisenstein(61), trace_map(55) |
