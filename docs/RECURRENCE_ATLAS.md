...
> Last generated: 2026-09-06 from 1175 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1175 frontier probes; status {'open': 67, 'banked': 771, 'dead': 314, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 263x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(656), eisenstein(651), firewall(626), figure_eight(496), metallic(433), amphichiral_cp(431)
  recurrence is: structural-invariant 4517 mentions | conserved-integral 263 | TOOL 425
...
| coupling | 366 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4517** mentions — invariants of the object's transforms.
