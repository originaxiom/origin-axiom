...
> Last generated: 2026-07-16 from 590 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 590 frontier probes; status {'banked': 400, 'dead': 126, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 166x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(410), golden(375), eisenstein(299), metallic(286), trace_map(285), figure_eight(274)
  recurrence is: structural-invariant 2172 mentions | conserved-integral 166 | TOOL 285
  the honest split: the trace-map TOOL is in 285 probes (48%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
| golden | 375 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| trace_map | 285 | 48% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
...
| amphichiral_cp | 196 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| symplectic | 82 | 13% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2172** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **285** probes (48%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
