...
> Last generated: 2026-08-21 from 1016 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1016 frontier probes; status {'open': 67, 'banked': 664, 'dead': 264, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 231x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(571), firewall(551), eisenstein(530), figure_eight(424), metallic(404), trace_map(379)
  recurrence is: structural-invariant 3343 mentions | conserved-integral 231 | TOOL 379
...
|---|---|---|---|---|---|---|
| golden | 571 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| figure_eight | 424 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| torsion | 322 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3343** mentions — invariants of the object's transforms.
...
| measure | 104 | golden | golden(56), eisenstein(49), figure_eight(47), firewall(46) |
