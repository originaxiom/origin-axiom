...
> Last generated: 2026-08-21 from 1010 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1010 frontier probes; status {'open': 66, 'banked': 660, 'dead': 263, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 231x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(568), firewall(549), eisenstein(528), figure_eight(420), metallic(403), trace_map(379)
  recurrence is: structural-invariant 3324 mentions | conserved-integral 231 | TOOL 379
...
| amphichiral_cp | 333 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 318 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| lorentzian | 181 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3324** mentions — invariants of the object's transforms.
...
| measure | 102 | golden | golden(54), eisenstein(49), figure_eight(46), firewall(46) |
