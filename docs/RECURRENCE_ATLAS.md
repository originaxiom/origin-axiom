...
> Last generated: 2026-07-30 from 743 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 743 frontier probes; status {'banked': 497, 'dead': 177, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 192x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(482), firewall(476), eisenstein(406), figure_eight(358), metallic(345), trace_map(338)
  recurrence is: structural-invariant 2707 mentions | conserved-integral 192 | TOOL 338
...
| figure_eight | 358 | 48% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2707** mentions — invariants of the object's transforms.
