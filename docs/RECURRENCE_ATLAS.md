...
> Last generated: 2026-08-21 from 1013 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1013 frontier probes; status {'open': 66, 'banked': 663, 'dead': 263, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 231x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(570), firewall(551), eisenstein(529), figure_eight(422), metallic(403), trace_map(379)
  recurrence is: structural-invariant 3336 mentions | conserved-integral 231 | TOOL 379
...
| figure_eight | 422 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 403 | 39% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 379 | 37% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 335 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 321 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 236 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3336** mentions — invariants of the object's transforms.
