...
> Last generated: 2026-09-06 from 1170 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1170 frontier probes; status {'open': 67, 'banked': 766, 'dead': 314, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 262x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(654), eisenstein(646), firewall(626), figure_eight(492), metallic(433), amphichiral_cp(426)
  recurrence is: structural-invariant 4496 mentions | conserved-integral 262 | TOOL 424
...
| eisenstein | 646 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| metallic | 433 | 37% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4496** mentions — invariants of the object's transforms.
