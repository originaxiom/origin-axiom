...
> Last generated: 2026-07-30 from 739 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 739 frontier probes; status {'banked': 497, 'dead': 173, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 191x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(479), firewall(476), eisenstein(404), figure_eight(354), metallic(345), trace_map(337)
  recurrence is: structural-invariant 2695 mentions | conserved-integral 191 | TOOL 337
...
|---|---|---|---|---|---|---|
| golden | 479 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 476 | 64% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 404 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 354 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 345 | 46% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 337 | 45% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 276 | 37% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 248 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| wrt_quantum | 202 | 27% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 191 | 25% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| z3_generation | 153 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| quasicrystal | 63 | 8% | dynamics | structural | quantum | the Fibonacci quasicrystal / Suto / Damanik-Gorodetski |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **191** probes (25%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2695** mentions — invariants of the object's transforms.
