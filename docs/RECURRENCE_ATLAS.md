...
> Last generated: 2026-08-27 from 1080 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1080 frontier probes; status {'open': 63, 'banked': 719, 'dead': 278, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 240x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(614), firewall(592), eisenstein(584), figure_eight(451), metallic(420), trace_map(401)
  recurrence is: structural-invariant 3569 mentions | conserved-integral 240 | TOOL 401
...
| firewall | 592 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 584 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3569** mentions — invariants of the object's transforms.
