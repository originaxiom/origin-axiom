...
> Last generated: 2026-07-02 from 338 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 338 frontier probes; status {'banked': 230, 'dead': 52, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(219), golden(204), trace_map(199), metallic(187), figure_eight(185), eisenstein(169)
  recurrence is: structural-invariant 1240 mentions | conserved-integral 98 | TOOL 199
...
|---|---|---|---|---|---|---|
| firewall | 219 | 64% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 204 | 60% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| eisenstein | 169 | 50% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1240** mentions — invariants of the object's transforms.
