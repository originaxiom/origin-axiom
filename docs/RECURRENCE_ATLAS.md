...
THE RECURRENCE ATLAS -- context card
  corpus: 1174 frontier probes; status {'open': 67, 'banked': 769, 'dead': 315, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 263x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(656), eisenstein(649), firewall(626), figure_eight(493), metallic(433), trace_map(427)
  recurrence is: structural-invariant 4507 mentions | conserved-integral 263 | TOOL 427
...
| figure_eight | 493 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4507** mentions — invariants of the object's transforms.
