...
> Last generated: 2026-07-02 from 332 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 332 frontier probes; status {'banked': 224, 'dead': 52, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 97x, 29%) -- genuine unity, MUST recur
  top recurring motifs: firewall(213), golden(200), trace_map(196), metallic(185), figure_eight(181), eisenstein(163)
  recurrence is: structural-invariant 1211 mentions | conserved-integral 97 | TOOL 196
  the honest split: the trace-map TOOL is in 196 probes (59%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 213 | 64% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 200 | 60% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| trace_map | 196 | 59% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| metallic | 185 | 55% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| figure_eight | 181 | 54% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| eisenstein | 163 | 49% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| dickson_tower | 73 | 21% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
...
| apolynomial | 47 | 14% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1211** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **196** probes (59%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| spacetime_3p1 | 53 | metallic | figure_eight(37), metallic(37), trace_map(35), dickson_tower(33) |
