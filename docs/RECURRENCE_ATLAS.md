...
> Last generated: 2026-09-03 from 1151 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1151 frontier probes; status {'open': 67, 'banked': 755, 'dead': 307, 'dormant': 22}
  ...
  recurrence is: structural-invariant 3781 mentions | conserved-integral 255 | TOOL 418
...
| firewall | 622 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3781** mentions — invariants of the object's transforms.
