...
> Last generated: 2026-08-12 from 958 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 958 frontier probes; status {'open': 60, 'banked': 628, 'dead': 251, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 223x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(546), firewall(541), eisenstein(505), figure_eight(404), metallic(396), trace_map(372)
  recurrence is: structural-invariant 3219 mentions | conserved-integral 223 | TOOL 372
...
|---|---|---|---|---|---|---|
| golden | 546 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3219** mentions — invariants of the object's transforms.
