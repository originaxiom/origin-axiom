...
|---|---|---|---|---|---|---|
| golden | 482 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2776** mentions — invariants of the object's transforms.
