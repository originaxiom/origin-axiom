...
> Last generated: 2026-08-11 from 961 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 961 frontier probes; status {'open': 62, 'banked': 631, 'dead': 248, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 229x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(550), firewall(543), eisenstein(505), figure_eight(409), metallic(405), trace_map(386)
  recurrence is: structural-invariant 3244 mentions | conserved-integral 229 | TOOL 386
  the honest split: the trace-map TOOL is in 386 probes (40%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
| metallic | 405 | 42% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 386 | 40% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3244** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **386** probes (40%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| measure | 94 | golden | golden(50), eisenstein(46), firewall(46), figure_eight(37) |
