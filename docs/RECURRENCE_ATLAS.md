...
THE RECURRENCE ATLAS -- context card
  ...
  top recurring motifs: firewall(378), golden(330), metallic(265), trace_map(262), eisenstein(255), figure_eight(249)
  recurrence is: structural-invariant 1936 mentions | conserved-integral 139 | TOOL 262
...
| metallic | 265 | 50% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| figure_eight | 249 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1936** mentions — invariants of the object's transforms.
