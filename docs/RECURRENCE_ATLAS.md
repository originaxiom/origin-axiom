...
> Last generated: 2026-07-31 from 756 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 756 frontier probes; status {'banked': 501, 'dead': 184, 'open': 53, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 195x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(483), firewall(478), eisenstein(407), figure_eight(359), metallic(348), trace_map(340)
  recurrence is: structural-invariant 2778 mentions | conserved-integral 195 | TOOL 340
...
| metallic | 348 | 46% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| kappa | 195 | 25% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **195** probes (25%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2778** mentions — invariants of the object's transforms.
