...
> Last generated: 2026-08-22 from 1032 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1032 frontier probes; status {'open': 63, 'banked': 687, 'dead': 263, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 234x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(582), firewall(560), eisenstein(546), figure_eight(425), metallic(416), trace_map(393)
  recurrence is: structural-invariant 3409 mentions | conserved-integral 234 | TOOL 393
...
|---|---|---|---|---|---|---|
| golden | 582 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 560 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 546 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 425 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 416 | 40% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 393 | 38% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 360 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3409** mentions — invariants of the object's transforms.
