...
> Last generated: 2026-09-09 from 1196 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1196 frontier probes; status {'open': 68, 'banked': 785, 'dead': 319, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 266x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(670), golden(669), firewall(630), figure_eight(510), amphichiral_cp(443), metallic(441)
  recurrence is: structural-invariant 4632 mentions | conserved-integral 266 | TOOL 436
...
| golden | 669 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 630 | 52% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 510 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| amphichiral_cp | 443 | 37% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| torsion | 365 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| z3_generation | 297 | 24% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4632** mentions — invariants of the object's transforms.
