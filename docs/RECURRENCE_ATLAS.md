...
> Last generated: 2026-09-15 from 1238 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1238 frontier probes; status {'open': 70, 'banked': 811, 'dead': 333, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 280x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(698), golden(689), firewall(641), figure_eight(536), amphichiral_cp(468), metallic(461)
  recurrence is: structural-invariant 4929 mentions | conserved-integral 280 | TOOL 450
...
| golden | 689 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| amphichiral_cp | 468 | 37% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| metallic | 461 | 37% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| closing | 387 | 31% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
| torsion | 377 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| z3_generation | 317 | 25% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| wrt_quantum | 286 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
| dickson_tower | 123 | 9% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
...
| action | 78 | 6% | question | structural | dynamics | is there a least-action principle, and at which step -- the variational structure the object supplies rather than one lifted onto it (B6's derived potential, B21's bracket, B1341's theorem that the half step is generated by no Lagrangian and the monodromy is) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4929** mentions — invariants of the object's transforms.
