...
THE RECURRENCE ATLAS -- context card
  corpus: 992 frontier probes; status {'open': 65, 'banked': 648, 'dead': 258, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 227x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(562), firewall(549), eisenstein(522), figure_eight(412), metallic(400), trace_map(377)
  recurrence is: structural-invariant 3294 mentions | conserved-integral 227 | TOOL 377
