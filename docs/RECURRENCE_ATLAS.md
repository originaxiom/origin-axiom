...
> Last generated: 2026-09-26 from 1228 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1228 frontier probes; status {'open': 69, 'banked': 816, 'dead': 320, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 269x, 21%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(697), golden(688), firewall(632), figure_eight(532), amphichiral_cp(460), metallic(455)
  recurrence is: structural-invariant 4814 mentions | conserved-integral 269 | TOOL 450
...
| amphichiral_cp | 460 | 37% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| z3_generation | 324 | 26% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| wrt_quantum | 303 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
| lorentzian | 217 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4814** mentions — invariants of the object's transforms.
...
| spacetime_3p1 | 149 | eisenstein | eisenstein(91), golden(85), figure_eight(82), trace_map(72) |
