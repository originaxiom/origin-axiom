...
> Last generated: 2026-08-21 from 1007 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1007 frontier probes; status {'open': 63, 'banked': 666, 'dead': 259, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 231x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(571), firewall(556), eisenstein(528), figure_eight(419), metallic(407), trace_map(386)
  recurrence is: structural-invariant 3347 mentions | conserved-integral 231 | TOOL 386
  the honest split: the trace-map TOOL is in 386 probes (38%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
| metallic | 407 | 40% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 386 | 38% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 348 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **The hammer (selection effect):** the trace-map **tool** appears in **386** probes (38%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
