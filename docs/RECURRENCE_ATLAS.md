...
> Last generated: 2026-07-18 from 624 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 624 frontier probes; status {'banked': 424, 'dead': 136, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 180x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(419), golden(402), eisenstein(324), metallic(309), trace_map(294), figure_eight(283)
  recurrence is: structural-invariant 2303 mentions | conserved-integral 180 | TOOL 294
  the honest split: the trace-map TOOL is in 294 probes (47%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 419 | 67% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 402 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 324 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| metallic | 309 | 49% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 294 | 47% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| figure_eight | 283 | 45% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| torsion | 220 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 209 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 180 | 28% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| wrt_quantum | 161 | 25% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 130 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 111 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| dickson_tower | 94 | 15% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| symplectic | 89 | 14% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| apolynomial | 62 | 9% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **180** probes (28%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2303** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **294** probes (47%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| measure | 37 | firewall | firewall(24), golden(24), trace_map(15), figure_eight(13) |
...
| particle_dict | 47 | eisenstein | eisenstein(39), firewall(36), golden(34), z3_generation(32) |
| spacetime_3p1 | 77 | metallic | figure_eight(53), metallic(46), golden(46), trace_map(45) |
