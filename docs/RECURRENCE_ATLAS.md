...
> Last generated: 2026-07-28 from 720 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 720 frontier probes; status {'banked': 484, 'dead': 167, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 188x, 26%) -- genuine unity, MUST recur
  top recurring motifs: firewall(474), golden(471), eisenstein(396), figure_eight(343), metallic(340), trace_map(333)
  recurrence is: structural-invariant 2656 mentions | conserved-integral 188 | TOOL 333
...
| eisenstein | 396 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 343 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2656** mentions — invariants of the object's transforms.
