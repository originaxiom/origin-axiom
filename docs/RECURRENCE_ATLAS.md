...
> Last generated: 2026-08-11 from 947 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 947 frontier probes; status {'open': 60, 'banked': 620, 'dead': 248, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 221x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(543), firewall(538), eisenstein(498), figure_eight(403), metallic(396), trace_map(371)
  recurrence is: structural-invariant 3195 mentions | conserved-integral 221 | TOOL 371
...
|---|---|---|---|---|---|---|
| golden | 543 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 538 | 56% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 498 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 403 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 396 | 41% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 371 | 39% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 315 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 303 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 228 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 221 | 23% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **221** probes (23%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3195** mentions — invariants of the object's transforms.
...
| measure | 88 | golden | golden(49), firewall(45), eisenstein(43), figure_eight(36) |
...
| particle_dict | 77 | eisenstein | eisenstein(55), firewall(52), z3_generation(50), golden(45) |
