...
> Last generated: 2026-08-28 from 1085 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1085 frontier probes; status {'open': 63, 'banked': 720, 'dead': 282, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 241x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(618), firewall(597), eisenstein(589), figure_eight(455), metallic(420), trace_map(402)
  recurrence is: structural-invariant 3588 mentions | conserved-integral 241 | TOOL 402
...
|---|---|---|---|---|---|---|
| golden | 618 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 597 | 55% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 589 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3588** mentions — invariants of the object's transforms.
