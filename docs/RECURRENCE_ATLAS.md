...
> Last generated: 2026-07-02 from 344 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 344 frontier probes; status {'banked': 234, 'dead': 54, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(225), golden(209), trace_map(200), metallic(190), figure_eight(185), eisenstein(174)
  recurrence is: structural-invariant 1263 mentions | conserved-integral 98 | TOOL 200
  the honest split: the trace-map TOOL is in 200 probes (58%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 225 | 65% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 209 | 60% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| trace_map | 200 | 58% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
...
| wrt_quantum | 85 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1263** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **200** probes (58%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
