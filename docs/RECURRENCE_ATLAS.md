...
> Last generated: 2026-07-29 from 728 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 728 frontier probes; status {'banked': 492, 'dead': 167, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 188x, 25%) -- genuine unity, MUST recur
  top recurring motifs: firewall(474), golden(473), eisenstein(401), figure_eight(349), metallic(342), trace_map(334)
  recurrence is: structural-invariant 2669 mentions | conserved-integral 188 | TOOL 334
...
| golden | 473 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 401 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 349 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| wrt_quantum | 200 | 27% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2669** mentions — invariants of the object's transforms.
...
| spacetime_3p1 | 94 | golden | figure_eight(63), golden(61), trace_map(53), metallic(53) |
