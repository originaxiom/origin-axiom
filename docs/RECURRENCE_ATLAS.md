...
> Last generated: 2026-08-27 from 1075 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1075 frontier probes; status {'open': 63, 'banked': 718, 'dead': 274, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 240x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(612), firewall(588), eisenstein(580), figure_eight(447), metallic(420), trace_map(401)
  recurrence is: structural-invariant 3554 mentions | conserved-integral 240 | TOOL 401
...
|---|---|---|---|---|---|---|
| golden | 612 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 588 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 580 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 447 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 380 | 35% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3554** mentions — invariants of the object's transforms.
