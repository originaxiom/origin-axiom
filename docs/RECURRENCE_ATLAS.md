...
THE RECURRENCE ATLAS -- context card
  ...
  top recurring motifs: firewall(409), golden(371), eisenstein(294), metallic(286), trace_map(283), figure_eight(274)
  recurrence is: structural-invariant 2156 mentions | conserved-integral 166 | TOOL 283
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2156** mentions — invariants of the object's transforms.
...
| observable | 26 | golden | golden(18), metallic(14), torsion(14), firewall(14) |
