...
> Last generated: 2026-08-01 from 769 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 769 frontier probes; status {'banked': 505, 'dead': 191, 'open': 54, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 199x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(486), firewall(480), eisenstein(409), figure_eight(361), metallic(352), trace_map(341)
  recurrence is: structural-invariant 2791 mentions | conserved-integral 199 | TOOL 341
...
|---|---|---|---|---|---|---|
| golden | 486 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 480 | 62% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 409 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 361 | 46% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 352 | 45% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2791** mentions — invariants of the object's transforms.
