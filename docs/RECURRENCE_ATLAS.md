...
> Last generated: 2026-09-16 from 1240 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1240 frontier probes; status {'open': 70, 'banked': 813, 'dead': 333, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 280x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(699), golden(691), firewall(642), figure_eight(538), amphichiral_cp(470), metallic(463)
  recurrence is: structural-invariant 4948 mentions | conserved-integral 280 | TOOL 452
  the honest split: the trace-map TOOL is in 452 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| eisenstein | 699 | 56% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| golden | 691 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 642 | 51% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 538 | 43% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| amphichiral_cp | 470 | 37% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| metallic | 463 | 37% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 452 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| closing | 389 | 31% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
...
| torsion | 379 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| z3_generation | 319 | 25% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| measurement | 308 | 24% | question | no | dynamics | collapse, decoherence, the measurement postulate as a structural shape rather than an added axiom |
...
| symplectic | 128 | 10% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4948** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **452** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
