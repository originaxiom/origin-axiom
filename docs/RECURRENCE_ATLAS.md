...
> Last generated: 2026-07-18 from 617 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 617 frontier probes; status {'banked': 419, 'dead': 134, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 178x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(416), golden(396), eisenstein(320), metallic(306), trace_map(294), figure_eight(280)
  recurrence is: structural-invariant 2275 mentions | conserved-integral 178 | TOOL 294
...
|---|---|---|---|---|---|---|
| firewall | 416 | 67% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 396 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 320 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| metallic | 306 | 49% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 294 | 47% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| figure_eight | 280 | 45% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2275** mentions — invariants of the object's transforms.
