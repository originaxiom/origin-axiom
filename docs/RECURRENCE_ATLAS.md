...
> Last generated: 2026-08-21 from 1011 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1011 frontier probes; status {'open': 66, 'banked': 661, 'dead': 263, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 231x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(569), firewall(549), eisenstein(528), figure_eight(421), metallic(403), trace_map(379)
  recurrence is: structural-invariant 3326 mentions | conserved-integral 231 | TOOL 379
...
| figure_eight | 421 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| torsion | 319 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3326** mentions — invariants of the object's transforms.
