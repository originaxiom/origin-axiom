...
> Last generated: 2026-08-19 from 981 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 981 frontier probes; status {'open': 64, 'banked': 642, 'dead': 254, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 227x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(558), firewall(548), eisenstein(519), figure_eight(409), metallic(400), trace_map(374)
  recurrence is: structural-invariant 3280 mentions | conserved-integral 227 | TOOL 374
  the honest split: the trace-map TOOL is in 374 probes (38%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 558 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 548 | 55% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 519 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 409 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 400 | 40% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 374 | 38% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 330 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 307 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 232 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
| lorentzian | 178 | 18% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **The hammer (selection effect):** the trace-map **tool** appears in **374** probes (38%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| measure | 93 | golden | golden(50), eisenstein(46), firewall(45), figure_eight(38) |
...
| spacetime_3p1 | 114 | golden | golden(69), eisenstein(67), figure_eight(66), trace_map(54) |
