...
> Last generated: 2026-08-28 from 1087 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1087 frontier probes; status {'open': 63, 'banked': 722, 'dead': 282, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 241x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(619), firewall(599), eisenstein(590), figure_eight(455), metallic(420), trace_map(402)
  recurrence is: structural-invariant 3594 mentions | conserved-integral 241 | TOOL 402
  the honest split: the trace-map TOOL is in 402 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
| firewall | 599 | 55% | structure | structural | meta | the firewall / structural theorem / form-not-values |
...
| trace_map | 402 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3594** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **402** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
