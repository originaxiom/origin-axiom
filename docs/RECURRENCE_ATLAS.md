...
> Last generated: 2026-09-06 from 1171 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1171 frontier probes; status {'open': 67, 'banked': 767, 'dead': 314, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 262x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(654), eisenstein(647), firewall(626), figure_eight(492), metallic(433), amphichiral_cp(426)
  recurrence is: structural-invariant 4497 mentions | conserved-integral 262 | TOOL 425
...
| eisenstein | 647 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| firewall | 626 | 53% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 492 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 433 | 36% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| amphichiral_cp | 426 | 36% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| trace_map | 425 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| coupling | 364 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
| torsion | 357 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| closing | 348 | 29% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
...
| z3_generation | 276 | 23% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| lorentzian | 208 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4497** mentions — invariants of the object's transforms.
...
| spacetime_3p1 | 134 | eisenstein | eisenstein(79), golden(78), figure_eight(72), trace_map(64) |
