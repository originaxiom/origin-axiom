...
> Last generated: 2026-09-03 from 1147 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1147 frontier probes; status {'open': 66, 'banked': 755, 'dead': 304, 'dormant': 22}
  the ONE conserved first integral: kappa (recurs 255x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(644), eisenstein(627), firewall(620), figure_eight(483), metallic(429), amphichiral_cp(420)
  recurrence is: structural-invariant 3769 mentions | conserved-integral 255 | TOOL 416
  the honest split: the trace-map TOOL is in 416 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 644 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 627 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| firewall | 620 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 483 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| trace_map | 416 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 350 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| lorentzian | 205 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3769** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **416** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
