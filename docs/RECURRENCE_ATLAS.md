...
> Last generated: 2026-08-18 from 979 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 979 frontier probes; status {'open': 64, 'banked': 641, 'dead': 254, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 227x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(557), firewall(548), eisenstein(517), figure_eight(408), metallic(400), trace_map(374)
  recurrence is: structural-invariant 3275 mentions | conserved-integral 227 | TOOL 374
...
|---|---|---|---|---|---|---|
| golden | 557 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| figure_eight | 408 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| wrt_quantum | 231 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
