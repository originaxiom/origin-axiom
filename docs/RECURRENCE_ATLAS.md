...
> Last generated: 2026-07-22 from 685 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 685 frontier probes; status {'banked': 461, 'dead': 159, 'open': 48, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 184x, 26%) -- genuine unity, MUST recur
  top recurring motifs: firewall(460), golden(449), eisenstein(377), metallic(329), figure_eight(325), trace_map(320)
  recurrence is: structural-invariant 2551 mentions | conserved-integral 184 | TOOL 320
  the honest split: the trace-map TOOL is in 320 probes (46%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 460 | 67% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 449 | 65% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 377 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| metallic | 329 | 48% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| figure_eight | 325 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| trace_map | 320 | 46% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 254 | 37% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 234 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| wrt_quantum | 186 | 27% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 184 | 26% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| z3_generation | 145 | 21% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 122 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| dickson_tower | 97 | 14% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
...
| quasicrystal | 62 | 9% | dynamics | structural | quantum | the Fibonacci quasicrystal / Suto / Damanik-Gorodetski |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **184** probes (26%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2551** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **320** probes (46%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
|---|---|---|---|
| cancellation | 38 | golden | golden(26), firewall(24), eisenstein(23), trace_map(21) |
| selector | 17 | firewall | firewall(11), trace_map(10), eisenstein(10), golden(10) |
| measure | 48 | golden | golden(34), firewall(32), eisenstein(23), figure_eight(21) |
...
| particle_dict | 52 | eisenstein | eisenstein(44), firewall(40), golden(38), z3_generation(34) |
| spacetime_3p1 | 85 | golden | figure_eight(56), golden(54), metallic(51), trace_map(50) |
