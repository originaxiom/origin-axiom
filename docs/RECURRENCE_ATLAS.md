...
> Last generated: 2026-07-02 from 336 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 336 frontier probes; status {'banked': 228, 'dead': 52, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 29%) -- genuine unity, MUST recur
  top recurring motifs: firewall(217), golden(202), trace_map(198), metallic(187), figure_eight(184), eisenstein(167)
  recurrence is: structural-invariant 1229 mentions | conserved-integral 98 | TOOL 198
  the honest split: the trace-map TOOL is in 198 probes (58%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 217 | 64% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 202 | 60% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| trace_map | 198 | 58% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| metallic | 187 | 55% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| figure_eight | 184 | 54% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| eisenstein | 167 | 49% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| amphichiral_cp | 101 | 30% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 98 | 29% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| torsion | 87 | 25% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 83 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| dickson_tower | 76 | 22% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| z3_generation | 65 | 19% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| symplectic | 61 | 18% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **98** probes (29%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1229** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **198** probes (58%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
|---|---|---|---|
| cancellation | 18 | golden | trace_map(15), figure_eight(13), golden(13), eisenstein(11) |
| selector | 13 | golden | trace_map(9), figure_eight(8), golden(8), firewall(8) |
...
| spacetime_3p1 | 54 | metallic | figure_eight(38), metallic(37), trace_map(35), dickson_tower(34) |
