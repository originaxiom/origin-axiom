...
> Last generated: 2026-07-30 from 740 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 740 frontier probes; status {'banked': 497, 'dead': 174, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 191x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(480), firewall(476), eisenstein(404), figure_eight(355), metallic(345), trace_map(337)
  recurrence is: structural-invariant 2697 mentions | conserved-integral 191 | TOOL 337
...
|---|---|---|---|---|---|---|
| golden | 480 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| figure_eight | 355 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| torsion | 277 | 37% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2697** mentions — invariants of the object's transforms.
