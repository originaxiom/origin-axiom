...
THE RECURRENCE ATLAS -- context card
  corpus: 995 frontier probes; status {'open': 63, 'banked': 656, 'dead': 257, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 229x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(565), firewall(553), eisenstein(525), figure_eight(416), metallic(405), trace_map(381)
  recurrence is: structural-invariant 3317 mentions | conserved-integral 229 | TOOL 381
...
| eisenstein | 525 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| lorentzian | 178 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3317** mentions — invariants of the object's transforms.
...
| spacetime_3p1 | 113 | golden | figure_eight(68), golden(67), eisenstein(64), trace_map(56) |
