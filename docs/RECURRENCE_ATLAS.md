...
> Last generated: 2026-09-17 from 1248 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1248 frontier probes; status {'open': 70, 'banked': 817, 'dead': 337, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 281x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(705), golden(695), firewall(642), figure_eight(546), amphichiral_cp(477), metallic(466)
  recurrence is: structural-invariant 4986 mentions | conserved-integral 281 | TOOL 455
  the honest split: the trace-map TOOL is in 455 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| eisenstein | 705 | 56% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| golden | 695 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| trace_map | 455 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
...
| apolynomial | 86 | 6% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
...
- **The hammer (selection effect):** the trace-map **tool** appears in **455** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
