...
> Last generated: 2026-07-02 from 345 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 345 frontier probes; status {'banked': 234, 'dead': 55, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(226), golden(209), trace_map(200), metallic(190), figure_eight(185), eisenstein(174)
  recurrence is: structural-invariant 1265 mentions | conserved-integral 98 | TOOL 200
...
|---|---|---|---|---|---|---|
| firewall | 226 | 65% | structure | structural | meta | the firewall / structural theorem / form-not-values |
...
| metallic | 190 | 55% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| symplectic | 63 | 18% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| lorentzian | 55 | 15% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1265** mentions — invariants of the object's transforms.
