...
> Last generated: 2026-08-26 from 1062 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1062 frontier probes; status {'open': 63, 'banked': 710, 'dead': 269, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 238x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(605), firewall(577), eisenstein(570), figure_eight(440), metallic(419), trace_map(399)
  recurrence is: structural-invariant 3508 mentions | conserved-integral 238 | TOOL 399
...
|---|---|---|---|---|---|---|
| golden | 605 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 577 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 570 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 440 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 371 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| z3_generation | 239 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3508** mentions — invariants of the object's transforms.
...
| particle_dict | 90 | eisenstein | eisenstein(64), z3_generation(58), firewall(58), golden(54) |
