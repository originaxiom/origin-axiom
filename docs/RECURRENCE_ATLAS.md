...
> Last generated: 2026-07-30 from 741 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 741 frontier probes; status {'banked': 497, 'dead': 175, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 192x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(481), firewall(476), eisenstein(405), figure_eight(356), metallic(345), trace_map(338)
  recurrence is: structural-invariant 2702 mentions | conserved-integral 192 | TOOL 338
...
|---|---|---|---|---|---|---|
| golden | 481 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 476 | 64% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 405 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 356 | 48% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 249 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| wrt_quantum | 202 | 27% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 192 | 25% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **192** probes (25%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2702** mentions — invariants of the object's transforms.
