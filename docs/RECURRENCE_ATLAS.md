...
> Last generated: 2026-09-02 from 1145 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1145 frontier probes; status {'open': 64, 'banked': 755, 'dead': 304, 'dormant': 22}
  the ONE conserved first integral: kappa (recurs 254x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(642), eisenstein(626), firewall(619), figure_eight(481), metallic(428), amphichiral_cp(419)
  recurrence is: structural-invariant 3759 mentions | conserved-integral 254 | TOOL 415
  the honest split: the trace-map TOOL is in 415 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 642 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 626 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| firewall | 619 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 481 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 428 | 37% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| amphichiral_cp | 419 | 36% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| trace_map | 415 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 349 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 270 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 261 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| kappa | 254 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| lorentzian | 204 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **254** probes (22%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3759** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **415** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
