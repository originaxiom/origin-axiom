...
> Last generated: 2026-07-18 from 630 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 630 frontier probes; status {'banked': 428, 'dead': 137, 'open': 48, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 180x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(425), golden(407), eisenstein(328), metallic(311), trace_map(294), figure_eight(286)
  recurrence is: structural-invariant 2322 mentions | conserved-integral 180 | TOOL 294
...
|---|---|---|---|---|---|---|
| firewall | 425 | 67% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 407 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 328 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| metallic | 311 | 49% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 294 | 46% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| figure_eight | 286 | 45% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| torsion | 221 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| wrt_quantum | 164 | 26% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
| apolynomial | 63 | 10% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2322** mentions — invariants of the object's transforms.
...
| measure | 38 | firewall | firewall(25), golden(25), trace_map(15), figure_eight(14) |
...
| particle_dict | 48 | eisenstein | eisenstein(40), firewall(37), golden(35), z3_generation(32) |
| spacetime_3p1 | 78 | metallic | figure_eight(53), metallic(47), golden(47), trace_map(45) |
