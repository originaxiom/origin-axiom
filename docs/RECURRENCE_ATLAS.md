...
> Last generated: 2026-09-06 from 1178 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1178 frontier probes; status {'open': 67, 'banked': 771, 'dead': 316, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 264x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(659), eisenstein(653), firewall(626), figure_eight(495), metallic(433), amphichiral_cp(430)
  recurrence is: structural-invariant 4525 mentions | conserved-integral 264 | TOOL 427
...
| eisenstein | 653 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| firewall | 626 | 53% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 495 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 433 | 36% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| amphichiral_cp | 430 | 36% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| closing | 350 | 29% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
...
| z3_generation | 281 | 23% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| naming | 41 | 3% | question | structural | arithmetic | self-reference, the quine, self-name vs self-sign -- naming and choosing proved complementary (B762/B1184) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4525** mentions — invariants of the object's transforms.
...
| cancellation | 62 | golden | golden(38), eisenstein(37), firewall(35), trace_map(28) |
...
| particle_dict | 98 | eisenstein | eisenstein(69), z3_generation(64), firewall(62), golden(60) |
