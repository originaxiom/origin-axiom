...
> Last generated: 2026-09-06 from 1179 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1179 frontier probes; status {'open': 67, 'banked': 774, 'dead': 315, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 263x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(658), eisenstein(655), firewall(627), figure_eight(498), amphichiral_cp(433), metallic(433)
  recurrence is: structural-invariant 4534 mentions | conserved-integral 263 | TOOL 427
...
|---|---|---|---|---|---|---|
| golden | 658 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| z3_generation | 283 | 24% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4534** mentions — invariants of the object's transforms.
...
| spacetime_3p1 | 137 | eisenstein | eisenstein(82), golden(79), figure_eight(74), trace_map(65) |
