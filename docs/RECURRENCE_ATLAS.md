...
THE RECURRENCE ATLAS -- context card
  corpus: 1177 frontier probes; status {'open': 67, 'banked': 773, 'dead': 314, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 263x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(656), eisenstein(653), firewall(626), figure_eight(496), metallic(433), amphichiral_cp(431)
  recurrence is: structural-invariant 4521 mentions | conserved-integral 263 | TOOL 426
  the honest split: the trace-map TOOL is in 426 probes (36%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 656 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| trace_map | 426 | 36% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4521** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **426** probes (36%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| spacetime_3p1 | 136 | eisenstein | eisenstein(81), golden(78), figure_eight(73), closing(64) |
