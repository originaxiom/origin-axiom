...
> Last generated: 2026-09-15 from 1237 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1237 frontier probes; status {'open': 70, 'banked': 810, 'dead': 333, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 280x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(697), golden(688), firewall(641), figure_eight(536), amphichiral_cp(468), metallic(460)
  recurrence is: structural-invariant 4924 mentions | conserved-integral 280 | TOOL 450
...
|---|---|---|---|---|---|---|
| eisenstein | 697 | 56% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| golden | 688 | 55% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| metallic | 460 | 37% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| closing | 386 | 31% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
...
| wrt_quantum | 285 | 23% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
| choice | 189 | 15% | question | structural | arithmetic | the residual bit(s): the torsor of closings, the basepoint bit, what the object can and cannot select (A7/B766/B1183/B1225) |
