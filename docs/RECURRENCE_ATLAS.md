...
> Last generated: 2026-09-06 from 1172 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1172 frontier probes; status {'open': 67, 'banked': 768, 'dead': 314, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 262x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(654), eisenstein(648), firewall(626), figure_eight(492), metallic(433), amphichiral_cp(426)
  recurrence is: structural-invariant 4500 mentions | conserved-integral 262 | TOOL 425
...
| eisenstein | 648 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| firewall | 626 | 53% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 492 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| z3_generation | 277 | 23% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4500** mentions — invariants of the object's transforms.
