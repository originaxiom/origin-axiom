...
> Last generated: 2026-08-11 from 957 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 957 frontier probes; status {'open': 62, 'banked': 628, 'dead': 247, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 227x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(548), firewall(543), eisenstein(504), figure_eight(409), metallic(403), trace_map(384)
  recurrence is: structural-invariant 3236 mentions | conserved-integral 227 | TOOL 384
...
| eisenstein | 504 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| amphichiral_cp | 316 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| kappa | 227 | 23% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **227** probes (23%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3236** mentions — invariants of the object's transforms.
...
| measure | 91 | golden | golden(49), firewall(46), eisenstein(45), figure_eight(37) |
