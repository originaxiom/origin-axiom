...
> Last generated: 2026-07-29 from 731 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 731 frontier probes; status {'banked': 494, 'dead': 168, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 188x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(476), firewall(474), eisenstein(402), figure_eight(351), metallic(342), trace_map(335)
  recurrence is: structural-invariant 2674 mentions | conserved-integral 188 | TOOL 335
  the honest split: the trace-map TOOL is in 335 probes (45%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
| eisenstein | 402 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 351 | 48% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 342 | 46% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 335 | 45% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 272 | 37% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 246 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2674** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **335** probes (45%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
