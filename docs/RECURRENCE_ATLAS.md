...
> Last generated: 2026-08-27 from 1077 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1077 frontier probes; status {'open': 63, 'banked': 718, 'dead': 276, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 240x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(613), firewall(589), eisenstein(581), figure_eight(449), metallic(420), trace_map(401)
  recurrence is: structural-invariant 3559 mentions | conserved-integral 240 | TOOL 401
...
| figure_eight | 449 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 382 | 35% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3559** mentions — invariants of the object's transforms.
