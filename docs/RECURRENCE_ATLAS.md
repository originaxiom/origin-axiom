...
THE RECURRENCE ATLAS -- context card
  corpus: 1013 frontier probes; status {'open': 63, 'banked': 671, 'dead': 260, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 232x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(574), firewall(556), eisenstein(531), figure_eight(420), metallic(409), trace_map(387)
  recurrence is: structural-invariant 3363 mentions | conserved-integral 232 | TOOL 387
...
|---|---|---|---|---|---|---|
| golden | 574 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 556 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 531 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| amphichiral_cp | 351 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 314 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3363** mentions — invariants of the object's transforms.
...
| spacetime_3p1 | 116 | golden | golden(69), figure_eight(68), eisenstein(66), trace_map(56) |
