...
> Last generated: 2026-07-18 from 622 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 622 frontier probes; status {'banked': 423, 'dead': 135, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 179x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(418), golden(400), eisenstein(322), metallic(308), trace_map(294), figure_eight(282)
  recurrence is: structural-invariant 2293 mentions | conserved-integral 179 | TOOL 294
...
| golden | 400 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 322 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| metallic | 308 | 49% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| torsion | 218 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 209 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 179 | 28% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| wrt_quantum | 160 | 25% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 128 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **179** probes (28%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2293** mentions — invariants of the object's transforms.
