...
> Last generated: 2026-08-22 from 1035 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1035 frontier probes; status {'open': 63, 'banked': 690, 'dead': 263, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 234x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(585), firewall(561), eisenstein(548), figure_eight(425), metallic(417), trace_map(394)
  recurrence is: structural-invariant 3417 mentions | conserved-integral 234 | TOOL 394
  the honest split: the trace-map TOOL is in 394 probes (38%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 585 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 561 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 548 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| trace_map | 394 | 38% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 361 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| lorentzian | 187 | 18% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3417** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **394** probes (38%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| spacetime_3p1 | 121 | eisenstein | eisenstein(70), golden(70), figure_eight(68), trace_map(61) |
