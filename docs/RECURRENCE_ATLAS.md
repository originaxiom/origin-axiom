...
> Last generated: 2026-07-17 from 603 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 603 frontier probes; status {'banked': 410, 'dead': 129, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 173x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(412), golden(384), eisenstein(310), metallic(293), trace_map(292), figure_eight(278)
  recurrence is: structural-invariant 2225 mentions | conserved-integral 173 | TOOL 292
  the honest split: the trace-map TOOL is in 292 probes (48%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 412 | 68% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 384 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 310 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| metallic | 293 | 48% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 292 | 48% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| figure_eight | 278 | 46% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| torsion | 215 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 204 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 173 | 28% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| wrt_quantum | 152 | 25% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 121 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 107 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| dickson_tower | 93 | 15% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| symplectic | 88 | 14% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
...
| five_web | 22 | 3% | arithmetic | structural | arithmetic | the '5' recurrence web (H2): 40a1, conductor 40, Pisano |

### The honest split — unity vs the hammer

- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **173** probes (28%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2225** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **292** probes (48%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
|---|---|---|---|
| cancellation | 36 | golden | golden(25), firewall(23), eisenstein(22), trace_map(21) |
...
| units_scale | 73 | firewall | firewall(57), golden(49), metallic(41), trace_map(38) |
| gauge_dict | 35 | firewall | firewall(29), figure_eight(23), golden(22), eisenstein(22) |
| particle_dict | 43 | eisenstein | eisenstein(36), firewall(36), golden(30), z3_generation(30) |
| spacetime_3p1 | 76 | metallic | figure_eight(53), trace_map(45), metallic(45), golden(45) |
| observable | 28 | golden | golden(21), torsion(16), firewall(15), metallic(14) |
| numerology | 18 | firewall | firewall(14), metallic(13), golden(13), eisenstein(13) |
