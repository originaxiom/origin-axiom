...
> Last generated: 2026-08-12 from 953 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 953 frontier probes; status {'open': 60, 'banked': 626, 'dead': 248, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 222x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(545), firewall(539), eisenstein(503), figure_eight(403), metallic(396), trace_map(371)
  recurrence is: structural-invariant 3210 mentions | conserved-integral 222 | TOOL 371
...
| eisenstein | 503 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3210** mentions — invariants of the object's transforms.
