...
> Last generated: 2026-09-06 from 1164 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1164 frontier probes; status {'open': 67, 'banked': 762, 'dead': 312, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 260x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(650), eisenstein(642), firewall(626), figure_eight(490), metallic(432), trace_map(422)
  recurrence is: structural-invariant 4468 mentions | conserved-integral 260 | TOOL 422
...
| eisenstein | 642 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| closing | 344 | 29% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4468** mentions — invariants of the object's transforms.
