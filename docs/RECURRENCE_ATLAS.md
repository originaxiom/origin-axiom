...
> Last generated: 2026-08-21 from 1025 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1025 frontier probes; status {'open': 63, 'banked': 681, 'dead': 262, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 234x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(578), firewall(558), eisenstein(540), figure_eight(424), metallic(414), trace_map(391)
  recurrence is: structural-invariant 3393 mentions | conserved-integral 234 | TOOL 391
  the honest split: the trace-map TOOL is in 391 probes (38%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
| firewall | 558 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 540 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| trace_map | 391 | 38% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 358 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3393** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **391** probes (38%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| spacetime_3p1 | 119 | golden | golden(69), eisenstein(68), figure_eight(68), trace_map(59) |
