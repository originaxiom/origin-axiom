...
> Last generated: 2026-08-03 from 789 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 789 frontier probes; status {'banked': 513, 'dead': 202, 'open': 55, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 202x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(494), firewall(485), eisenstein(423), figure_eight(368), metallic(359), trace_map(348)
  recurrence is: structural-invariant 2855 mentions | conserved-integral 202 | TOOL 348
  the honest split: the trace-map TOOL is in 348 probes (44%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 494 | 62% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 485 | 61% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 423 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| trace_map | 348 | 44% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 283 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 263 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| z3_generation | 164 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 141 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2855** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **348** probes (44%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| particle_dict | 58 | eisenstein | eisenstein(46), golden(41), firewall(41), z3_generation(37) |
