...
> Last generated: 2026-07-18 from 621 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 621 frontier probes; status {'banked': 422, 'dead': 135, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 179x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(417), golden(399), eisenstein(321), metallic(308), trace_map(294), figure_eight(281)
  recurrence is: structural-invariant 2289 mentions | conserved-integral 179 | TOOL 294
...
|---|---|---|---|---|---|---|
| firewall | 417 | 67% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 399 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 321 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| figure_eight | 281 | 45% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| z3_generation | 127 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2289** mentions — invariants of the object's transforms.
