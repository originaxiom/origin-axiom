...
> Last generated: 2026-08-02 from 775 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 775 frontier probes; status {'banked': 507, 'dead': 195, 'open': 54, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 200x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(489), firewall(483), eisenstein(415), figure_eight(365), metallic(356), trace_map(345)
  recurrence is: structural-invariant 2815 mentions | conserved-integral 200 | TOOL 345
  the honest split: the trace-map TOOL is in 345 probes (44%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 489 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 483 | 62% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 415 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 365 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 356 | 45% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 345 | 44% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 282 | 36% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 254 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| wrt_quantum | 205 | 26% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 200 | 25% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| z3_generation | 155 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 133 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| dickson_tower | 104 | 13% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| symplectic | 94 | 12% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| apolynomial | 74 | 9% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2815** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **345** probes (44%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
