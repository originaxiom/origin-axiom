...
> Last generated: 2026-07-13 from 526 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  ...
  top recurring motifs: firewall(382), golden(332), metallic(267), trace_map(263), eisenstein(257), figure_eight(250)
  recurrence is: structural-invariant 1948 mentions | conserved-integral 140 | TOOL 263
...
| golden | 332 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1948** mentions — invariants of the object's transforms.
