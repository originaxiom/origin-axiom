...
> Last generated: 2026-07-14 from 533 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 533 frontier probes; status {'banked': 351, 'dead': 118, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 140x, 26%) -- genuine unity, MUST recur
  top recurring motifs: firewall(388), golden(336), metallic(269), trace_map(266), eisenstein(263), figure_eight(253)
  recurrence is: structural-invariant 1977 mentions | conserved-integral 140 | TOOL 266
  the honest split: the trace-map TOOL is in 266 probes (49%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 388 | 72% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 336 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| metallic | 269 | 50% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 266 | 49% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| eisenstein | 263 | 49% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 253 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| torsion | 185 | 34% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 165 | 30% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 140 | 26% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| wrt_quantum | 132 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 105 | 19% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 98 | 18% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| dickson_tower | 89 | 16% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| symplectic | 76 | 14% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1977** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **266** probes (49%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
|---|---|---|---|
| cancellation | 32 | golden | golden(23), firewall(23), trace_map(20), eisenstein(19) |
| selector | 17 | firewall | firewall(12), figure_eight(10), trace_map(10), eisenstein(10) |
| measure | 30 | firewall | firewall(20), golden(19), trace_map(13), figure_eight(11) |
