...
> Last generated: 2026-07-17 from 604 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 604 frontier probes; status {'banked': 411, 'dead': 129, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 173x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(413), golden(385), eisenstein(311), metallic(294), trace_map(293), figure_eight(278)
  recurrence is: structural-invariant 2230 mentions | conserved-integral 173 | TOOL 293
...
| golden | 385 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 311 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| metallic | 294 | 48% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| wrt_quantum | 153 | 25% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2230** mentions — invariants of the object's transforms.
