...
> Last generated: 2026-08-26 from 1059 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1059 frontier probes; status {'open': 63, 'banked': 707, 'dead': 269, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 238x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(603), firewall(574), eisenstein(569), figure_eight(439), metallic(419), trace_map(399)
  recurrence is: structural-invariant 3498 mentions | conserved-integral 238 | TOOL 399
...
|---|---|---|---|---|---|---|
| golden | 603 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 574 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 569 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| torsion | 321 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3498** mentions — invariants of the object's transforms.
