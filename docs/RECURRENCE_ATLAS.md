...
> Last generated: 2026-07-02 from 346 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 346 frontier probes; status {'banked': 234, 'dead': 56, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(227), golden(209), trace_map(200), metallic(190), figure_eight(185), eisenstein(174)
  recurrence is: structural-invariant 1267 mentions | conserved-integral 98 | TOOL 200
...
|---|---|---|---|---|---|---|
| firewall | 227 | 65% | structure | structural | meta | the firewall / structural theorem / form-not-values |
...
| torsion | 92 | 26% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| lorentzian | 56 | 16% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1267** mentions — invariants of the object's transforms.
