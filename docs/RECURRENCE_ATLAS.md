...
> Last generated: 2026-08-10 from 930 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 930 frontier probes; status {'open': 60, 'banked': 610, 'dead': 241, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 220x, 23%) -- genuine unity, MUST recur
  top recurring motifs: firewall(538), golden(535), eisenstein(491), figure_eight(403), metallic(393), trace_map(371)
  recurrence is: structural-invariant 3165 mentions | conserved-integral 220 | TOOL 371
...
| golden | 535 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 491 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 403 | 43% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 393 | 42% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 371 | 39% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 307 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| z3_generation | 208 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3165** mentions — invariants of the object's transforms.
...
| measure | 84 | golden | golden(47), firewall(45), eisenstein(41), figure_eight(36) |
| units_scale | 92 | firewall | firewall(66), golden(60), metallic(51), eisenstein(47) |
