...
> Last generated: 2026-08-26 from 1061 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1061 frontier probes; status {'open': 63, 'banked': 709, 'dead': 269, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 238x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(604), firewall(576), eisenstein(570), figure_eight(439), metallic(419), trace_map(399)
  recurrence is: structural-invariant 3505 mentions | conserved-integral 238 | TOOL 399
...
| firewall | 576 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
...
| z3_generation | 238 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3505** mentions — invariants of the object's transforms.
...
| particle_dict | 89 | eisenstein | eisenstein(64), z3_generation(57), firewall(57), golden(53) |
