...
THE RECURRENCE ATLAS -- context card
  corpus: 1175 frontier probes; status {'open': 67, 'banked': 770, 'dead': 315, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 263x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(657), eisenstein(650), firewall(626), figure_eight(494), metallic(433), amphichiral_cp(428)
  recurrence is: structural-invariant 4511 mentions | conserved-integral 263 | TOOL 427
...
| dickson_tower | 109 | 9% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4511** mentions — invariants of the object's transforms.
...
| selector | 21 | eisenstein | eisenstein(14), golden(12), firewall(12), figure_eight(11) |
