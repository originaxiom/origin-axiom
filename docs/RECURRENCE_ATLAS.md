...
> Last generated: 2026-08-26 from 1054 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1054 frontier probes; status {'open': 63, 'banked': 705, 'dead': 267, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 237x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(599), firewall(570), eisenstein(564), figure_eight(434), metallic(419), trace_map(398)
  recurrence is: structural-invariant 3479 mentions | conserved-integral 237 | TOOL 398
...
|---|---|---|---|---|---|---|
| golden | 599 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 570 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 564 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 434 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 368 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3479** mentions — invariants of the object's transforms.
...
| particle_dict | 86 | eisenstein | eisenstein(62), z3_generation(56), firewall(55), golden(51) |
