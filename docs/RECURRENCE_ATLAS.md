...
> Last generated: 2026-08-21 from 1014 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1014 frontier probes; status {'open': 66, 'banked': 663, 'dead': 264, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 231x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(570), firewall(551), eisenstein(529), figure_eight(423), metallic(404), trace_map(379)
  recurrence is: structural-invariant 3338 mentions | conserved-integral 231 | TOOL 379
  the honest split: the trace-map TOOL is in 379 probes (37%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 570 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 551 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 529 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 423 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 404 | 39% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 379 | 37% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 336 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 321 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| z3_generation | 228 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 182 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3338** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **379** probes (37%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| measure | 103 | golden | golden(55), eisenstein(49), figure_eight(47), firewall(46) |
...
| spacetime_3p1 | 117 | golden | golden(69), eisenstein(68), figure_eight(67), metallic(55) |
