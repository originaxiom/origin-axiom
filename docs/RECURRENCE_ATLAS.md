...
> Last generated: 2026-08-12 from 968 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 968 frontier probes; status {'open': 62, 'banked': 634, 'dead': 252, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 231x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(555), firewall(548), eisenstein(509), figure_eight(411), metallic(409), trace_map(390)
  recurrence is: structural-invariant 3274 mentions | conserved-integral 231 | TOOL 390
...
| firewall | 548 | 56% | structure | structural | meta | the firewall / structural theorem / form-not-values |
...
| torsion | 310 | 32% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3274** mentions — invariants of the object's transforms.
