...
> Last generated: 2026-07-29 from 732 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 732 frontier probes; status {'banked': 495, 'dead': 168, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 188x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(476), firewall(474), eisenstein(403), figure_eight(352), metallic(342), trace_map(336)
  recurrence is: structural-invariant 2677 mentions | conserved-integral 188 | TOOL 336
  the honest split: the trace-map TOOL is in 336 probes (45%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 476 | 65% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 474 | 64% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 403 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 352 | 48% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 342 | 46% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 336 | 45% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 273 | 37% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 247 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| wrt_quantum | 201 | 27% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 188 | 25% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| z3_generation | 151 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 129 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| dickson_tower | 102 | 13% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2677** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **336** probes (45%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| measure | 51 | golden | golden(34), firewall(33), eisenstein(24), figure_eight(22) |
