...
| golden | 397 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 320 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| metallic | 307 | 49% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
...
| amphichiral_cp | 207 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| lorentzian | 109 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2279** mentions — invariants of the object's transforms.
