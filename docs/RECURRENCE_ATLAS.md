...
> Last generated: 2026-09-16 from 1242 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1242 frontier probes; status {'open': 70, 'banked': 814, 'dead': 334, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 280x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(701), golden(691), firewall(642), figure_eight(540), amphichiral_cp(471), metallic(463)
  recurrence is: structural-invariant 4955 mentions | conserved-integral 280 | TOOL 453
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4955** mentions — invariants of the object's transforms.
