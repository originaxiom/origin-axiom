...
THE RECURRENCE ATLAS -- context card
  ...
  recurrence is: structural-invariant 2167 mentions | conserved-integral 166 | TOOL 284
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2167** mentions — invariants of the object's transforms.
