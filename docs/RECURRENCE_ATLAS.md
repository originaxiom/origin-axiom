...
> Last generated: 2026-07-02 from 350 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 350 frontier probes; status {'banked': 237, 'dead': 57, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(231), golden(212), trace_map(202), metallic(192), figure_eight(185), eisenstein(177)
  recurrence is: structural-invariant 1286 mentions | conserved-integral 98 | TOOL 202
...
|---|---|---|---|---|---|---|
| firewall | 231 | 66% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 212 | 60% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| figure_eight | 185 | 52% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| eisenstein | 177 | 50% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| lorentzian | 58 | 16% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1286** mentions — invariants of the object's transforms.
