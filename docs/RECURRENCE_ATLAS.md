...
> Last generated: 2026-09-14 from 1230 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1230 frontier probes; status {'open': 70, 'banked': 807, 'dead': 329, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 279x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(694), golden(683), firewall(639), figure_eight(532), amphichiral_cp(461), metallic(456)
  recurrence is: structural-invariant 4886 mentions | conserved-integral 279 | TOOL 447
...
| firewall | 639 | 51% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 532 | 43% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| amphichiral_cp | 461 | 37% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| coupling | 385 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
| closing | 383 | 31% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
| torsion | 375 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| z3_generation | 314 | 25% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| measurement | 301 | 24% | question | no | dynamics | collapse, decoherence, the measurement postulate as a structural shape rather than an added axiom |
| wrt_quantum | 280 | 22% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 279 | 22% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
...
| symplectic | 124 | 10% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| dickson_tower | 123 | 10% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| monoid | 105 | 8% | question | structural | dynamics | End(F2) beyond the units: the four Hopfian-det strata, the non-invertible verbs the programme has never computed |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **279** probes (22%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
