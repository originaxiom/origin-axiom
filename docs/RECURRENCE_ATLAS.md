...
> Last generated: 2026-08-12 from 960 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 960 frontier probes; status {'open': 60, 'banked': 629, 'dead': 252, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 224x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(547), firewall(542), eisenstein(506), figure_eight(404), metallic(396), trace_map(373)
  recurrence is: structural-invariant 3224 mentions | conserved-integral 224 | TOOL 373
...
|---|---|---|---|---|---|---|
| golden | 547 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| amphichiral_cp | 323 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3224** mentions — invariants of the object's transforms.
