...
> Last generated: 2026-08-12 from 966 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 966 frontier probes; status {'open': 62, 'banked': 632, 'dead': 252, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 230x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(553), firewall(546), eisenstein(508), figure_eight(411), metallic(407), trace_map(388)
  recurrence is: structural-invariant 3261 mentions | conserved-integral 230 | TOOL 388
...
|---|---|---|---|---|---|---|
| golden | 553 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3261** mentions — invariants of the object's transforms.
