...
> Last generated: 2026-07-09 from 468 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 468 frontier probes; status {'banked': 311, 'dead': 97, 'open': 44, 'dormant': 16}
  the ONE conserved first integral: kappa (recurs 121x, 25%) -- genuine unity, MUST recur
  top recurring motifs: firewall(345), golden(289), metallic(244), eisenstein(235), figure_eight(234), trace_map(234)
  recurrence is: structural-invariant 1757 mentions | conserved-integral 121 | TOOL 234
  the honest split: the trace-map TOOL is in 234 probes (50%) = method/selection-effect, NOT unity; only kappa is a forced first integral
  top meeting-point candidates: B156, B309, B321, B154, B469, B140
...
|---|---|---|---|---|---|---|
| firewall | 345 | 73% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 289 | 61% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| metallic | 244 | 52% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| eisenstein | 235 | 50% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 234 | 50% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| trace_map | 234 | 50% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 167 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 145 | 30% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 121 | 25% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| wrt_quantum | 118 | 25% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 95 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| dickson_tower | 86 | 18% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| lorentzian | 76 | 16% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| symplectic | 68 | 14% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| apolynomial | 59 | 12% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
| quasicrystal | 44 | 9% | dynamics | structural | quantum | the Fibonacci quasicrystal / Suto / Damanik-Gorodetski |
| hyperbolicity_split | 23 | 4% | structure | structural | topology | the hyperbolicity-split motif (H4): object on both sides of the divide |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **121** probes (25%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1757** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **234** probes (50%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| units_scale | 57 | firewall | firewall(48), golden(38), trace_map(32), metallic(31) |
| gauge_dict | 29 | firewall | firewall(25), golden(21), figure_eight(21), eisenstein(17) |
| particle_dict | 35 | firewall | firewall(32), eisenstein(31), z3_generation(25), golden(24) |
| spacetime_3p1 | 61 | metallic | figure_eight(42), metallic(39), trace_map(36), dickson_tower(36) |
| observable | 12 | firewall | firewall(12), metallic(10), golden(8), torsion(8) |
| numerology | 14 | firewall | firewall(14), golden(12), torsion(12), eisenstein(11) |
