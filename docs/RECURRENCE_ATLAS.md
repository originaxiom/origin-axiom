...
> Last generated: 2026-08-11 from 946 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 946 frontier probes; status {'open': 60, 'banked': 619, 'dead': 248, 'dormant': 19}
  ...
  recurrence is: structural-invariant 3194 mentions | conserved-integral 221 | TOOL 371
...
| z3_generation | 211 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 169 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3194** mentions — invariants of the object's transforms.
