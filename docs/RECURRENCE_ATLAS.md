...
> Last generated: 2026-07-21 from 674 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 674 frontier probes; status {'banked': 453, 'dead': 156, 'open': 48, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 183x, 27%) -- genuine unity, MUST recur
  top recurring motifs: firewall(459), golden(441), eisenstein(369), metallic(323), figure_eight(319), trace_map(316)
  recurrence is: structural-invariant 2511 mentions | conserved-integral 183 | TOOL 316
...
|---|---|---|---|---|---|---|
| firewall | 459 | 68% | structure | structural | meta | the firewall / structural theorem / form-not-values |
...
| kappa | 183 | 27% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| z3_generation | 143 | 21% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 120 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **183** probes (27%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2511** mentions — invariants of the object's transforms.
