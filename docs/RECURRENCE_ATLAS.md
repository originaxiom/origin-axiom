...
> Last generated: 2026-08-20 from 992 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 992 frontier probes; status {'open': 63, 'banked': 654, 'dead': 256, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 229x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(565), firewall(553), eisenstein(524), figure_eight(416), metallic(405), trace_map(381)
  recurrence is: structural-invariant 3315 mentions | conserved-integral 229 | TOOL 381
  the honest split: the trace-map TOOL is in 381 probes (38%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 565 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 553 | 55% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 524 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 416 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 405 | 40% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 381 | 38% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 340 | 34% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 308 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 239 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 229 | 23% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| z3_generation | 224 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 177 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| dickson_tower | 105 | 10% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| symplectic | 97 | 9% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| apolynomial | 80 | 8% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
| quasicrystal | 67 | 6% | dynamics | structural | quantum | the Fibonacci quasicrystal / Suto / Damanik-Gorodetski |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3315** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **381** probes (38%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| cancellation | 51 | golden | golden(32), eisenstein(31), firewall(29), trace_map(23) |
| selector | 18 | firewall | firewall(12), trace_map(11), eisenstein(11), golden(11) |
| measure | 101 | golden | golden(57), eisenstein(52), firewall(50), figure_eight(41) |
| units_scale | 98 | firewall | firewall(68), golden(61), metallic(51), eisenstein(48) |
| gauge_dict | 59 | eisenstein | eisenstein(35), firewall(33), amphichiral_cp(29), figure_eight(29) |
| particle_dict | 81 | eisenstein | eisenstein(58), z3_generation(53), firewall(52), golden(46) |
| spacetime_3p1 | 111 | golden | figure_eight(68), golden(67), eisenstein(63), trace_map(56) |
| observable | 37 | golden | golden(28), metallic(19), torsion(18), firewall(17) |
| numerology | 21 | golden | golden(16), firewall(16), eisenstein(16), torsion(14) |
| bridge_construction | 7 | golden | golden(5), firewall(5), wrt_quantum(4), figure_eight(4) |
...
|---|---|
| source_free | 1/3 |
| bridge_construction | 7/17 |
| gauge_dict | 59/97 |
| measure | 101/162 |
| spacetime_3p1 | 111/176 |
| numerology | 21/33 |
| observable | 37/54 |
| cancellation | 51/74 |
