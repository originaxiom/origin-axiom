...
> Last generated: 2026-07-17 from 612 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 612 frontier probes; status {'banked': 416, 'dead': 132, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 177x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(415), golden(391), eisenstein(317), metallic(301), trace_map(293), figure_eight(279)
  recurrence is: structural-invariant 2257 mentions | conserved-integral 177 | TOOL 293
  the honest split: the trace-map TOOL is in 293 probes (47%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 415 | 67% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 391 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 317 | 51% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| metallic | 301 | 49% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 293 | 47% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| figure_eight | 279 | 45% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| torsion | 217 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 206 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 177 | 28% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| wrt_quantum | 156 | 25% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 123 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 108 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
| apolynomial | 61 | 9% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **177** probes (28%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2257** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **293** probes (47%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| gauge_dict | 36 | firewall | firewall(29), figure_eight(23), eisenstein(23), golden(22) |
| particle_dict | 45 | eisenstein | eisenstein(38), firewall(36), golden(32), z3_generation(30) |
