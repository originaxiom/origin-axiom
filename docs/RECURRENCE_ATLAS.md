...
> Last generated: 2026-07-01 from 327 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 327 frontier probes; status {'banked': 219, 'dead': 52, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 97x, 29%) -- genuine unity, MUST recur
  top recurring motifs: firewall(208), golden(200), trace_map(192), metallic(182), figure_eight(176), eisenstein(160)
  recurrence is: structural-invariant 1190 mentions | conserved-integral 97 | TOOL 192
  the honest split: the trace-map TOOL is in 192 probes (58%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 208 | 63% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 200 | 61% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| trace_map | 192 | 58% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| metallic | 182 | 55% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| figure_eight | 176 | 53% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| eisenstein | 160 | 48% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| amphichiral_cp | 98 | 29% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 97 | 29% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| torsion | 83 | 25% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| z3_generation | 62 | 18% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| apolynomial | 46 | 14% | structure | no | topology | the A-polynomial / Cooper-Long / AJ |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1190** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **192** probes (58%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| selector | 10 | golden | golden(8), trace_map(7), eisenstein(6), figure_eight(5) |
