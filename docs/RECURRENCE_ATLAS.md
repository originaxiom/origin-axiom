...
> Last generated: 2026-07-03 from 353 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 353 frontier probes; status {'banked': 239, 'dead': 58, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 27%) -- genuine unity, MUST recur
  top recurring motifs: firewall(234), golden(215), trace_map(203), metallic(194), figure_eight(186), eisenstein(179)
  recurrence is: structural-invariant 1298 mentions | conserved-integral 98 | TOOL 203
  the honest split: the trace-map TOOL is in 203 probes (57%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 234 | 66% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 215 | 60% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| trace_map | 203 | 57% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| metallic | 194 | 54% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| figure_eight | 186 | 52% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| eisenstein | 179 | 50% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| amphichiral_cp | 102 | 28% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 98 | 27% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| torsion | 97 | 27% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| lorentzian | 60 | 16% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1298** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **203** probes (57%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
|---|---|---|---|
| cancellation | 21 | golden | trace_map(16), golden(16), figure_eight(13), eisenstein(13) |
