...
> Last generated: 2026-08-11 from 950 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 950 frontier probes; status {'open': 60, 'banked': 623, 'dead': 248, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 222x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(545), firewall(538), eisenstein(501), figure_eight(403), metallic(396), trace_map(371)
  recurrence is: structural-invariant 3204 mentions | conserved-integral 222 | TOOL 371
...
| eisenstein | 501 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| amphichiral_cp | 317 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3204** mentions — invariants of the object's transforms.
