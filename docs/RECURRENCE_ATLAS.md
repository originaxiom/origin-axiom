...
> Last generated: 2026-08-11 from 942 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 942 frontier probes; status {'open': 60, 'banked': 618, 'dead': 245, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 220x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(542), firewall(538), eisenstein(497), figure_eight(403), metallic(395), trace_map(371)
  recurrence is: structural-invariant 3186 mentions | conserved-integral 220 | TOOL 371
...
|---|---|---|---|---|---|---|
| golden | 542 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 538 | 57% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 497 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 403 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 395 | 41% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 371 | 39% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 311 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| z3_generation | 210 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3186** mentions — invariants of the object's transforms.
...
| measure | 87 | golden | golden(49), firewall(45), eisenstein(43), figure_eight(36) |
