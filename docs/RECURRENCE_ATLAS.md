...
> Last generated: 2026-08-20 from 997 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 997 frontier probes; status {'open': 65, 'banked': 653, 'dead': 258, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 228x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(564), firewall(549), eisenstein(524), figure_eight(414), metallic(402), trace_map(377)
  recurrence is: structural-invariant 3305 mentions | conserved-integral 228 | TOOL 377
...
| figure_eight | 414 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3305** mentions — invariants of the object's transforms.
...
| measure | 97 | golden | golden(51), eisenstein(47), firewall(46), figure_eight(41) |
