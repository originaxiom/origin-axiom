...
> Last generated: 2026-07-29 from 738 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 738 frontier probes; status {'banked': 497, 'dead': 172, 'open': 51, 'dormant': 18}
  the ONE conserved first integral: kappa (recurs 190x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(479), firewall(476), eisenstein(404), figure_eight(354), metallic(345), trace_map(337)
  recurrence is: structural-invariant 2695 mentions | conserved-integral 190 | TOOL 337
...
| kappa | 190 | 25% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **190** probes (25%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
