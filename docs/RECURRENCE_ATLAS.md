...
> Last generated: 2026-07-03 from 360 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 360 frontier probes; status {'banked': 244, 'dead': 60, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 99x, 27%) -- genuine unity, MUST recur
  top recurring motifs: firewall(240), golden(221), trace_map(203), metallic(199), figure_eight(187), eisenstein(181)
  recurrence is: structural-invariant 1320 mentions | conserved-integral 99 | TOOL 203
  the honest split: the trace-map TOOL is in 203 probes (56%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 240 | 66% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 221 | 61% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| trace_map | 203 | 56% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| metallic | 199 | 55% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| figure_eight | 187 | 51% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| eisenstein | 181 | 50% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| amphichiral_cp | 104 | 28% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 99 | 27% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| torsion | 97 | 26% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 87 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| dickson_tower | 78 | 21% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| z3_generation | 68 | 18% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| symplectic | 65 | 18% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
| lorentzian | 61 | 16% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
| five_web | 9 | 2% | arithmetic | structural | arithmetic | the '5' recurrence web (H2): 40a1, conductor 40, Pisano |

### The honest split — unity vs the hammer

- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **99** probes (27%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1320** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **203** probes (56%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
|---|---|---|---|
| cancellation | 22 | golden | golden(17), trace_map(16), figure_eight(14), eisenstein(14) |
...
| spacetime_3p1 | 56 | metallic | figure_eight(39), metallic(37), trace_map(35), dickson_tower(35) |
| observable | 6 | firewall | firewall(6), metallic(4), golden(4), eisenstein(3) |
