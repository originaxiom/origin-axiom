...
> Last generated: 2026-07-12 from 500 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 500 frontier probes; status {'banked': 331, 'dead': 106, 'open': 47, 'dormant': 16}
  the ONE conserved first integral: kappa (recurs 135x, 27%) -- genuine unity, MUST recur
  top recurring motifs: firewall(370), golden(315), trace_map(255), metallic(255), eisenstein(250), figure_eight(246)
  recurrence is: structural-invariant 1879 mentions | conserved-integral 135 | TOOL 255
  the honest split: the trace-map TOOL is in 255 probes (51%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
| golden | 315 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| trace_map | 255 | 51% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1879** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **255** probes (51%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| measure | 26 | firewall | firewall(18), golden(16), trace_map(13), figure_eight(11) |
