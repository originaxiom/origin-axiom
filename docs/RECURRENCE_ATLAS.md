...
> Last generated: 2026-08-03 from 787 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 787 frontier probes; status {'banked': 512, 'dead': 201, 'open': 55, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 201x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(493), firewall(484), eisenstein(422), figure_eight(368), metallic(359), trace_map(347)
  recurrence is: structural-invariant 2850 mentions | conserved-integral 201 | TOOL 347
  the honest split: the trace-map TOOL is in 347 probes (44%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 493 | 62% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 484 | 61% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 422 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 368 | 46% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 359 | 45% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 347 | 44% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 283 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 262 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| wrt_quantum | 206 | 26% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 201 | 25% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| z3_generation | 163 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 140 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
| dickson_tower | 105 | 13% | structure | structural | representation | the Dickson tower rho_n / degree=rank / the det=-1 parity |
| symplectic | 95 | 12% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **201** probes (25%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2850** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **347** probes (44%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| measure | 56 | golden | golden(36), firewall(33), eisenstein(26), figure_eight(24) |
| units_scale | 84 | firewall | firewall(61), golden(56), metallic(47), trace_map(42) |
| gauge_dict | 45 | firewall | firewall(29), eisenstein(29), figure_eight(26), golden(25) |
| particle_dict | 57 | eisenstein | eisenstein(46), golden(40), firewall(40), z3_generation(36) |
| spacetime_3p1 | 95 | golden | figure_eight(64), golden(62), eisenstein(54), trace_map(53) |
