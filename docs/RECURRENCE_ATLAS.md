...
> Last generated: 2026-09-09 from 1197 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1197 frontier probes; status {'open': 68, 'banked': 786, 'dead': 319, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 266x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(670), eisenstein(670), firewall(630), figure_eight(511), amphichiral_cp(443), metallic(441)
  recurrence is: structural-invariant 4636 mentions | conserved-integral 266 | TOOL 437
...
| eisenstein | 670 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| closing | 363 | 30% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
| z3_generation | 298 | 24% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4636** mentions — invariants of the object's transforms.
...
| spacetime_3p1 | 139 | eisenstein | eisenstein(83), golden(81), figure_eight(76), trace_map(69) |
