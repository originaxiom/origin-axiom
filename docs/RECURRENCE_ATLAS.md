...
> Last generated: 2026-09-06 from 1181 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1181 frontier probes; status {'open': 67, 'banked': 775, 'dead': 316, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 263x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(659), eisenstein(657), firewall(627), figure_eight(499), amphichiral_cp(435), metallic(434)
  recurrence is: structural-invariant 4542 mentions | conserved-integral 263 | TOOL 427
...
| eisenstein | 657 | 55% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| firewall | 627 | 53% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| figure_eight | 499 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| coupling | 367 | 31% | question | no | physics | the observer/object interface: what the coupling supplies that neither side has alone (the listener map, the pair, the relational bit) |
| torsion | 359 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| closing | 354 | 29% | question | structural | topology | what closing the open object supplies and costs -- Dehn filling, the seam, the constitutive closure (B286/B287/B294) |
...
| z3_generation | 284 | 24% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| monoid | 91 | 7% | question | structural | dynamics | End(F2) beyond the units: the four Hopfian-det strata, the non-invertible verbs the programme has never computed |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4542** mentions — invariants of the object's transforms.
...
| particle_dict | 99 | eisenstein | eisenstein(70), z3_generation(65), firewall(62), golden(61) |
