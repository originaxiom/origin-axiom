...
> Last generated: 2026-08-27 from 1076 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1076 frontier probes; status {'open': 63, 'banked': 718, 'dead': 275, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 240x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(613), firewall(589), eisenstein(581), figure_eight(448), metallic(420), trace_map(401)
  recurrence is: structural-invariant 3558 mentions | conserved-integral 240 | TOOL 401
...
|---|---|---|---|---|---|---|
| golden | 613 | 56% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 589 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 581 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 448 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 420 | 39% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 401 | 37% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| amphichiral_cp | 381 | 35% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| z3_generation | 240 | 22% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3558** mentions — invariants of the object's transforms.
...
| spacetime_3p1 | 126 | eisenstein | eisenstein(75), golden(75), figure_eight(69), trace_map(61) |
