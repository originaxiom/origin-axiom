...
> Last generated: 2026-07-02 from 347 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 347 frontier probes; status {'banked': 235, 'dead': 56, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(228), golden(209), trace_map(200), metallic(190), figure_eight(185), eisenstein(174)
  recurrence is: structural-invariant 1269 mentions | conserved-integral 98 | TOOL 200
...
|---|---|---|---|---|---|---|
| firewall | 228 | 65% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 209 | 60% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| eisenstein | 174 | 50% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| torsion | 93 | 26% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| wrt_quantum | 86 | 24% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
...
| symplectic | 64 | 18% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1269** mentions — invariants of the object's transforms.
...
| observable | 3 | firewall | firewall(3), metallic(2), eisenstein(2), golden(2) |
