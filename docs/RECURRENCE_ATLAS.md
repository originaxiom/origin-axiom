...
> Last generated: 2026-08-02 from 772 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 772 frontier probes; status {'banked': 506, 'dead': 193, 'open': 54, 'dormant': 19}
  the ONE conserved first integral: kappa (recurs 199x, 25%) -- genuine unity, MUST recur
  top recurring motifs: golden(488), firewall(481), eisenstein(412), figure_eight(364), metallic(355), trace_map(342)
  recurrence is: structural-invariant 2805 mentions | conserved-integral 199 | TOOL 342
  the honest split: the trace-map TOOL is in 342 probes (44%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| golden | 488 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 481 | 62% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 412 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 364 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
| metallic | 355 | 45% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| trace_map | 342 | 44% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
| torsion | 282 | 36% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 252 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| wrt_quantum | 205 | 26% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| kappa | 199 | 25% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| z3_generation | 154 | 19% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 132 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Genuine unity:** the one conserved **first integral** `κ = tr[a,b]` recurs in **199** probes (25%). A first integral is *conserved by the trace map ∀m* (K001/K007), so it **must** recur — this recurrence is forced, not chosen.
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2805** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **342** probes (44%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| gauge_dict | 40 | firewall | firewall(29), eisenstein(27), golden(25), figure_eight(25) |
