...
> Last generated: 2026-08-26 from 1066 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1066 frontier probes; status {'open': 63, 'banked': 713, 'dead': 270, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 238x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(608), firewall(581), eisenstein(574), figure_eight(442), metallic(419), trace_map(400)
  recurrence is: structural-invariant 3527 mentions | conserved-integral 238 | TOOL 400
...
|---|---|---|---|---|---|---|
| golden | 608 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 581 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 574 | 53% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 442 | 41% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 374 | 35% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 326 | 30% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
| lorentzian | 194 | 18% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3527** mentions — invariants of the object's transforms.
...
| units_scale | 106 | firewall | firewall(72), golden(65), eisenstein(55), metallic(54) |
