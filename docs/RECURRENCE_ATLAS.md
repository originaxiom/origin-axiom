...
> Last generated: 2026-07-16 from 591 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 591 frontier probes; status {'banked': 401, 'dead': 126, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 166x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(410), golden(376), eisenstein(299), trace_map(286), metallic(286), figure_eight(274)
  recurrence is: structural-invariant 2175 mentions | conserved-integral 166 | TOOL 286
  the honest split: the trace-map TOOL is in 286 probes (48%) = method/selection-effect, NOT unity; only kappa is a forced first integral
...
|---|---|---|---|---|---|---|
| firewall | 410 | 69% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 376 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| eisenstein | 299 | 50% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| trace_map | 286 | 48% | dynamics | tool | dynamics | the trace map / Dehn-twist words / monodromy / substitution -- the METHOD |
...
| torsion | 210 | 35% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
| amphichiral_cp | 197 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 166 | 28% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| wrt_quantum | 151 | 25% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 117 | 19% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
| symplectic | 83 | 14% | structure | structural | geometry | the Goldman symplectic / Neumann-Zagier pairing |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2175** mentions — invariants of the object's transforms.
- **The hammer (selection effect):** the trace-map **tool** appears in **286** probes (48%). This recurrence is *because it is our method* — it is **not** evidence of unity. The atlas keeps this separate on purpose (verify-don't-trust).
...
| units_scale | 71 | firewall | firewall(57), golden(48), metallic(40), trace_map(37) |
...
| observable | 27 | golden | golden(20), torsion(15), firewall(15), metallic(14) |
