...
THE RECURRENCE ATLAS -- context card
  corpus: 1012 frontier probes; status {'open': 66, 'banked': 662, 'dead': 263, 'dormant': 21}
  the ONE conserved first integral: kappa (recurs 231x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(570), firewall(550), eisenstein(529), figure_eight(422), metallic(403), trace_map(379)
  recurrence is: structural-invariant 3333 mentions | conserved-integral 231 | TOOL 379
...
| firewall | 550 | 54% | structure | structural | meta | the firewall / structural theorem / form-not-values |
...
| amphichiral_cp | 334 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| torsion | 320 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3333** mentions — invariants of the object's transforms.
