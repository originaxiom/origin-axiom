...
> Last generated: 2026-07-21 from 676 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 676 frontier probes; status {'banked': 453, 'dead': 158, 'open': 48, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 182x, 26%) -- genuine unity, MUST recur
  top recurring motifs: firewall(458), golden(442), eisenstein(370), metallic(323), figure_eight(320), trace_map(316)
  recurrence is: structural-invariant 2512 mentions | conserved-integral 182 | TOOL 316
...
| eisenstein | 370 | 54% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| metallic | 323 | 47% | structure | structural | arithmetic | the metallic family lambda_m tower (golden/silver/bronze) |
| figure_eight | 320 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2512** mentions — invariants of the object's transforms.
