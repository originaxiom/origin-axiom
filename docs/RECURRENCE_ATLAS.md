...
> Last generated: 2026-08-12 from 964 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 964 frontier probes; status {'open': 62, 'banked': 632, 'dead': 250, 'dormant': 20}
  the ONE conserved first integral: kappa (recurs 230x, 23%) -- genuine unity, MUST recur
  top recurring motifs: golden(551), firewall(545), eisenstein(507), figure_eight(410), metallic(406), trace_map(387)
  recurrence is: structural-invariant 3254 mentions | conserved-integral 230 | TOOL 387
...
|---|---|---|---|---|---|---|
| golden | 551 | 57% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
| firewall | 545 | 56% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| eisenstein | 507 | 52% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
| figure_eight | 410 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| torsion | 308 | 31% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **3254** mentions — invariants of the object's transforms.
