...
> Last generated: 2026-07-18 from 620 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 620 frontier probes; status {'banked': 422, 'dead': 134, 'open': 47, 'dormant': 17}
  the ONE conserved first integral: kappa (recurs 179x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(416), golden(398), eisenstein(321), metallic(308), trace_map(294), figure_eight(281)
  recurrence is: structural-invariant 2284 mentions | conserved-integral 179 | TOOL 294
...
| golden | 398 | 64% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| amphichiral_cp | 208 | 33% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
| kappa | 179 | 28% | invariant | first-integral | dynamics | the conserved commutator trace kappa = tr[a,b] = the Suto invariant |
| wrt_quantum | 159 | 25% | quantum | no | quantum | the WRT / colored-Jones / modular quantum invariants |
| z3_generation | 126 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 110 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2284** mentions — invariants of the object's transforms.
