...
> Last generated: 2026-08-03 from 782 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 782 frontier probes; status {'banked': 509, 'dead': 200, 'open': 54, 'dormant': 19}
  ...
  recurrence is: structural-invariant 2839 mentions | conserved-integral 201 | TOOL 347
...
|---|---|---|---|---|---|---|
| golden | 493 | 63% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| figure_eight | 368 | 47% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 258 | 32% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| z3_generation | 158 | 20% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
| lorentzian | 135 | 17% | physics-bridge | no | physics | the Lorentzian / signature / spacetime bridge |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **2839** mentions — invariants of the object's transforms.
...
| gauge_dict | 42 | firewall | firewall(29), eisenstein(29), figure_eight(26), golden(25) |
