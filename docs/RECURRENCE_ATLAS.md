...
> Last generated: 2026-09-06 from 1165 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1165 frontier probes; status {'open': 67, 'banked': 763, 'dead': 312, 'dormant': 23}
  the ONE conserved first integral: kappa (recurs 260x, 22%) -- genuine unity, MUST recur
  top recurring motifs: golden(650), eisenstein(643), firewall(626), figure_eight(490), metallic(432), trace_map(423)
  recurrence is: structural-invariant 4471 mentions | conserved-integral 260 | TOOL 423
...
| figure_eight | 490 | 42% | object | no | topology | the simplest hyperbolic knot; the carrier object |
...
| amphichiral_cp | 422 | 36% | symmetry | structural | topology | amphichirality / the CP sign +-pi/6 / CS=0 |
...
| z3_generation | 272 | 23% | symmetry | structural | arithmetic | the generation Z/3 (deck / commensurator / omega-circulant) |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4471** mentions — invariants of the object's transforms.
