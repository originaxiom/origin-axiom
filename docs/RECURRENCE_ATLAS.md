...
> Last generated: 2026-09-17 from 1250 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 1250 frontier probes; status {'open': 70, 'banked': 817, 'dead': 339, 'dormant': 24}
  the ONE conserved first integral: kappa (recurs 281x, 22%) -- genuine unity, MUST recur
  top recurring motifs: eisenstein(707), golden(696), firewall(642), figure_eight(548), amphichiral_cp(477), metallic(466)
  recurrence is: structural-invariant 4990 mentions | conserved-integral 281 | TOOL 456
...
|---|---|---|---|---|---|---|
| eisenstein | 707 | 56% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **4990** mentions — invariants of the object's transforms.
