...
> Last generated: 2026-07-02 from 342 frontier probes.
...
THE RECURRENCE ATLAS -- context card
  corpus: 342 frontier probes; status {'banked': 232, 'dead': 54, 'open': 42, 'dormant': 14}
  the ONE conserved first integral: kappa (recurs 98x, 28%) -- genuine unity, MUST recur
  top recurring motifs: firewall(223), golden(208), trace_map(200), metallic(190), figure_eight(185), eisenstein(173)
  recurrence is: structural-invariant 1258 mentions | conserved-integral 98 | TOOL 200
...
|---|---|---|---|---|---|---|
| firewall | 223 | 65% | structure | structural | meta | the firewall / structural theorem / form-not-values |
| golden | 208 | 60% | arithmetic | structural | arithmetic | the golden end: Q(sqrt5), phi, E8, 2I |
...
| eisenstein | 173 | 50% | arithmetic | structural | arithmetic | the Eisenstein end: Q(sqrt-3), omega, E6, 2T |
...
| torsion | 91 | 26% | arithmetic | structural | arithmetic | the (Z/4)^2 congruence torsion / Alexander polynomial |
...
- **Structural invariants** (the two ends, ω, the Dickson parity, …): **1258** mentions — invariants of the object's transforms.
