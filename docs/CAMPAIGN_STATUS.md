...
**LATEST — B1000 (2026-08-09): FOUR SECTORS, FIVE CLOSINGS.** Sealed before compute with the prior *expected to correct B717* — and it did, in one named place. The external inputs deduplicate to **8**: **5 closings** (chirality, the 27-VEV, the anchor, the 4d lift, time) over **4 sectors** — so **B717's four is right for SECTORS, wrong for CLOSINGS: charge is two holes**, and **B963 proves they compete** for τ. **The observer-coupling doctrine survives and sharpens** — every closing external, none internal, no fifth sector. **And 3 imports are OURS** (the 6d type, the filling slope, P5 completeness) — **bridge artifacts, reducible, never attempted**. First quantitative test of the doctrine. **B1001:** the atlas regex was `B\d{1,3}`, so the first four-digit arc was **silently invisible** — caught by `atlas-fresh` the day it landed.
