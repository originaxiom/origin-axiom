...
**LATEST — B1004 (2026-08-09): the B500–B800 sweep found a retracted clause still live in five places.** 260 verdicted arcs in the band (164 PROVED, 86 NEGATIVE, **26 cited nowhere**), and its **most-mentioned arc carries a clause B942 retracted and B957 refuted** — with **two LAW_MAP rows still asserting it, one INHERITING IT AS AN AXIOM**, and B725's own caveat calling *unproved* what is **false**. **B948 had reported superseding the row; it had not.** The sweep was blind because **B967 deliberately left the phrase unregistered** to avoid firing on a correction banner — right intent, wrong effect. Registered; two further hidden instances found; all corrected. **And cc3's catch adopted:** the relay gate was too narrow to see the day's one unadopted artifact — widened, **nine more surfaced, four past threshold**. **THE RULE: an exclusion is a claim, and a claim needs a check — any gate exemption must name what it would cost if wrong.**
