...
**LATEST (2026-09-06, B1293 — SEAT HARVEST: THE SM GROUP IS REACHED, I-14 COLLAPSES TO A POINT, AND MAIN'S B1290 WAS SECOND)**: owner asked for codex — **codex's head is R040 (2026-09-02), already harvested at B1238/B1239, nothing new**. Two *other* seats pushed the same day. **CONFIRMED HERE from structure alone:** fc R65/R68's **120** A₂ and **40** A₂³ subsystems of E₆ (matching 51840/1296); fc R68's labelling `c = (1,0,2,2,0,2)` grading the 27 as **9+9+9** with its θ-flip; and the SM seat's **z_L as an A₁A₅ involution** — a ℤ/2 grading splitting the 27 as **15+12** has centralizer **dim 38 = 3+35**, and `27|SU(2)×SU(6) = (2,6̄)⊕(1,15) = 12+15`, with `78 = 38+40`. **CALIBRATION THAT CHANGES THE CITATION: 9+9+9 occurs in 178 of 728 labellings (24.5%) — the MOST COMMON shape, not a rare one**, so R68's content is the **two-sided ℤ[g]-stability** cutting 40 → 4 → 1, *not* the partition; citing 9+9+9 as the discovery is the E61/E63 misreading. **TWO RESULTS MAIN DID NOT HAVE:** (a) the SM seat's **first vacuum of the programme with the Standard-Model group** — `W = z_L ∘ χ_j` with ⟨N⟩, ⟨ν^c⟩ leaves **su(3)⊕su(2)⊕u(1)_Y** unbroken; (b) fc's **I-14 collapses to a point**, 85 → 40 → 4 → **1**, mirror-invariant — with fc's own fence carried: *it is not exhibited that the physical trinification **is** this subsystem rather than one of the other 39*. **AND THE OBSTRUCTION THAT CAME WITH THEM:** the SM seat's theorem that **every vacuum with three generations of Q, u^c, e^c keeps SU(5) unbroken** — *“two generations of Q and L is the closing's Standard Model”* — scoped by them to the **closed** closing, the chiral one still to be built. **PRIORITY, PLAINLY: fc's R56 derived `net chirality = χ(M,∂⁺M)` — *“zero for a knot”*, *“the record's seven chirality walls are one theorem”* — BEFORE main's B1290**, so B1290/B1291 are independent confirmation and extension, not discovery; B1291 does go strictly further (B1277 §4 lists three candidate ∂⁺M, B1291 proves the general criterion, classifies all **54** involutions, and adds the parity theorem). Recorded so nobody conflates it: fc's **R61** θ is a real structure **on the fibre** (Fix = two arcs), **R62**'s θ = −I is **on the cusp torus** (Fix = 4 isolated points) — different spaces, no contradiction. **No ledger row moves; I-26 untouched.** Gate 5 untouched.
