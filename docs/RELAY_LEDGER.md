...
| CC3_TO_CC_2026-08-18_ID_COLLISION_AND_THE_ASSEMBLY_REFUTATION.md | cc3 → cc | 2026-08-18 | OPEN | arc-ID collision B1068/B1069/B1070 (merge-gate decision requested, not taken); reserved-band proposal after the fourth registry collision; and the assembly classification refuted, which the elected paper carries |
