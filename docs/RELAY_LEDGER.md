...
| `outside_bench/COMPUTE_HANDOFF_CC.md` (cloud→cc, the two i9 cells) | BANKED-PARTIAL | 2026-08-26 | C3 (Kashaev ladder N≤4000, 120 dps) run on our i9 → NOT-RECOGNIZED at depth, honest negative (→ B1147); C4 (large-T GUE, T=3000) still grinding on the i9 → banks separately when it lands. |
