...
3. No absolute machine paths in any script or text (main's path guard rejects harvested files that carry one; a `/home/user/...` line from a seat is red on main today).
