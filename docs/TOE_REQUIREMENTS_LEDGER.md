...
| 2 chirality | the object counts 2 at every fixed locus — **frame attached (2026-09-15, the outside bench's item 2, recomputed here):** the "2" is χ(Fix g) = 1 − s_μ(g) ∈ {0, 2} (B1294/B1295), while the cusp-fixed count \|det(A−I)\| ∈ {0, 4} on one cusp (B1291/B1320): on m004 its multiset over orientation-preserving cusp maps is {0: 2, 4: 2}, max 4, and B1321's "3" on m202 is this second quantity at two cusps (m202 and s959: {0: 4, 1: 8, 3: 8, 4: 4}). The 2 and the 3 are not comparable numbers; the paper's chirality section keeps them apart, this row did not; every closing vector-like; four faces read "2 or nothing" by one theorem (B1227 in four value groups). **Phase 2's chiral-cover test has now been RUN and returned zero**: the multi-cusp index derived and verified (B1333), 38 070 sectors on all 54 chiral covers to degree ten all zero, and the first *proof* of I = 0 on a stated domain (B1334). **Granting chirality as a declared input (B1340) does not complete the programme**: the object's fixed-locus theorem gives \|det(A − I)\| ∈ {0, 4} and 3 never occurs, so C3 is an import, and spending it costs P9 (see rows 6 and 7) while buying one forced shape | B1291, B1294–B1297, B1303, B1305, B1332–B1334, B1340 | B1291, B1294–B1297, B1303, B1305, B1320, B1321 | **wall**: the chirality bit is the observer's unless Phase 2's chiral-cover test finds otherwise |
