...
| R024 | `certificates/r024_lepton_character_datum.py` | both retained height-308 branches place `e^c` and `l` in coarse character zero; their generation-level tail embeddings and B1208's three-way tensor fork remain unresolved | VERIFIED / RELAYED |
