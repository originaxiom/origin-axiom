...
> physical theory. Start with [the audit](reports/physical_bridge_2026_09_05/README.md)
> before using older crossing-significance or blanket dynamics summaries below.

> **Continuation (2026-09-06).** The 14-dimensional cascade algebra is an
> intermediate step: the known two-singlet completion already reduces it to
> the SM's 12-dimensional gauge algebra, conditionally realized in an explicit
...
> **Source-map continuation R11 (2026-09-06).** The marked founding ratio
> now has an [explicit commuting family component](reports/physical_bridge_2026_09_05/FAMILY_ACTION.md)
> in the icosian E8 construction. Its literal left action also rotates E6;
> the factorization is verified for all twenty order-three units. This earns
> an internal algebraic map, not three physical chiral families. The separate
> domain-repaired calculation passes eleven checks; its original failure
> and the non-green combined regression remain documented.
