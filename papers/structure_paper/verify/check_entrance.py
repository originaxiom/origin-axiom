#!/usr/bin/env python3
"""Proposition (the reduction that consumes the arithmetic) -- prop:mod3.

Provenance: written by the adversarial-scrutiny seat against v6 of this paper
(finding M5: the entrance theorem had no runnable artifact). Reproduced and run
in-sandbox here before adoption, not cited: it exercises exactly the generators
this paper exhibits, A = [[1,1],[0,1]] and B = [[1,0],[2,1]].
