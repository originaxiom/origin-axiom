...
(2) THE ARRANGEMENT, OVER Q.  Its companion check_rung_attained.py enumerates the flats at
    ...
    dim C = 4 with dim z(C) = 12 forces |Phi ^ C-perp| = 6 with C-perp two-dimensional; the
    only rank-<=2 root system with 6 roots is A2; and all such subsystems lie in a single
    W-orbit, so the stratification is unique up to conjugacy.  Hence the weights of C on e6
