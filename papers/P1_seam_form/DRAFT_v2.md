...
(Kurlberg–Rudnick), Galois equivariance (Coste–Gannon; Bantay), the even-function class (Cohen;
McCarthy), and the ℚ-class principle (Serre). Against that shelf, our search did not locate: the
explicit 30-value seam form at any composite level; the broken-lattice selection rule with ℚ(√−15)
