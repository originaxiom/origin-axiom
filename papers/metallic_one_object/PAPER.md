...
| twist-knot `SU(3)` ↔ our level-rank `SU(3)₂`? | is the Gang–Yonekura twist-knot `SU(3)` the §4.3 `SU(2)₃↔SU(3)₂` dual? | **[open — mathematics]** a specific, answerable question; the figure-eight is in both the metallic and twist-knot families. |
