# PAPER 2 — The figure-eight knot as the golden cat map:
# a complete instance of the quantum-topology / arithmetic / dynamics trinity

**Status: outline (flagship campaign). The synthesis paper: the cornerstone, the seven-face
dictionary, Gate B, and the walls as correct properties. Every dictionary entry lock-backed.
Phrasing governor binding; frameworks cited (Reid, Hannay–Berry, Kurlberg–Rudnick,
Garoufalidis–Zagier, Morishita).**

## Abstract (draft)

The figure-eight knot 4₁ is the unique object that is simultaneously the mapping torus of the
...
## The seven-face dictionary (Sections 3–5, the core; each lock-backed)
| face | invariant of the golden cat map | lock |
|---|---|---|
...
| L-function | entropy = 4 Reg = 2√5 L(1,χ₅); ζ_H = ζ·L(χ₋₃)L(χ₅)L(χ₋₁₅) | test_b420/b401 |
...
neighborhood (Garoufalidis–Zagier quantum modularity; Morishita arithmetic topology); the
honest boundary — the object is the unique meeting of golden dynamics and Eisenstein
arithmetic, special for mathematics. What a specialist would confirm (novelty of the E₆
variety of 4₁; the torsion-as-dynamical-zeta packaging).
