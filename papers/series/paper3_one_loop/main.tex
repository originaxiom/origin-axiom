...
\textbf{The gap can nevertheless be located exactly, and one route to closing it can be ruled
out.} Taking the ratio of \eqref{eq:symfactor} at $m$ and $m-1$ isolates
