...
\begin{remark}[a recorded disagreement]\label{rem:m12}
An independent count communicated to us reports $2$ primitive classes at $m=12$, where our
enumeration gives $3$. We have not resolved the discrepancy and therefore state
Theorem~\ref{thm:classes} only for $m\le11$. Nothing in this paper depends on $m\ge12$: the
threshold claim concerns the \emph{first} repetition, which occurs at $m=6$, and both counts
agree on $1\le m\le11$. We flag it rather than suppress it.
\end{remark}
