...
We had $|\mathcal{F}|=14$. \textbf{The census contains $111$.} Two criteria must be kept apart, and
conflating them is what produced the error:
\begin{itemize}[leftmargin=1.4em]
\item[\textbf{(A)}] \emph{all} tetrahedra regular ideal (shape $e^{i\pi/3}$) --- \textbf{77}
      members;
\item[\textbf{(B)}] tetrahedron shape field contained in $\Q(\sqrt{-3})$ --- \textbf{111} members.
\end{itemize}
$A\subsetneq B$ strictly: every all-regular manifold has shape field $\Q(\sqrt{-3})$, but $34$
members of $B$ have non-regular shapes, six of them in our original fourteen. \textbf{The
definition this paper uses is (B), so $|\mathcal{F}|=111$} --- eight times what we enumerated.
...
\textbf{One claim survives the enlargement, and gets stronger.} All $111$ members are
...
amphichirality of $\mathcal{F}$ is family-level and strengthened from $14/14$ to $111/111$.
