...
Six of the eleven values --- $12$, $14$, $18$, $30$, $46$ and (trivially) $78$ --- were obtained
in earlier separate computations that share no code with the enumeration here, and all six lie
in the enumerated set. This is a consistency check on the arrangement, not a proof of
exhaustiveness.
\end{remark}
