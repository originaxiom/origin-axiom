...
identified}, and every decomposition our record has produced is annular, which returns zero with no representation theory
entering. We state it as the open question because it is the sharpest form of this section's subject: on a manifold with
torus boundary, where could a non-zero net count come from at all?
...
\noindent\footnotesize All 67 claims below (over 95 claim--record pairs) carry a test lock; 7 additionally
