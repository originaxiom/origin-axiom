...
\]
and $\tfrac{6}{\pi^2}N^3 > 120$ for every $N \ge 6$ (at $N=6$ already $131.3 > 120$), no modulus beyond $5$ can qualify. The two small moduli are disposed of directly: $|\mathrm{SL}(2,\Z/1)| = 1$ and $|\mathrm{SL}(2,\Z/2)| = 6$, neither of which is $24$, $48$ or $120$. So the list $N \in \{3,4,5\}$ is complete, with no case left unexamined. Second, write $\Lambda(m) := m^2+4$. This is the \emph{level} of the metallic grammar
