# TERMINALITY SECTION — OWNER-ELECTED CANDIDATE (placed 2026-09-01)

**Status: CANDIDATE section for P2/P3 integration, placed here by the owner's 2026-09-01
election ("T5, T4 green. act"). PENDING the G1 cell's su(3)+g2 descent outcome** — the
scope correction at the end of this file restricts the theorem's part (ii) quantifier to
the regular-maximal menus until that computation runs; G1's result either extends
