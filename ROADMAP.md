...
> suite** (core + the frontier `B`-probe locks) now spans **~1197 test functions across
> 325 files** as of the B346 frontier (the proven core is unchanged; all growth is
...
`B1–B346`; recent probes in `CHANGELOG.md`; the current frontier in `docs/OPEN_PROBLEMS.md`.
