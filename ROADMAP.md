...
> suite** (core + the frontier `B`-probe locks) now spans **~1208 test functions across
> 327 files** as of the B348 frontier (the proven core is unchanged; all growth is
...
`B1–B348`; recent probes in `CHANGELOG.md`; the current frontier in `docs/OPEN_PROBLEMS.md`.
