...
> suite** (core + the frontier `B`-probe locks) now spans **~1224 test functions across
> 330 files** as of the B351 frontier (the proven core is unchanged; all growth is
...
`B1–B351`; recent probes in `CHANGELOG.md`; the current frontier in `docs/OPEN_PROBLEMS.md`.
