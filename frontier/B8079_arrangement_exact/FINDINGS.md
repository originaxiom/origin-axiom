# B8079 — the rung arrangement EXACT over ℚ: B8078's residue closed, and the 64 Levis deposited
...
B8078 proved the paper's eleven-element rung bound is **tight**, and registered one residue: the
...
**That residue is now closed**, by a construction sharing no code path with B8078.
...
**That profile is exactly what B8078 computed from the charges**, through `ad`-matrices, an exact
...
base change to `K`. So B8078's `(8,16)`-plane cubic being **irreducible over ℚ** and the lattice
