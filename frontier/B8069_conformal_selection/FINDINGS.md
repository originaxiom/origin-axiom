# B8069 — affine isotropy selects a ray: the object fixes a (3,1) conformal structure
...
B8069 shows the metric is determined **up to exactly one positive scale `t`**.
...
- Not connected to the `e₆`/`so(10)` arc (B8068). Whether the conformal structure here and the
