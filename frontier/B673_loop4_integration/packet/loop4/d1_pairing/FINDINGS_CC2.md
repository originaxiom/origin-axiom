...
## ADDENDUM (main-seat extraction from d1_results.json, verified exactly):
THE SOLO RELATION IS A PROPORTIONALITY LAW: l2 = 0 — the relation is
[c_23] + (7983360/13)*omega*[c_34] = 0 (omega = (-1+sqrt(-3))/2), verified
on all 5 basis coords. So {[c_24], [c_34]} are independent and [c_23] is
LOCKED to [c_34] by the ratio -(7983360/13)*omega — the cubic's core value
times the Eisenstein unit. Two of the three solo couplings are one class.
