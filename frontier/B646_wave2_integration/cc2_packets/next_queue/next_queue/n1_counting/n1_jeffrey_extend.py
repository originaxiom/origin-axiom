...
for r in RS:
    ...
    print(f"  kappa = {r} (E6 k = {r - 12}): Z_J = {z.real:+.10f} {z.imag:+.10f}i",
          flush=True)
with open('/Users/dri/oa-seat-cc2/seat-work/next_queue/n1_counting/jeffrey_extension.json',
          'w') as f:
    json.dump({"totals": out, "rows": rows}, f, indent=1)
print("DONE — jeffrey_extension.json written", flush=True)
