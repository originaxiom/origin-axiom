# B914 DRAFT — R2′ the signed skeleton + R3′ the colorless-first ratio table: THE TABLE IS ONE NUMBER — all six normalization-free couplings are EXACTLY EQUAL; the H-unit gauge is the determinant gauge
