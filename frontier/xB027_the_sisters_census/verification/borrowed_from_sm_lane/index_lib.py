# ---------------------------------------------------------------------------
# BORROWED, NOT WRITTEN BY THIS SEAT.
#   source : frontier/B1374_the_class_index_in_the_sm_frame/verification/index_lib.py
#   lane   : <remote>/standard-model-derivation-0qt6ao at 23532539
#   author : seat cc
#   copied verbatim by seat xb for xB027; NOT rewritten, NOT re-derived.
# ---------------------------------------------------------------------------
#!/usr/bin/env python3
