...
- The dimension estimate is not called the exact Hausdorff dimension.
- The gap-label theorem is known mathematics; the probe uses it as a validation
  control (Damanik-Gorodetski-Yessen, `arXiv:1403.7823`).
- The bridge to experiment is not called a falsifiable prediction because the
  coupling is not derived from A1-A6 plus exchange symmetry.
