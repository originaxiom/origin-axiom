# Probe B25 -- Fibonacci spectrum anchor
...
- finite approximants only: no exact Hausdorff-dimension claim;
...
as the figure-eight complete-structure normalization used in the trace-map
campaign, but B18 showed trace-lift functoriality for all invariant surfaces.
The shared `I=1/4` surface is therefore necessary evidence for the bridge, not a
...
Damanik, Gorodetski, and Yessen, *The Fibonacci Hamiltonian*
(`arXiv:1403.7823`).
