...
- `[machine-path]/docs/ERROR_LEDGER.md` local carries **E1–E26 only** — missing **E4a, E27, E28, E29, E30, E31, E32** and the E27 mechanical-sweep note.
- `[machine-path]/WORKING_RULES.md` local is missing the **sub-lemma / law-harvest clause of Rule 10**.
...
- `origin/main:docs/ERROR_LEDGER.md` — 33 classes, E1–E32 (+E4a) — local copy at `[machine-path]/docs/ERROR_LEDGER.md` is **stale (E1–E26)**
...
- `origin/main:WORKING_RULES.md` — 14 binding items; local copy at `[machine-path]/WORKING_RULES.md` is **stale (Rule 10 truncated)**
...
- Relay corpus (working tree, untracked): `[machine-path]/CC_TO_CC3_*.md` and `[machine-path]/CC3_TO_CC_*.md` — 20+ files, 2026-07-22 → 2026-07-29; these carry the cc3-binding cadence, numbering, and gate rules that COMMS_PROTOCOL v1.1 has not yet absorbed.
