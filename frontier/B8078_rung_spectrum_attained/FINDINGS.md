...
evidence was a **sample**: 16 coordinate subsets (B8075) plus 440 random rational directions,
...
enhancement field **is K**, the object's own weight field (B8076 item 1).
...
- the sixteen coordinate subsets **reproduce B8075's exact table** `{12, 30, 78}`
...
- **every rung value independently banked before this arc lies in the enumerated spectrum**:
  12 (B874 §2, B8075), 14 and 18 (B892 via B874's amendment), 30 (B874 §1, B8075), 46 (B866),
