# PREREGISTRATION — B8078 (post-hoc, and labelled as such)

**This arc was NOT preregistered.** It began as an exploratory probe of B8075's rung
...
|---|---|---|
| the sixteen coordinate subsets reproduce `{12, 30, 78}` | the charge build differs from B8075's | **B8075** |
...
| every independently banked rung value lies in the spectrum | the enumeration is incomplete | **B866, B874, B892, B8075** |
...
1. **No headline may be a printed constant** (E843). The eleven values are read out of a
...
4. **No absence without search.** The 46's absence from B8075's sample was a hypothesis; the
