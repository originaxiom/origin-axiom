...
was a SAMPLE: 16 coordinate subsets (B8075) plus 440 random rational directions, giving
...
CORPUS rather than by this file: the sixteen-subset table must reproduce B8075's exact
...
rung value banked by B866/B874/B892/B8075 by other methods must land in the enumerated
...
gate("dim z(C) = 12, reproducing B8075 and B874 sec.2 exactly over Q", len(zC) == 12,
     f"got {len(zC)}")

# B8075's sixteen-coordinate-subset table, reproduced exactly
tab = {}
for k in range(5):
...
gate("B8075's sixteen-subset table reproduced exactly",
...
CROSS = {12: "B874 sec.2, B8075", 14: "B892 (via B874's amendment)", 18: "B892 (same)",
         30: "B874 sec.1, B8075", 46: "B866", 78: "trivially, S=0"}
