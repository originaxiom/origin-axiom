"""VENDORED MODULE (B1102 bank, 2026-08-21) -- the e6 Chevalley bracket/basis the stored
B1098 triple and B1100 tables are expressed in. Source: the paper-lineage branch's
verify module check_charge_bracket.py (sha256 of the original at vendoring: 4f10df9f55bd58bfb814f8b4428ff55bc710d4e49713876797b5c35f5990455f).
Lineage: the paper's e6 -- the same underlying module the cloud handoff's certificates
imported; re-certified IN THIS ARC by verify_27_is_a_rep (all C(78,2) Chevalley pairs,
exact) + the synthetic ideal-split pre-flight + class-size agreement with B1100's
independently-based table. Vendored so the arc is self-contained in-tree; the env
override B1102_CCB_PATH remains for cross-bench comparison runs."""
#!/usr/bin/env python3
"""
