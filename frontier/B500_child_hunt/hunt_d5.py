...
"""B500 — THE CHILD HUNT (depth 4, all-three-verb words). Streamed to hunt_results_d5.txt.
...
OUT = open(os.path.join(HERE, "hunt_results_d5.txt"), "w")
def log(m):
...
log("depth-5 all-three-verb words: %d" % len(words))
for w in words:
    p = (x, y, z)
