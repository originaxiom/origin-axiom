...
unstable at 10 primes) -> extend the CRT modulus. Same census as p7_10.py, TARGETS=prs[10:20]."""
import json, os, sys
import numpy as np
...
for p in TARGETS:
    ...
    json.dump(RES, open(os.path.join(HERE, "singles_1215_p11_20.json"), "w"), indent=1)  # incremental
