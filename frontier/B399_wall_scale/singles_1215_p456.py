...
N, o1 = 1215, 1620
prs = primes_1_mod(4*N, 6, start=3*10**7)
TARGETS = prs[3:6]              # primes 4-6 for the degree-6 reconstruction
pass
RES = {}
for p in TARGETS:
...
import json as J
J.dump(RES, open(os.path.join(HERE, "singles_1215_p456.json"), "w"), indent=1)
