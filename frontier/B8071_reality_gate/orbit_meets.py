#!/usr/bin/env python3
"""B8071b -- does the A2 orbit have REAL POINTS in e6(2)?

B8071 left its headline conditional: *if* A2 meets e6(2), its compact su(3)+su(3)
...
sys.path.insert(0, "frontier/B8071_reality_gate")
...
print("   - if A2 meets p_C for e6(2) characters, B8071's conditional headline is DISCHARGED:")
