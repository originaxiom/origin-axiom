# B8074 — the rank ceiling's hypothesis is load-bearing: nilpotent centralisers reach rank 4
...
- **That the object reaches either orbit.** The ω-covariant purity reading that would place it on
  `2A1` is mod-`p` work in `frontier/B8068_j2t_charge_field/` and is **owed**, not claimed.
- **Which real forms** these orbits and centralisers admit — that is
  `frontier/B8071_reality_gate/`, a separate arc.
