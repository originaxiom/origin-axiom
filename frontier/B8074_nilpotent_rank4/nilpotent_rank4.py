#!/usr/bin/env python3
"""B8074 -- does the rank ceiling cover nilpotents?
...
print("  it is mod-p work in frontier/B8068_j2t_charge_field/ and is OWED, not claimed here.")
print("  Real forms are frontier/B8071_reality_gate/, not this arc.")
...
RESULTS = {
    ...
    "scope": ("scope note on GUT_REQUIREMENTS_LEDGER section D, not a refutation; "
              "object placement on 2A1 is OWED not claimed; real forms are B8071"),
}
