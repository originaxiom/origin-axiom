# B8068 ITEM 1 — the real forms, exhausted: right rank or right chirality, never both

> ## ⚠ ARGUMENT RE-SCOPED 2026-08-17 (B8073) — the conclusion survives, the argument does not
>
...
> `cell20_outer.py`).
>
> **B8073 tested the right object with a τ built and gated properly** — intertwining verified
...
> silently. B8073's own negative is scoped to the family it swept, never to "no conjugation
> exists".
