# B8070 — RETRACTED. The rank descent was an artifact of my own script.
...
2. **Drop the 3-plane and uniqueness fails.** Over the full 5-dimensional charge space on
   ...
   **Three anomaly-free lines, not one.** B8070's own C4 grid enumerated all three families and
