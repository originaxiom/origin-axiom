# B1071 — the reality gate: the compact rank-4 algebra exists in e₆(2), on the orbit the object does not reach
...
`Stab(B)₀ ≅ (SU(3)×SU(3))/ℤ₃`**, and B1068's `cell30` already found `(16,16)` inside `f₄` at 9 of
...
compact `su(3)⊕su(3)` are therefore among them, and B1071's headline is no longer conditional:
