# PREREGISTRATION — B1073: is the object's `su(5)` τ-stable?
...
`A = Stab_{e₆}(e_i, ēbar_j, s) = (dim 34, Killing rank 24)` of `frontier/B1068_j2t_charge_field/`
...
`grep -rn "254" docs/LAW_MAP.md frontier/B1068_j2t_charge_field/*.md` and a read of
`frontier/B1068_j2t_charge_field/CELL_ITEM1_FINDINGS.md`, `PREREG_A_TAU_A.md`,
