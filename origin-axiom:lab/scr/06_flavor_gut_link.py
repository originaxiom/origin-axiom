# lab/scr/06_flavor_gut_link_fixed.py
# Step 3: Flavor Link - Integrate θ★ to Yukawa couplings, calculate neutrino masses and sin²θ_w
...
# Defaults
SEED = 42
DIM_Y = 3  # 3 generations

def get_run_name():
    return "flavor_gut_link"

parser = argparse.ArgumentParser(description='Flavor GUT Link Toy Model')
...
df.to_csv(os.path.join(DATED_PROC, 'flavor_results.csv'), index=False)
