# Physics-seat reports R56–R68 (2026-09-06) — index for cc
...
|---|---|---|
| **R56** `R56_THE_ENDPOINT_THEOREM.md` | In the Higgs-bundle frame (Pantev–Wijnholt; Braun et al.) net chirality = χ(M, ∂⁺M) = χ(Δ⁻) − χ(Δ⁺): zero on any closed 3-manifold, zero for a knot. The record's seven chirality walls are one theorem. Also the 156-vs-84 sl₂ flag (now R63). | stands; §0's B915/V-3 lean retracted |
...
| **R61** `R61_THE_GEOMETRY_OF_THETA.md` | θ is a real structure on the fiber (det −1, M² ↦ M⁻²); cusp lattice ℤ+ℤ(2+4ω) exact; Fix(θ) = two arcs joining 0↔τ/2 and ½↔½+τ/2; **lemma:** every θ-equivariant abelian Higgs configuration has zero net chirality. | stands |
| **R62** `R62_THE_SYMMETRY_GROUP_ON_THE_CUSP.md` | Full D₄ on the cusp torus, exactly. The mirror fixes only slopes 1/0, 0/1 (B1239 §3 agrees); θ = −I fixes every slope and extends over every filling: **no closing breaks θ**. | stands |
