# Read-only Git-content retrieval for R29. Not a physics producer.
...
PATTERN = /codimension.?two|co.?dimension.?2|capacity|defect.{0,30}(Higgs|gauge|moment)|Higgs.{0,30}(defect|brane|locali[sz])|thin.{0,20}(brane|tube|core)|line.{0,20}trace|non.?closable|closability/in
EXTRA_TIPS = %w[
...
abort('Usage: ruby defect_gauge_history_scan.rb NEW_OUTPUT.json') unless ARGV.size == 1
