...
**Canonical questions:** 192

**Registry SHA-256:** `3ecd6b674c2883b2399883e9e72ff2a4beec82bec4ab7600d856e5cb127b5c2a`
...
|---|---:|---|
| `OPEN` | 23 | Registered and typed, but its stated closure test has not yet been executed. |
| `PROVED` | 72 | A type-correct proof or reproducible exact computation establishes the scoped claim. |
| `REFUTED` | 58 | A proof, counterexample, or exact negative computation defeats the scoped claim. |
