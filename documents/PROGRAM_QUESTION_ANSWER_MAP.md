...
**Canonical questions:** 201

**Registry SHA-256:** `deca82c55e4ab9b3453f420f0c6b39967caebf2ba12d8ba81302618ded61be6b`
...
|---|---:|---|
| `OPEN` | 26 | Registered and typed, but its stated closure test has not yet been executed. |
| `PROVED` | 75 | A type-correct proof or reproducible exact computation establishes the scoped claim. |
| `REFUTED` | 61 | A proof, counterexample, or exact negative computation defeats the scoped claim. |
...
| [OA-C0008](#oa-c0008) | `REFUTED` | `spectrum` | Does the native structure provide three physical copies of a chiral 27? | No. B1033 retracts four internal threes; B876 is one vectorlike 16+bar16 pattern; E8 contains (27,3) and (bar27,bar3), and its sole A2 cannot be both electroweak and family. OA-C1126 exactly shows that the selected trinification order-three symmetry cycles three different 9-blocks rather than three gauge-identical copies inside one 27. OA-C1137 records the independent logical failure of using a degree-two trace field to bound multiplicity by two. OA-C1170 now closes the commensurator-Z3 route: its three labels are explicitly intertwined representatives on one carrier, one character-variety point, not three copies. OA-C1171 closes the B632 integer-three reading: H1(M;27)=3 is V(16)+V(8)+V(0), three inequivalent modes; its already-run cell 2 gives an alternating rank-two cup operation with one-dimensional kernel, and the mirror double has count five. The native physical-generation claim remains refuted; the genuinely new compactification/index request is OA-C0009. |
| [OA-C0009](#oa-c0009) | `EXTERNAL_BLOCKER` | `geometry` | Does a native closure have net chiral index N_27-N_bar27=3? | Not yet. Closed doubles have equal 27/bar27 counts; B1084's flat loci intersect on lines; no current 4d Dirac/index functor exists. B632's H1(M;27)=3 does not pay this gate: its three summands have inequivalent principal-SL2 types 16, 8 and 0, cell 2 is an alternating rank-two operation rather than a chiral-family index, and B1036 gives five modes on the mirror double. A new typed compactification/Dirac/index construction is still required. |
...
| [OA-C0012](#oa-c0012) | `CONDITIONAL` | `spectrum` | Given the standard compact embedding and correct vacuum, is the unbroken global group (SU3xSU2xU1)/Z6? | Conditionally. The Z6 kernel is standard and B1080 computes it for chosen cascades; no branch derives the physical compact embedding/vacuum antecedent. OA-C1176 now proves that the full-27 kernel is cyclic Z6 and path-independent at primitive integral hypercharge normalization. OA-C1177 proves that the anomaly and kernel computations consume rather than derive that normalization. The physical global-group row therefore remains CONDITIONAL on the selected embedding, vacuum and primitive charge lattice. |
...
| [OA-C0016](#oa-c0016) | `EXTERNAL_BLOCKER` | `values` | Does the object emit every dimensionless Standard-Model parameter after thresholds and RG running? | Not yet. Natural period searches return negative; sin^2(theta_W)=3/8 is the conditional GUT normalization, not the measured prediction. The outside volume-extended B1137 probe adds vol, vol/pi and vol/zeta_K(2) as independent basis directions and finds 0/18 Standard-Model targets involving a regulator, with the unmodified 0/18 run as control. This is a bounded-height negative, not an all-heights theorem, and the Tier-B/J3(O) regulator-to-physics construction remains absent. B1140 gives a separate structural value-negative: the 64-dimensional complement on the spacetime fork has invariant content zero. B1154 distinguishes arithmetic non-overlap from the independent cohomological up-Yukawa emptiness: these walls support the same structure-versus-values diagnosis, but none supplies a number. B1226 retypes the flat parameter list into pure angles, running couplings, dimensionful values and beta-odd phases. Its only new forward route is bit-valued: OA-C1182 asks whether the Chern-Simons two-torsion class controls physical CP parity. No continuous phase, threshold or RG prediction follows. |
| [OA-C0017](#oa-c0017) | `EXTERNAL_BLOCKER` | `qft` | Does the object uniquely produce four-dimensional spacetime and a gravitational quantum dynamics? | Not yet. B1104 finds no canonical suspension section; filling is nonunique; S=-Vol*sigma is an on-shell value rather than a 4d gravitational action. B1157 and B1165 further classify the infinity-place constructions as generic spectral geometry: no 4d action, propagator or Ward identities are constructed. The exact Ruelle factorization OA-C1104 is mathematics, while OA-C1106--OA-C1108 remain specialist analytic residues. OA-C1132 registers the unrun arithmetic-versus-nonarithmetic ablation and OA-C1135 fences the proposed parity-by-dimension classifier. B1224/B1226 correct the old equivalence: amphichirality implies only two-torsion Chern-Simons, while m004's CS=0 is a contingent verified datum. The identity dS/dk=-CS leaves the selected saddle k-blind but constructs neither a quantum level selector nor four-dimensional gravity. OA-C1184 records the missing complex-CS boundary theory. |
| [OA-C0018](#oa-c0018) | `EMPIRICAL` | `values` | Does the completed theory make a successful unused quantitative prediction? | Empirical evidence only. No current repo value claim satisfies this strict endpoint criterion; several sealed crossings are negative. The only live laboratory signature, the proposed L173 five-versus-six edge differential, is now structurally refuted as distinctive: reversal-closed two-ended detectors must tie, and the odd-window excess is generic across Sturmian controls rather than golden-specific (OA-C1169). |
...
| [OA-C1034](#oa-c1034) | `CONDITIONAL` | `flavor` | Do the exact norm-308 monad and selected C12/Wilson sectors yield evaluated holomorphic up and down/lepton Yukawa cup-product maps with determined ranks and Higgs line? | Conditionally. At the exact height-308 stable bundle candidate, character arithmetic allows Sym2(C3) of dimension 6 and C3 tensor C3 of dimension 9, with no C12 texture zeros. R017 makes the primary up-type proof branch-local: H1(G_Y)=0 kills both matter images and H1(K1)=H2(K1)=0 lifts the Higgs input, so cup-product naturality forces the full 1x1806 map and the Wilson 1x6 slice to rank zero. Hu=C0 is one-dimensional, while B0 is a four-dimensional trivial module leaving an unselected P3 of Hd lines. The down-sector presentation is 33 connecting plus 5 Serre-tail classes and its first physical connecting slice has 18 entries. R026 supplies the exact determinant comparison, R027 the normalized ambient toric top trace, and R028 every chart/frame/orientation convention. R030 reconstructs the actual integral height-308 generators and verifies literal unit identities for the same four Phi components on all 36 charts over GF(1009); proper-image closedness of their global base locus on the projective toric model promotes this to a four-open cover over Q(zeta12). Coverage is therefore no longer conditional on a giant characteristic-zero Bezout printout. R031 exhausts the factor dual-cycle equations, proves the normalized dP6 trace has minimum support four and is homologous to R027's cyclic representative, reducing the product contraction from 384 to 96 four-simplices without changing the functional. What remains is load-bearing: the common-frame determinant/residue map for those 96 simplices, evaluation of the 18 connecting entries, chain-level Serre representatives for the mixed/tail blocks, and the resulting P3 matrix pencil. No down/lepton rank, nonzero entry or Higgs line is yet proved. R031A resolves the C12 action on the four-dimensional Higgs block: in the split ledger B_0=4 chi_0 and the generator acts by I_4. This excludes the primitive cyclotomic scalar reading but leaves P3(C) and the actual cup-product quotient open. |
...
| [OA-C1143](#oa-c1143) | `EXTERNAL_BLOCKER` | `values` | Can a phason-controlled Aubry-Andre-Harper experiment measure the preregistered number of edge modes in a labelled gap well enough to distinguish the predicted counts five and six? | Not yet. B1171 adopts B8146's full-text audit: existing 13--28-waveguide demonstrations provide the phason knob but report qualitative localization, no mode count and no uncertainty or resolution for this observable. The later outside two-ended audit removes the proposed discriminator itself: at reversal-closed windows J H_L J=H_R forces reflection-invariant spectral/localization observables to agree, while a one-ended detector manufactures the former imbalance; the tested odd-index excess is also generic across non-golden slope controls. Thus the commissioned experimental readout still does not exist, and the advertised five-versus-six object prediction is independently refuted under its specified symmetric detector (OA-C1169). |
...
| [OA-C1148](#oa-c1148) | `OPEN` | `flavor` | Can the normalized cyclic or Serre quasi-isomorphism over Q(zeta_12) be constructed exactly and used to evaluate the norm-308 down-type and lepton Yukawa cup products? | Open. B1185 closes only the pairwise distinction among the three suppression mechanisms. Its down-tail handoff names a characteristic-zero comparison T but the required certify_yukawa_down_tail_cech_308.sage load target is absent from the shared record. The outside one-27 calculation exactly finds one SU(2)-epsilon lambda invariant and one SU(3)-delta exotic invariant, and its finite H_d menu makes the down and lepton determinant cuts coincide only at that coefficient-shape level. R024 correctly finds coarse physical character zero for e^c and l/H_d on both retained Wilson branches, while R025 corrects its tail interpretation and proves only the physical one-dimensional pure-tail square zero. R026 then constructs the exact ordered Q(zeta_12) Euler frame, determinant comparison det(G)->L, equivariant phase and sparse local connecting formula; its exact frame minor is -72*zeta_12^2. R027 constructs the exact canonical-weight Cech generator and cyclic dual trace for dP6 and a signed 384-simplex product trace on the actual 36-chart cover of Z=dP6 x dP6, normalized to one on the marked H4(K_Z) generator. R028 pins the exact C12 chart action, all 36 common Laurent frames and the 18-positive/18-negative local orientation census; it proves raw chart monomial = q_(D,sigma)*t^u for every relevant lattice monomial and exposes the prior unordered representative and tautological commutativity checks. B1217 independently verifies R026's determinant core and confirms R027's 384-simplex reduction. B1216 narrows the surviving projective-Higgs fork to one generation-level binary fact: identical internal character assignments make det(Y_e)=det(Y_d), whereas different assignments give an independent cubic. The generalized SU(3) ambient-type theorem does not force this mixed SU(5) product to vanish. The Q(zeta_12) Phi/Bezout payload, characteristic-zero refinement collapse and hypersurface connecting representative delta(ctilde)/f are still required for every connecting entry; the chain-level Serre map is additionally required for tail or mixed entries. No tensor rank, binary-fork outcome or physical normalization follows yet. |
| [OA-C1149](#oa-c1149) | `OPEN` | `dynamics` | Can the continuous Powers weight lambda be placed or selected by an object-native arithmetic or dynamical construction rather than carried as an independent input? | Open. B1191 separates lambda from the sigma anchor but leaves it unplaced. B1192's correctness lens rejects the attempted Q(sqrt(5)) placement: the banked lambda is a free rational/Powers weight and no map ties it to the cat-map field. B1195 GC-22 proves only the narrow BTZ/KMS tautology: choosing a free BTZ mass and inverting q=exp(-2*pi/r_+) at lambda=0.4 reproduces B723's already defined modular period. B1216 then refutes the attempted {II_1,III_1} exhaustion and the associated excluded-by-TYPE argument: the cited reductions were never derived in-repo. What survives is only the textbook fact that Q(sqrt(-3)) has unit rank zero and regulator one, killing that particular regulator route. Lambda has no acceptance gate and is now more honestly underdocumented, not closed. B721 excludes the chosen tracial-core construction, not all possible maps. B1229 proposes rational-boundary KMS periodicity as a candidate finite-label mechanism, but does not compute it. R031B shows that the finite RCFT boundary premise is itself open for the complex PSL(2,C) sector and that rationality alone is not finiteness. Lambda therefore remains OPEN. |
| [OA-C1150](#oa-c1150) | `OPEN` | `vacuum` | Does the surviving projective Higgs-line freedom reduce to already priced finite labels or one normalization, or does it add up to three independent continuous vacuum inputs? | Open. B1193 catches an error in the v0 input floor: the P3 Higgs line is not covered by the earlier multiplicity-one argument. Outside tip bc9d381d sharpens the test: its four Higgs slots have four distinct crystal weights, so the line reduces to a finite menu in that frame unless main's B0 block is torus-isotypic. B1195 GC-25 does not settle that comparison because its rational regular-representation stand-in assumes the action on the actual four-dimensional multiplicity space. B1205 cuts a generic P3 by a determinant cubic only to a surface, while a skew-slice control shows that such a determinant can vanish identically; no actual object tensor was evaluated. B1206/B1208 prove the lambda block is either rank zero or two by full SU(2) invariance and that the one-27 H_d menu has only one canonical functional, so those named routes do not add a cut. R024 shows e^c and l share coarse character zero on both retained branches. R025 corrects the lepton tail equation and kills only its one-dimensional pure-tail square; it leaves the three connecting B_2 directions, all mixed terms and the full GL_4-isotypic Higgs/lepton ambiguity intact. B1216 corrects the A11 tail enumeration by adding the repeated (8,8) channel and reduces the fork to one binary generation-level lookup: SAME internal character assignments force det(Y_e)=det(Y_d) and leave dimension one; DIFFERENT assignments give an independent cubic and dimension zero. B1217 confirms that R026 supplies only component one of the evaluator and that R027's 384-simplex trace is component two. The exact tensor lookup and quotient dimension remain unresolved. Even a future dimension-zero answer is a finite point set, not a unique prediction. B1230's identity-versus-scalar C-2 fork is now resolved by R031A as identity: B_0=4 chi_0, not a cyclotomic rank-one scalar module. The claimed dim_Q=4 versus rank_K=1 alternative was a field error. After complexification the uncut line space remains P3(C). Cardy finiteness cannot reduce it until a typed boundary-state identification and the RCFT applicability row OA-C1184 are established. |
| [OA-C1151](#oa-c1151) | `OPEN` | `gravity` | Does a genuine E6-lattice boundary character identify the stage's sigma normalization with the banked CFT or two-sixes structure and thereby delete sigma as an independent anchor? | Open. B1190 refutes the prior synthesis as a kind error. B1191 exhausts main's q-series fingerprint route and finds its only candidate fails the required kind/positivity map; the outside artifact survey extends that negative across its Habiro, zeta-count, dark-table and coupling holdings. Tip 9915068b constructs the generic level-one E6 lattice source exactly: an Eisenstein rank-three lattice with discriminant group F3, primaries {1,27,27bar}, vacuum opening 1,78,729 and 27 opening 27,378. B1195 GC-23 rules out the tested raw/direct cusp Gram constructions, but its own hostile lens rejects the universal claim: interior, linking or Poincare-Lefschetz pairings can carry cross-cusp terms and were not classified. B1216 converts the missing bridge into a named acceptance gate for the graded AdS3-boundary character chi_partial of T[m004] at c=6: a named module/algebra, the correct q^(h-c/24) prefactor, nonnegative integral coefficients, exact c=6, the Cardy six-versus-one accounting and provenance from the object rather than a coincidental WZW sum. The gate has a nonempty pass branch, but no candidate presently passes it; the boundary linking pairing also remains uncomputed. Sigma is therefore testably externally bounded, not derived. B1228 supplies a named E6_1 candidate but retracts the join: the geometric PSL(2,C) connection is A1-typed while E6 comes from a separate McKay/2T construction. Absence of a level receiver does not force k=1. B1229's RCFT turn is also conditional. R031B verifies Anderson-Moore/Vafa only under a finite RCFT premise, shows rationality is not a finite menu, scopes MMS to its declared class, and separates Gal(Q(zeta3)/Q)=Z2 from the trinification and fusion Z3 data. B1230's four c=6 solutions are exact only in simply-laced integral-level WZW. Sigma=1 and even finite-label status remain OPEN. |
| [OA-C1152](#oa-c1152) | `OPEN` | `framework` | For which heterogeneous grammar partners does simultaneous mirror realization define a nontrivial relational c-class, and does the grammar canonically force one such partner? | Open. B1192 exhibits relational mirror-odd classes for selected heterogeneous pairs, but B1216 removes one of its supporting clauses as MB12-vacuous: every anti-conjugator swaps the reciprocal eigenlines, including mirror-even controls, so that clause discriminates nothing. The proposed norm dichotomy is also refuted. Norm +1 occurs for 30/37 scanned fields; within the same discriminant-12 GL2 class, 22/60 embeddings give DIRECT(det=-1) while 38/60 give TORSOR; and DIRECT(-1) occurs for norm-negative discriminants 13, 15 and 21. A sqrt(2) control never gives DIRECT(-1), so the sign remains field-specific but does not track the advertised unit-norm criterion. B1195's bounded gen_det=-kappa/g^2 pattern remains partial, not a universal theorem. No canonical partner or exhaustive named-action classification is supplied. OA-C1181 isolates the additional unrun comparison between the relational c-class, Chern-Simons two-torsion and a boundary modular-invariant choice. Equal cardinality does not close that comparison. |
| [OA-C1153](#oa-c1153) | `OPEN` | `dynamics` | Do the volume-defined schedule and Chern-Simons or saddle-defined clock represent one coherently normalized time variable on their common domain? | Open. B1197 executes one sharply typed orientation-blind comparison. The selected (1,n) ladder is monotone for 29 rungs, but across the full 78-closing B289 census \|CS\| is not monotone in volume: 15 consecutive-order violations occur and every p>=2 family fails. OA-C1167 records that exact global proposal as REFUTED. Outside memo 130 and B1208 strengthen the negative: signed CS is already two-valued at fixed volume on all 156 mirror-paired rows, and even \|CS\| has a 541-fold spread-to-window witness. B1199 also rejects the proposed reconciliation of additive saddle periods with a multiplicative Reissner--Nordstrom ratio group as a type error. The parent remains open because trajectory selection is an extra premise, the owner's D2 scope choice is still expressly untaken, the alternate saddle clock is not compared and no normalized physical conversion is constructed. A monotone unselected subtrajectory is not a coherent clock theorem. B1224/B1226 show that amphichirality constrains Chern-Simons only to a two-element torsion set and that m004's zero is contingent. This supplies neither a monotone volume clock nor a normalization equating the proposed schedules. |
...
| [OA-C1169](#oa-c1169) | `REFUTED` | `values` | Is the proposed L173 five-versus-six edge-mode differential a distinctive golden/object prediction under a reflection-symmetric two-ended detector? | No. Outside memos 137--145 prove J H_L J=H_R for reversal-closed windows, so reflection-invariant spectral/localization observables agree. The specified two-ended detector gives the exact count 7--7; that number is not asserted for every possible detector or threshold. The earlier imbalance comes from a one-ended near-boundary detector. Odd-Fibonacci-window asymmetries are real boundary defects but recur across tested non-golden slopes. In a 15-slope ensemble the golden excess is not multiplicity-corrected significant (Sidak P=0.241), correlates with window size and is exceeded by log(2) at a smaller window. The distinctive five-versus-six prediction is therefore refuted, while OA-C1143 separately retains the external experimental-readout question. |
| [OA-C1170](#oa-c1170) | `REFUTED` | `spectrum` | Does the intrinsic commensurator order-three operation itself produce three independent, gauge-isomorphic 27-valued matter copies? | No. B323 separates the gauge/trinification order three from the commensurator order three and records that the m004 object symmetry has order eight. B324's explicit Riley matrices are g-conjugate and therefore have identical characters. The independent stdlib certificate verifies the order-three intertwiner on both generators exactly: the character-variety orbit has size one on a two-dimensional carrier; functorial principal composition keeps one 27, not an 81-dimensional sum of three 27s. An explicit direct sum would insert the multiplicity the route was supposed to derive. Gate C therefore closes for the explicit B324 g-conjugation mechanism and for Gate C as drafted; an independently constructed coset/induced multiplicity carrier would be a new mechanism requiring its own row. This does not close OA-C0009, which asks for a genuinely new chiral index. |
| [OA-C1171](#oa-c1171) | `REFUTED` | `spectrum` | Does the integer h1(M;27)=3 in B632 instantiate three physical copies of one chiral matter representation? | No. B632 cell 1 computes H1(M;27)=3 as one class in each of V(16), V(8) and V(0), dimensions 17+9+1: three inequivalent local-system modes, explicitly not three copies. Contrary to outside memo 157's fresh claim that cell 2 is queued and unrun, current main contains the completed same-day cell 2, its two failed controlled runs, repair adjudication and exhaustive 162-descent verifier. The corrected theorem is an alternating map Lambda2 H1 -> H2(M;27*) of rank two with one-dimensional kernel; the invariant line is not a dynamically selected VEV. B1036 independently computes h1(double;27)=5=2+2+1. Thus the B632 route gives real cohomology and a real cup operation, but not three physical generations. Its remaining V-valued-double texture residual cannot retroactively turn three inequivalent solo modes into three copies. |
| [OA-C1172](#oa-c1172) | `OPEN` | `physics_interface` | Is the boundary/gluing theta characteristic selected by the same named spin structure as the B1141 beat-selected holonomy lift? | Open. B1218 correctly closes L57's old T-stability question: B364 proves that T-stability forces neither lift, while B359 and B363 establish pair specificity and two-sidedness. B1218 explicitly does not identify the reposed boundary theta characteristic with B1141's selected three-manifold holonomy sign lift. A boundary theta characteristic, tangent spin structure and internal 2T sign are related objects but not automatically the same affine Z2 element. No typed comparison has run. |
| [OA-C1173](#oa-c1173) | `PROVED` | `framework` | Is the observed h=0 vanishing locus a word property independent of channel and listener, and what mechanism picks the words? | Yes. B1110 F5 already closed L175: six channels spanning the declared listener sectors share the same 28 words among 1364, with separation 5e9 and no borderline case. The 28 are exactly the diagonal-free weld matrices, with maximum diagonal magnitude 1.2e-15 versus at least 0.30 for every other word. B1218 found and repaired the stale OPEN label on a second surface. |
| [OA-C1174](#oa-c1174) | `OPEN` | `dynamics` | Does the complex object invariant admit a Damanik-Gorodetski-type theorem for the limiting non-self-adjoint Fibonacci spectrum? | Open. Outside memo 156 finds the exact full-trace identity I(E-lambda,E,2)=lambda^2+2 and supplies exploratory masks. The exact Codex check narrows both headlines. First, kappa fixes lambda^2, not a sign: on one branch both +w and -w solve it, and the two kappa conjugates give the four-element sign/Galois orbit. Second, every finite approximant used in the mask is {\|x_n(E)\|<=2} for a nonconstant complex polynomial (degrees 21,55,144 at the reported n=6,8,10). The certificate independently reconstructs the recurrence and records the externally checked upstream git-blob identity, reported levels and window; it then gives an exact strict-interior Q(w) witness inside the sampled [-6,6]^2 square at every reported level. Thus the exact windowed lemniscate represented by each sampled mask has nonempty interior; being bounded, the full finite lemniscate has exact planar box dimension 2. Hence the reported sub-two dimensions and zero-interior statement are under-resolution artifacts for the finite approximants, and the same-modulus genericity verdict is not established. The limiting intersection may still be fractal, but no convergence/topology theorem was supplied. Gate D remains open. |
| [OA-C1175](#oa-c1175) | `PROVED` | `framework` | After the banked A2, hypercharge-orbit and spin-lift resolutions, which discrete inputs remain free in the current structural ledger? | Yes. The 2026-08-30 main repair removes about 8.5 phantom bits. B1112 makes A2 the unique projective SM-compatible landing; B1109 reduces 18 hypercharge directions to two nine-element orbits and B1118 identifies their residual orbit bit with P rather than a new input; B1141 selects the spin lift and B1145 closes SP-2. On the declared post-B1145 internal ledger the remaining discrete freedom is exactly {C,P}, two relational bits. Continuous/external items still remain--basepoint, phason intercept, four-dimensional suspension/filling, scale, chirality/QFT realization and vacuum data. OA-C1172's boundary theta-characteristic comparison and OA-C1140's Pin-image comparison are explicitly outside this internal ledger until typed; neither may be silently counted as paid by B1141. This is a scoped accounting theorem, not parameter-free TOE closure. B1224/B1226 expose a Chern-Simons two-torsion bit, while B1229 proposes a modular-invariant interpretation. Neither is silently identified with the ledger's C bit: OA-C1181 records that comparison and OA-C1182 records the downstream CP-parity bridge. Until either map is proved, the scoped post-B1145 internal census remains {C,P} and the new labels are untyped candidate interpretations rather than extra paid bits. |
| [OA-C1176](#oa-c1176) | `PROVED` | `spectrum` | At primitive integral hypercharge normalization, is the kernel of the Standard-Model algebra action on the full 27 cyclic Z6 independently of whether the descent path passes through SU(5)? | Yes. B1221 enumerates the center action on 16+10+1 and obtains a cyclic kernel of order six; the 16 and 10 separately also give order six, while adjoint-only and integer-charge controls give different orders. SU(5) occurs nowhere in the computation, so the representation-theoretic kernel is path-independent. The theorem explicitly assumes primitive integral y=6Y normalization; OA-C1177 records that this normalization is not derived by the anomaly or kernel calculation. |
| [OA-C1177](#oa-c1177) | `REFUTED` | `spectrum` | Do the anomaly-ratio equations and B1221 representation-kernel computation themselves determine the primitive integral normalization y=6Y rather than assume it? | No. The anomaly equations are homogeneous in the abelian charge and therefore determine ratios only. B1221 explicitly inserts y=6Y before computing the kernel. Its addendum checks rescalings and finds kernel orders 6,12,18,24,36 and 72; order six occurs exactly for rescalings coprime to six. Thus the computation consumes primitivity rather than deriving it. This refutes only the anomaly-plus-kernel route; OA-C1118 retains the broader question of a new object-native charge-lattice selector. |
| [OA-C1178](#oa-c1178) | `REFUTED` | `framework` | Are all named object vanishings and freedom-ledger entries consequences of one universal canonicity-or-symmetry obstruction law? | No. B1224 correctly retracts B1222's H1-torsion population test because H1 torsion was not an observable predicted by the thesis. That invalid test is not used here. The universal quantifier is nevertheless refuted by B1222's surviving exact counterexamples: the regulator-one result follows from imaginary-quadratic unit rank zero; the h=0 locus is a diagonal-free word property; designer-freedom zero is meta-accounting; and ell and sigma are missing data rather than broken symmetries. The observed 7/10 and 6/10 tendency remains real, while OA-C1180 records the valid narrower mirror-odd theorem. |
| [OA-C1179](#oa-c1179) | `REFUTED` | `arithmetic` | Does the discriminant-6237 S3 extension act faithfully on the three quadratic faces in the programme's V4, thereby realizing the semidirect-product triality action of D4? | No. The cubic discriminant is 6237=3^4*7*11, so the unique quadratic subfield of its S3 Galois closure is Q(sqrt(77)). This is not one of Q(sqrt(-3)), Q(sqrt(5)) or Q(sqrt(-15)), the three nontrivial subfields of the face V4. Hence the S3 closure and V4 extension intersect trivially, their compositum has direct-product Galois group V4 times S3, and the induced action on the face V4 is trivial. D4 triality requires the faithful semidirect product V4 semidirect S3. |
| [OA-C1180](#oa-c1180) | `PROVED` | `geometry` | Does amphichirality force the Chern-Simons invariant into the two-torsion set {0,1/4} modulo 1/2 rather than force it to vanish? | Yes. For an amphichiral M and mirror-odd isometry invariant I valued in an abelian group A, self-isometry gives I(M)=-I(M), hence 2I(M)=0. For Chern-Simons in R/(1/2 Z), this gives exactly {0,1/4}. B1224 verifies all six amphichiral manifolds in its census: m004, m136 and m206 lie at zero, while m003, m135 and m207 lie at one quarter. B1226 separately shows that neither amphichiral implies CS=0 nor CS=0 implies amphichiral. |
| [OA-C1181](#oa-c1181) | `OPEN` | `framework` | Are the Chern-Simons two-torsion choice, the programme's surviving conjugation bit C, and the diagonal-versus-charge-conjugate modular-invariant choice canonically the same Z2 datum? | Open. OA-C1180 proves only that Chern-Simons has a two-torsion target. OA-C1175 counts C as a surviving internal relational bit, while B1229 proposes that C is the diagonal-versus-charge-conjugate modular-invariant choice. Equality of cardinality and the shared word 'conjugation' are not comparison maps. R031B additionally shows that no finite RCFT boundary has been established for the actual complex-CS sector, so even the modular-invariant receiver is presently absent. |
| [OA-C1182](#oa-c1182) | `OPEN` | `values` | Does the m004 Chern-Simons two-torsion datum determine whether a named four-dimensional Standard-Model CP phase lies at a CP-even point, without claiming its continuous magnitude? | Open. B1226 shows that B1027, B1137 and B813 all asked continuous-value questions of a bit-valued channel; those negative verdicts remain valid for their stated value dictionaries. The newly type-matched bit question was registered but not run. B303's internal sign statement does not supply a four-dimensional EFT, a normalized theta or mixing-phase map, or an identification among the three physical CP sectors. |
| [OA-C1183](#oa-c1183) | `PROVED` | `vacuum` | In the certified split C12 character ledger B=3 Reg_C12+chi_0+chi_11, is B_0 equal to four copies of chi_0 with identity generator action rather than a rank-one cyclotomic scalar module? | Yes. R031A reads the certified ledger as B_0=4 chi_0, so the marked generator is I_4 and its characteristic polynomial is (t-1)^4. A rational rank-one Q(zeta_12) scalar module instead has characteristic polynomial Phi_12(t)=t^4-t^2+1 and splits as chi_1+chi_5+chi_7+chi_11. The alternatives are inequivalent. R017 does not select a canonical descent field; after physical complexification the line space remains P3(C), of complex dimension three. |
| [OA-C1184](#oa-c1184) | `OPEN` | `qft` | Does the geometric complex PSL(2,C) Chern-Simons sector associated with m004 admit a finite rational boundary CFT or modular datum to which Anderson-Moore, Vafa, MMS and Cardy classification results apply? | Open. Anderson-Moore and Vafa prove rationality consequences from finite RCFT modular data; they do not prove that this m004 sector is rational. Witten's complex-gauge-group quantization has infinite-dimensional physical Hilbert spaces and leaves the related 1+1-dimensional CFT unclear. R031B therefore finds the applicability premise absent. Even granting rationality gives sigma in Q, which is infinite and dense, not a finite menu. MMS is scoped to the two-character Wronskian-index-zero problem; B1230's exact four c=6 solutions are exhaustive only inside simply-laced positive-integral-level WZW. The trace-field, trinification and fusion Z3 data also lack a typed map. |
...
- **Question:** Does the discriminant-6237 S3 extension act faithfully on the three quadratic faces in the programme's V4, thereby realizing the semidirect-product triality action of D4?
- **Answer:** No. The cubic discriminant is 6237=3^4*7*11, so the unique quadratic subfield of its S3 Galois closure is Q(sqrt(77)). This is not one of Q(sqrt(-3)), Q(sqrt(5)) or Q(sqrt(-15)), the three nontrivial subfields of the face V4. Hence the S3 closure and V4 extension intersect trivially, their compositum has direct-product Galois group V4 times S3, and the induced action on the face V4 is trivial. D4 triality requires the faithful semidirect product V4 semidirect S3.
- **Kind/domain:** `comparison` / `arithmetic`
- **Depends on:** [OA-C1099](#oa-c1099)
- **Leads to:** None.
- **Closure test:** Construct the Galois action and show that the S3 quotient faithfully permutes the three nontrivial V4 subfields as D4 triality requires.
- **Falsifier:** Arithmetic disjointness giving V4 times S3 with trivial action on the faces refutes the proposed triality correspondence.
- **Scope:** The proposed arithmetic realization using exactly the banked face V4 and discriminant-6237 cubic. It does not dispute the abstract group isomorphisms or the separately constructed D4/triality algebra.
- **Aliases:** `B1223`, `V4/S3 triality correspondence`, `D4 arithmetic automorphism claim`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1223_triality_correspondence/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1223_triality_correspondence/FINDINGS.md)
- **Deepest artifacts:** None registered.
...
- **Sources:** [`../evidence/WAVE6_BRANCH_DELTA_AUDIT.md`](program-question-map/evidence/WAVE6_BRANCH_DELTA_AUDIT.md), [`https://github.com/originaxiom/origin-axiom/blob/0f1c627e5c290439e4f6eeb3723fb5d9f83195d7/docs/GRAND_COMPUTATION_v0.md`](https://github.com/originaxiom/origin-axiom/blob/0f1c627e5c290439e4f6eeb3723fb5d9f83195d7/docs/GRAND_COMPUTATION_v0.md), [`https://github.com/originaxiom/origin-axiom/blob/40916c36ddeb1eb1631097b3535c6a79a2658e23/frontier/B1195_close_loop_batch5a/verification/batch5a_cells.json`](https://github.com/originaxiom/origin-axiom/blob/40916c36ddeb1eb1631097b3535c6a79a2658e23/frontier/B1195_close_loop_batch5a/verification/batch5a_cells.json), [`https://github.com/originaxiom/origin-axiom/blob/d23b237f/frontier/B1216_parameter_closure_run1/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/d23b237f/frontier/B1216_parameter_closure_run1/FINDINGS.md)
- **Deepest artifacts:** None registered.
...
- **Question:** Does the complex object invariant admit a Damanik-Gorodetski-type theorem for the limiting non-self-adjoint Fibonacci spectrum?
- **Answer:** Open. Outside memo 156 finds the exact full-trace identity I(E-lambda,E,2)=lambda^2+2 and supplies exploratory masks. The exact Codex check narrows both headlines. First, kappa fixes lambda^2, not a sign: on one branch both +w and -w solve it, and the two kappa conjugates give the four-element sign/Galois orbit. Second, every finite approximant used in the mask is {|x_n(E)|<=2} for a nonconstant complex polynomial (degrees 21,55,144 at the reported n=6,8,10). The certificate independently reconstructs the recurrence and records the externally checked upstream git-blob identity, reported levels and window; it then gives an exact strict-interior Q(w) witness inside the sampled [-6,6]^2 square at every reported level. Thus the exact windowed lemniscate represented by each sampled mask has nonempty interior; being bounded, the full finite lemniscate has exact planar box dimension 2. Hence the reported sub-two dimensions and zero-interior statement are under-resolution artifacts for the finite approximants, and the same-modulus genericity verdict is not established. The limiting intersection may still be fractal, but no convergence/topology theorem was supplied. Gate D remains open.
- **Kind/domain:** `theorem` / `dynamics`
- **Depends on:** [OA-C0003](#oa-c0003)
- **Leads to:** None.
- **Closure test:** Define the limiting complex spectrum/invariant set, prove its nonempty topology and hyperbolic/fractal properties with convergence from controlled approximants, and state the dependence on the full Galois/sign orbit.
- **Falsifier:** Interior in the limiting set, collapse/emptiness, failure of convergence, or a same-modulus theorem showing no claimed object-specific property refutes the corresponding strong claim.
- **Scope:** The complex full-trace Fibonacci recurrence. The exact critique refutes the finite-approximant fractal inference, not the possibility of a fractal limiting non-self-adjoint spectrum.
- **Aliases:** `Gate D`, `complex kappa Fibonacci spectrum`, `non-Hermitian Damanik-Gorodetski`, `outside memo 156`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/941b60e0baeda1bce91f3535b3a298c98f7121e0/outside_bench/memos/GATE_D_FIRST_NUMERICS.md`](https://github.com/originaxiom/origin-axiom/blob/941b60e0baeda1bce91f3535b3a298c98f7121e0/outside_bench/memos/GATE_D_FIRST_NUMERICS.md), [`https://github.com/originaxiom/origin-axiom/blob/941b60e0baeda1bce91f3535b3a298c98f7121e0/outside_bench/certificates/gate_d_numerics.py`](https://github.com/originaxiom/origin-axiom/blob/941b60e0baeda1bce91f3535b3a298c98f7121e0/outside_bench/certificates/gate_d_numerics.py)
- **Deepest artifacts:** [`../../../certificates/r029_upstream_hostile_corrections.py`](../certificates/r029_upstream_hostile_corrections.py), [`../../../outputs/r029_upstream_hostile_corrections.txt`](../outputs/r029_upstream_hostile_corrections.txt)
...
- **Leads to:** [OA-C0015](#oa-c0015), [OA-C1054](#oa-c1054), [OA-C1055](#oa-c1055), [OA-C1148](#oa-c1148), [OA-C1183](#oa-c1183)
...
- **Sources:** [`../../../memos/YUKAWA_CUP_PRODUCTS_308.md`](../memos/YUKAWA_CUP_PRODUCTS_308.md), [`../../../memos/YUKAWA_EXACT_SPECTRUM_NO_GO.md`](../memos/YUKAWA_EXACT_SPECTRUM_NO_GO.md), [`../../../memos/YUKAWA_PRIMARY_PROVENANCE.md`](../memos/YUKAWA_PRIMARY_PROVENANCE.md), [`../../../memos/YUKAWA_DETERMINANT_FRAME_308.md`](../memos/YUKAWA_DETERMINANT_FRAME_308.md), [`../../../memos/YUKAWA_TORIC_TOP_TRACE_308.md`](../memos/YUKAWA_TORIC_TOP_TRACE_308.md), [`../../../memos/YUKAWA_TORIC_CHART_FRAMES_308.md`](../memos/YUKAWA_TORIC_CHART_FRAMES_308.md), [`../../../memos/YUKAWA_PHI_COVER_SPECIALIZATION_308.md`](../memos/YUKAWA_PHI_COVER_SPECIALIZATION_308.md), [`../../../memos/YUKAWA_SPARSE_TORIC_TRACE_308.md`](../memos/YUKAWA_SPARSE_TORIC_TRACE_308.md), [`../evidence/WAVE5_BRANCH_DELTA_AUDIT.md`](program-question-map/evidence/WAVE5_BRANCH_DELTA_AUDIT.md)
- **Deepest artifacts:** [`../../../certificates/r017_yukawa_primary/verify_yukawa_cup_product_308_scope.py`](../certificates/r017_yukawa_primary/verify_yukawa_cup_product_308_scope.py), [`../../../certificates/r017_yukawa_primary/verify_yukawa_exact_spectrum_no_go.py`](../certificates/r017_yukawa_primary/verify_yukawa_exact_spectrum_no_go.py), [`../../../certificates/r026_yukawa_determinant_frame/determinant_frame.py`](../certificates/r026_yukawa_determinant_frame/determinant_frame.py), [`../../../certificates/r027_toric_top_trace/toric_top_trace.py`](../certificates/r027_toric_top_trace/toric_top_trace.py), [`../../../certificates/r028_toric_chart_frames/toric_chart_frames.py`](../certificates/r028_toric_chart_frames/toric_chart_frames.py), [`../../../certificates/r030_phi_cover_specialization/phi_cover_specialization.py`](../certificates/r030_phi_cover_specialization/phi_cover_specialization.py), [`../../../certificates/r030_phi_cover_specialization/r030_mod1009_cover_all36.json.gz`](../certificates/r030_phi_cover_specialization/r030_mod1009_cover_all36.json.gz), [`../../../certificates/r031_sparse_toric_trace/sparse_toric_trace.py`](../certificates/r031_sparse_toric_trace/sparse_toric_trace.py)
...
- **Answer:** Open. B1192 exhibits relational mirror-odd classes for selected heterogeneous pairs, but B1216 removes one of its supporting clauses as MB12-vacuous: every anti-conjugator swaps the reciprocal eigenlines, including mirror-even controls, so that clause discriminates nothing. The proposed norm dichotomy is also refuted. Norm +1 occurs for 30/37 scanned fields; within the same discriminant-12 GL2 class, 22/60 embeddings give DIRECT(det=-1) while 38/60 give TORSOR; and DIRECT(-1) occurs for norm-negative discriminants 13, 15 and 21. A sqrt(2) control never gives DIRECT(-1), so the sign remains field-specific but does not track the advertised unit-norm criterion. B1195's bounded gen_det=-kappa/g^2 pattern remains partial, not a universal theorem. No canonical partner or exhaustive named-action classification is supplied. OA-C1181 isolates the additional unrun comparison between the relational c-class, Chern-Simons two-torsion and a boundary modular-invariant choice. Equal cardinality does not close that comparison.
- **Kind/domain:** `classification` / `framework`
- **Depends on:** [OA-C1124](#oa-c1124), [OA-C1135](#oa-c1135)
- **Leads to:** [OA-C1181](#oa-c1181)
...
- **Question:** Is the observed h=0 vanishing locus a word property independent of channel and listener, and what mechanism picks the words?
- **Answer:** Yes. B1110 F5 already closed L175: six channels spanning the declared listener sectors share the same 28 words among 1364, with separation 5e9 and no borderline case. The 28 are exactly the diagonal-free weld matrices, with maximum diagonal magnitude 1.2e-15 versus at least 0.30 for every other word. B1218 found and repaired the stale OPEN label on a second surface.
- **Kind/domain:** `theorem` / `framework`
- **Depends on:** None.
- **Leads to:** None.
- **Closure test:** Show identical vanishing words across every declared listener sector with a separated exact or controlled numerical mechanism.
- **Falsifier:** A channel-dependent word set, a borderline classification, or a vanishing word with a nonzero diagonal refutes the claim.
- **Scope:** The B1110 finite word/listener census and its diagonal-free mechanism, not an unrestricted theorem over all word lengths.
- **Aliases:** `L175`, `h=0 locus`, `diagonal-free weld words`, `B1110 F5`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1110_spectral_cluster/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1110_spectral_cluster/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1110_spectral_cluster/arc_verdict.json`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1110_spectral_cluster/arc_verdict.json), [`https://github.com/originaxiom/origin-axiom/blob/c0e9a4a0033d9777e8ad1141315fba70e3f19e2f/frontier/B1218_open_claim_sweep/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/c0e9a4a0033d9777e8ad1141315fba70e3f19e2f/frontier/B1218_open_claim_sweep/FINDINGS.md)
- **Deepest artifacts:** [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1110_spectral_cluster/b1110_orbitswap_locus.py`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1110_spectral_cluster/b1110_orbitswap_locus.py), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1110_spectral_cluster/b1110_results.json`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1110_spectral_cluster/b1110_results.json)

<a id="oa-c1175"></a>
### OA-C1175 — `PROVED`

- **Question:** After the banked A2, hypercharge-orbit and spin-lift resolutions, which discrete inputs remain free in the current structural ledger?
- **Answer:** Yes. The 2026-08-30 main repair removes about 8.5 phantom bits. B1112 makes A2 the unique projective SM-compatible landing; B1109 reduces 18 hypercharge directions to two nine-element orbits and B1118 identifies their residual orbit bit with P rather than a new input; B1141 selects the spin lift and B1145 closes SP-2. On the declared post-B1145 internal ledger the remaining discrete freedom is exactly {C,P}, two relational bits. Continuous/external items still remain--basepoint, phason intercept, four-dimensional suspension/filling, scale, chirality/QFT realization and vacuum data. OA-C1172's boundary theta-characteristic comparison and OA-C1140's Pin-image comparison are explicitly outside this internal ledger until typed; neither may be silently counted as paid by B1141. This is a scoped accounting theorem, not parameter-free TOE closure. B1224/B1226 expose a Chern-Simons two-torsion bit, while B1229 proposes a modular-invariant interpretation. Neither is silently identified with the ledger's C bit: OA-C1181 records that comparison and OA-C1182 records the downstream CP-parity bridge. Until either map is proved, the scoped post-B1145 internal census remains {C,P} and the new labels are untyped candidate interpretations rather than extra paid bits.
- **Kind/domain:** `accounting` / `framework`
- **Depends on:** [OA-C1056](#oa-c1056)
- **Leads to:** [OA-C1181](#oa-c1181), [OA-C1182](#oa-c1182)
- **Closure test:** Reconcile every live freedom surface against the banked selectors without double-counting orbit labels or already-selected lifts.
- **Falsifier:** A live unresolved discrete label not equivalent to C or P, or a banked selector for either C or P, changes the census.
- **Scope:** The repository's declared post-B1145 internal discrete freedom ledger. It excludes unresolved boundary-theta and tangent-Pin comparison torsors (OA-C1172/OA-C1140) and does not erase the listed continuous or external physical inputs.
- **Aliases:** `B1218 freedom ledger`, `discrete input census`, `C and P bits`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/5ec66cf0bf1e6c3bee5e24c62c853aeaecb8871d/docs/THE_ROAD.md`](https://github.com/originaxiom/origin-axiom/blob/5ec66cf0bf1e6c3bee5e24c62c853aeaecb8871d/docs/THE_ROAD.md), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1109_selection_cluster/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1109_selection_cluster/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1112_projective_hatch/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1112_projective_hatch/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1118_deflation/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1118_deflation/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1141_spin_payment/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1141_spin_payment/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1145_sp2_fermion_seat/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1145_sp2_fermion_seat/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/c0e9a4a0033d9777e8ad1141315fba70e3f19e2f/frontier/B1218_open_claim_sweep/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/c0e9a4a0033d9777e8ad1141315fba70e3f19e2f/frontier/B1218_open_claim_sweep/FINDINGS.md)
- **Deepest artifacts:** [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1109_selection_cluster/b1109_selection.py`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1109_selection_cluster/b1109_selection.py), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1112_projective_hatch/parity_sweep.py`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1112_projective_hatch/parity_sweep.py), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1118_deflation/hyper_orbits_out.txt`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1118_deflation/hyper_orbits_out.txt), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1141_spin_payment/verification/verify_spin_payment.py`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1141_spin_payment/verification/verify_spin_payment.py), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1145_sp2_fermion_seat/verification/sp2_independent.py`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B1145_sp2_fermion_seat/verification/sp2_independent.py)

<a id="oa-c1178"></a>
### OA-C1178 — `REFUTED`

- **Question:** Are all named object vanishings and freedom-ledger entries consequences of one universal canonicity-or-symmetry obstruction law?
- **Answer:** No. B1224 correctly retracts B1222's H1-torsion population test because H1 torsion was not an observable predicted by the thesis. That invalid test is not used here. The universal quantifier is nevertheless refuted by B1222's surviving exact counterexamples: the regulator-one result follows from imaginary-quadratic unit rank zero; the h=0 locus is a diagonal-free word property; designer-freedom zero is meta-accounting; and ell and sigma are missing data rather than broken symmetries. The observed 7/10 and 6/10 tendency remains real, while OA-C1180 records the valid narrower mirror-odd theorem.
- **Kind/domain:** `theorem` / `framework`
- **Depends on:** None.
- **Leads to:** [OA-C1180](#oa-c1180)
- **Closure test:** Type every named vanishing and freedom row as the consequence of one declared symmetry action, with no counterexample and with a discriminating test on an observable predicted by the thesis.
- **Falsifier:** One named vanishing caused by a nonsymmetry theorem, or one freedom row that is missing data rather than a broken orbit, refutes the universal claim.
- **Scope:** The universal explanatory thesis over B1222's named census. Individual symmetry implications and narrower classes remain valid on their own hypotheses.
- **Aliases:** `B1222`, `selection is the obstruction`, `universal symmetry-vanishing thesis`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1222_symmetry_vanishing_thesis/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1222_symmetry_vanishing_thesis/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1222_symmetry_vanishing_thesis/ADDENDUM_2026-08-31_the_decisive_test_was_invalid.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1222_symmetry_vanishing_thesis/ADDENDUM_2026-08-31_the_decisive_test_was_invalid.md), [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1224_amphichiral_cs_torsion/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1224_amphichiral_cs_torsion/FINDINGS.md)
- **Deepest artifacts:** None registered.

<a id="oa-c1181"></a>
### OA-C1181 — `OPEN`

- **Question:** Are the Chern-Simons two-torsion choice, the programme's surviving conjugation bit C, and the diagonal-versus-charge-conjugate modular-invariant choice canonically the same Z2 datum?
- **Answer:** Open. OA-C1180 proves only that Chern-Simons has a two-torsion target. OA-C1175 counts C as a surviving internal relational bit, while B1229 proposes that C is the diagonal-versus-charge-conjugate modular-invariant choice. Equality of cardinality and the shared word 'conjugation' are not comparison maps. R031B additionally shows that no finite RCFT boundary has been established for the actual complex-CS sector, so even the modular-invariant receiver is presently absent.
- **Kind/domain:** `comparison` / `framework`
- **Depends on:** [OA-C1152](#oa-c1152), [OA-C1175](#oa-c1175), [OA-C1180](#oa-c1180), [OA-C1184](#oa-c1184)
- **Leads to:** [OA-C1182](#oa-c1182)
- **Closure test:** Place the three two-point sets in one typed construction and exhibit equivariant comparison maps respecting their named involutions and physical roles.
- **Falsifier:** Different transformation laws, independent choices, absence of the required boundary RCFT, or a comparison depending on an external convention refutes canonical identity.
- **Scope:** A typed identification among three proposed Z2 torsors. It does not identify any continuous CP phase or supply a four-dimensional chiral theory.
- **Aliases:** `CS bit versus c-bit`, `B1229 modular-invariant bit`, `three Z2 comparison`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1224_amphichiral_cs_torsion/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1224_amphichiral_cs_torsion/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1229_the_consistency_turn/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1229_the_consistency_turn/FINDINGS.md), [`../../../memos/RCFT_CONSISTENCY_SCOPE.md`](../memos/RCFT_CONSISTENCY_SCOPE.md)
- **Deepest artifacts:** None registered.
...
- **Leads to:** [OA-C1135](#oa-c1135), [OA-C1180](#oa-c1180), [OA-C1181](#oa-c1181)
...
- **Question:** Does amphichirality force the Chern-Simons invariant into the two-torsion set {0,1/4} modulo 1/2 rather than force it to vanish?
- **Answer:** Yes. For an amphichiral M and mirror-odd isometry invariant I valued in an abelian group A, self-isometry gives I(M)=-I(M), hence 2I(M)=0. For Chern-Simons in R/(1/2 Z), this gives exactly {0,1/4}. B1224 verifies all six amphichiral manifolds in its census: m004, m136 and m206 lie at zero, while m003, m135 and m207 lie at one quarter. B1226 separately shows that neither amphichiral implies CS=0 nor CS=0 implies amphichiral.
- **Kind/domain:** `theorem` / `geometry`
- **Depends on:** [OA-C1124](#oa-c1124)
- **Leads to:** [OA-C1181](#oa-c1181), [OA-C1182](#oa-c1182)
- **Closure test:** Prove the mirror-odd invariant identity in its exact value group and verify that both torsion values occur with controlled examples.
- **Falsifier:** An amphichiral example outside the two-torsion subgroup, or a convention in which the stated value group and sign law fail, refutes the scoped theorem.
- **Scope:** Chern-Simons in the stated normalization and the general mirror-odd value-group implication. It supplies a two-element set, not a canonical choice, Standard-Model CP datum, time variable or physical scale.
- **Aliases:** `B1224`, `B1227`, `amphichiral CS two-torsion`, `mirror-odd value-group law`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1224_amphichiral_cs_torsion/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1224_amphichiral_cs_torsion/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1226_the_beta_odd_box/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1226_the_beta_odd_box/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1227_one_theorem_two_regimes/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1227_one_theorem_two_regimes/FINDINGS.md)
- **Deepest artifacts:** [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1224_amphichiral_cs_torsion/kappa_cs.py`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1224_amphichiral_cs_torsion/kappa_cs.py), [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1227_one_theorem_two_regimes/two_regimes.py`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1227_one_theorem_two_regimes/two_regimes.py)
...
- **Depends on:** [OA-C0017](#oa-c0017), [OA-C1184](#oa-c1184)
- **Leads to:** [OA-C1181](#oa-c1181), [OA-C1184](#oa-c1184)
...
- **Aliases:** `L154`, `sigma deletion bridge`, `E6 boundary character`, `B1228`, `B1229`, `B1230`, `R031B`
...
- **Question:** Is the boundary/gluing theta characteristic selected by the same named spin structure as the B1141 beat-selected holonomy lift?
- **Answer:** Open. B1218 correctly closes L57's old T-stability question: B364 proves that T-stability forces neither lift, while B359 and B363 establish pair specificity and two-sidedness. B1218 explicitly does not identify the reposed boundary theta characteristic with B1141's selected three-manifold holonomy sign lift. A boundary theta characteristic, tangent spin structure and internal 2T sign are related objects but not automatically the same affine Z2 element. No typed comparison has run.
- **Kind/domain:** `comparison` / `physics_interface`
- **Depends on:** [OA-C1056](#oa-c1056)
- **Leads to:** None.
- **Closure test:** Construct the boundary theta line and the three-manifold spin torsor in one convention, compute restriction/gluing, and identify the selected affine elements.
- **Falsifier:** Selection of the opposite theta characteristic, or a proof that the two torsors admit no canonical comparison, refutes the proposed identification.
- **Scope:** The precise boundary-theta/three-manifold-spin comparison. It does not by itself construct a four-dimensional fermion index.
- **Aliases:** `L57 reposed`, `theta characteristic versus beat spin`, `B364`, `B1141`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B359_seam_form/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B359_seam_form/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B363_seam_lift_anatomy/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B363_seam_lift_anatomy/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B364_theta_polarization/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B364_theta_polarization/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/c0e9a4a0033d9777e8ad1141315fba70e3f19e2f/frontier/B1218_open_claim_sweep/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/c0e9a4a0033d9777e8ad1141315fba70e3f19e2f/frontier/B1218_open_claim_sweep/FINDINGS.md)
- **Deepest artifacts:** [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B359_seam_form/seam_form.py`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B359_seam_form/seam_form.py), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B363_seam_lift_anatomy/lift_torus.py`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B363_seam_lift_anatomy/lift_torus.py), [`https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B364_theta_polarization/theta_geometric.py`](https://github.com/originaxiom/origin-axiom/blob/4cc38d8a60aa93c85bca7157df008766e3f2861b/frontier/B364_theta_polarization/theta_geometric.py)
...
- **Kind/domain:** `construction` / `qft`
- **Depends on:** [OA-C0003](#oa-c0003)
- **Leads to:** [OA-C0007](#oa-c0007), [OA-C1062](#oa-c1062), [OA-C1106](#oa-c1106), [OA-C1107](#oa-c1107), [OA-C1108](#oa-c1108), [OA-C1120](#oa-c1120), [OA-C1132](#oa-c1132), [OA-C1135](#oa-c1135), [OA-C1149](#oa-c1149), [OA-C1153](#oa-c1153), [OA-C1157](#oa-c1157), [OA-C1160](#oa-c1160), [OA-C1184](#oa-c1184)
...
- **Question:** Does the geometric complex PSL(2,C) Chern-Simons sector associated with m004 admit a finite rational boundary CFT or modular datum to which Anderson-Moore, Vafa, MMS and Cardy classification results apply?
- **Answer:** Open. Anderson-Moore and Vafa prove rationality consequences from finite RCFT modular data; they do not prove that this m004 sector is rational. Witten's complex-gauge-group quantization has infinite-dimensional physical Hilbert spaces and leaves the related 1+1-dimensional CFT unclear. R031B therefore finds the applicability premise absent. Even granting rationality gives sigma in Q, which is infinite and dense, not a finite menu. MMS is scoped to the two-character Wronskian-index-zero problem; B1230's exact four c=6 solutions are exhaustive only inside simply-laced positive-integral-level WZW. The trace-field, trinification and fusion Z3 data also lack a typed map.
- **Kind/domain:** `existence` / `qft`
- **Depends on:** [OA-C0017](#oa-c0017)
- **Leads to:** [OA-C1149](#oa-c1149), [OA-C1150](#oa-c1150), [OA-C1151](#oa-c1151), [OA-C1181](#oa-c1181)
- **Closure test:** Construct the actual boundary state space or chiral algebra for the declared m004 complex-CS sector, prove finite modular factorization and rationality, and identify the sector and normalization entering c=6 sigma.
- **Falsifier:** A theorem that the relevant state space is intrinsically infinite/nonrational or admits no such boundary CFT refutes this route; compact integral-level CS/WZW evidence alone does not pass.
- **Scope:** The actual noncompact complex-CS m004 setup, not compact Chern-Simons theory at integral level. Success would establish an admissible receiver, not by itself select sigma, E6, a Higgs state or lambda.
- **Aliases:** `R031B`, `m004 complex-CS RCFT applicability`, `B1229 rational-boundary premise`, `Q11`
- **Sources:** [`../../../memos/RCFT_CONSISTENCY_SCOPE.md`](../memos/RCFT_CONSISTENCY_SCOPE.md), [`../../../CODEX_TO_CC_2026-09-01_B1229_B1230_RCFT_SCOPE.md`](../CODEX_TO_CC_2026-09-01_B1229_B1230_RCFT_SCOPE.md), [`https://doi.org/10.1007/BF02099116`](https://doi.org/10.1007/BF02099116), [`https://doi.org/10.1007/BF01223375`](https://doi.org/10.1007/BF01223375), [`https://doi.org/10.1016/0370-2693(88)91765-0`](https://doi.org/10.1016/0370-2693(88)91765-0)
- **Deepest artifacts:** [`../../../certificates/r031b_rcft_scope/rcft_scope.py`](../certificates/r031b_rcft_scope/rcft_scope.py), [`../../../outputs/r031b_rcft_scope.txt`](../outputs/r031b_rcft_scope.txt)
...
- **Leads to:** [OA-C0015](#oa-c0015), [OA-C1034](#oa-c1034), [OA-C1126](#oa-c1126), [OA-C1137](#oa-c1137), [OA-C1155](#oa-c1155), [OA-C1170](#oa-c1170), [OA-C1171](#oa-c1171)
...
- **Aliases:** `three generations`, `B876`, `B1033`, `E8 family A2`, `Gate C`, `B632 cohomological multiplicity`
- **Sources:** None registered.
- **Deepest artifacts:** None registered.
...
- **Answer:** Conditionally. The Z6 kernel is standard and B1080 computes it for chosen cascades; no branch derives the physical compact embedding/vacuum antecedent. OA-C1176 now proves that the full-27 kernel is cyclic Z6 and path-independent at primitive integral hypercharge normalization. OA-C1177 proves that the anomaly and kernel computations consume rather than derive that normalization. The physical global-group row therefore remains CONDITIONAL on the selected embedding, vacuum and primitive charge lattice.
- **Kind/domain:** `theorem` / `spectrum`
- **Depends on:** [OA-C0011](#oa-c0011), [OA-C0013](#oa-c0013), [OA-C1176](#oa-c1176)
- **Leads to:** [OA-C0014](#oa-c0014), [OA-C1176](#oa-c1176), [OA-C1177](#oa-c1177)
...
- **Leads to:** [OA-C0012](#oa-c0012), [OA-C1177](#oa-c1177)
...
- **Kind/domain:** `computation` / `spectrum`
- **Depends on:** [OA-C0013](#oa-c0013), [OA-C1112](#oa-c1112)
- **Leads to:** [OA-C1118](#oa-c1118), [OA-C1177](#oa-c1177)
...
- **Question:** Does the intrinsic commensurator order-three operation itself produce three independent, gauge-isomorphic 27-valued matter copies?
- **Answer:** No. B323 separates the gauge/trinification order three from the commensurator order three and records that the m004 object symmetry has order eight. B324's explicit Riley matrices are g-conjugate and therefore have identical characters. The independent stdlib certificate verifies the order-three intertwiner on both generators exactly: the character-variety orbit has size one on a two-dimensional carrier; functorial principal composition keeps one 27, not an 81-dimensional sum of three 27s. An explicit direct sum would insert the multiplicity the route was supposed to derive. Gate C therefore closes for the explicit B324 g-conjugation mechanism and for Gate C as drafted; an independently constructed coset/induced multiplicity carrier would be a new mechanism requiring its own row. This does not close OA-C0009, which asks for a genuinely new chiral index.
- **Kind/domain:** `theorem` / `spectrum`
- **Depends on:** [OA-C0008](#oa-c0008)
- **Leads to:** [OA-C0009](#oa-c0009), [OA-C1171](#oa-c1171)
- **Closure test:** Construct three independent zero-mode carriers or a direct-sum multiplicity-three local system, not three conjugate presentations of one representation.
- **Falsifier:** An exact invertible intertwiner identifying all three labelled representations on one carrier, together with absence of an internal object order three, refutes the claimed replication mechanism.
- **Scope:** The explicit commensurator-conjugation construction on the m004 Riley representation and every functorial principal image without an added multiplicity space. It does not universally exclude a separately constructed induced/coset carrier or an unrelated compactification/index mechanism.
- **Aliases:** `Gate C`, `commensurator Z3 generations`, `B323`, `B324`, `outside memo 157`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/89affd5bbd4b900397af2bf3b987ff8f05f5cb80/frontier/B323_four_levels_adjudication/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/89affd5bbd4b900397af2bf3b987ff8f05f5cb80/frontier/B323_four_levels_adjudication/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/89affd5bbd4b900397af2bf3b987ff8f05f5cb80/frontier/B324_omega_circulant_verified/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/89affd5bbd4b900397af2bf3b987ff8f05f5cb80/frontier/B324_omega_circulant_verified/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/941b60e0baeda1bce91f3535b3a298c98f7121e0/outside_bench/memos/GATE_C_ADJUDICATION.md`](https://github.com/originaxiom/origin-axiom/blob/941b60e0baeda1bce91f3535b3a298c98f7121e0/outside_bench/memos/GATE_C_ADJUDICATION.md)
- **Deepest artifacts:** [`../../../certificates/r029_upstream_hostile_corrections.py`](../certificates/r029_upstream_hostile_corrections.py), [`../../../outputs/r029_upstream_hostile_corrections.txt`](../outputs/r029_upstream_hostile_corrections.txt)

<a id="oa-c1171"></a>
### OA-C1171 — `REFUTED`

- **Question:** Does the integer h1(M;27)=3 in B632 instantiate three physical copies of one chiral matter representation?
- **Answer:** No. B632 cell 1 computes H1(M;27)=3 as one class in each of V(16), V(8) and V(0), dimensions 17+9+1: three inequivalent local-system modes, explicitly not three copies. Contrary to outside memo 157's fresh claim that cell 2 is queued and unrun, current main contains the completed same-day cell 2, its two failed controlled runs, repair adjudication and exhaustive 162-descent verifier. The corrected theorem is an alternating map Lambda2 H1 -> H2(M;27*) of rank two with one-dimensional kernel; the invariant line is not a dynamically selected VEV. B1036 independently computes h1(double;27)=5=2+2+1. Thus the B632 route gives real cohomology and a real cup operation, but not three physical generations. Its remaining V-valued-double texture residual cannot retroactively turn three inequivalent solo modes into three copies.
- **Kind/domain:** `typing` / `spectrum`
- **Depends on:** [OA-C0008](#oa-c0008), [OA-C1170](#oa-c1170)
- **Leads to:** [OA-C0009](#oa-c0009)
- **Closure test:** Exhibit three gauge-isomorphic chiral zero-mode copies with a signed four-dimensional index, rather than three inequivalent local-system summands.
- **Falsifier:** Different principal-SL2 types, a non-family cup-operation type, or failure of the count under the canonical double refutes the three-copy reading.
- **Scope:** The principal-SL2 m004 local system and its canonical mirror double. The mathematical cohomology is retained; only the physical three-copy interpretation is refuted.
- **Aliases:** `B632 H1=3`, `cohomological generation count`, `B632 cell 2`, `B1036 mirror double`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/89affd5bbd4b900397af2bf3b987ff8f05f5cb80/frontier/B632_cubic_route/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/89affd5bbd4b900397af2bf3b987ff8f05f5cb80/frontier/B632_cubic_route/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/89affd5bbd4b900397af2bf3b987ff8f05f5cb80/frontier/B632_cubic_route/REPAIR_ADJUDICATION.md`](https://github.com/originaxiom/origin-axiom/blob/89affd5bbd4b900397af2bf3b987ff8f05f5cb80/frontier/B632_cubic_route/REPAIR_ADJUDICATION.md), [`https://github.com/originaxiom/origin-axiom/blob/89affd5bbd4b900397af2bf3b987ff8f05f5cb80/frontier/B1036_mirror_double/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/89affd5bbd4b900397af2bf3b987ff8f05f5cb80/frontier/B1036_mirror_double/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/941b60e0baeda1bce91f3535b3a298c98f7121e0/outside_bench/memos/GATE_C_ADJUDICATION.md`](https://github.com/originaxiom/origin-axiom/blob/941b60e0baeda1bce91f3535b3a298c98f7121e0/outside_bench/memos/GATE_C_ADJUDICATION.md)
- **Deepest artifacts:** None registered.

<a id="oa-c1176"></a>
### OA-C1176 — `PROVED`

- **Question:** At primitive integral hypercharge normalization, is the kernel of the Standard-Model algebra action on the full 27 cyclic Z6 independently of whether the descent path passes through SU(5)?
- **Answer:** Yes. B1221 enumerates the center action on 16+10+1 and obtains a cyclic kernel of order six; the 16 and 10 separately also give order six, while adjoint-only and integer-charge controls give different orders. SU(5) occurs nowhere in the computation, so the representation-theoretic kernel is path-independent. The theorem explicitly assumes primitive integral y=6Y normalization; OA-C1177 records that this normalization is not derived by the anomaly or kernel calculation.
- **Kind/domain:** `computation` / `spectrum`
- **Depends on:** [OA-C1121](#oa-c1121)
- **Leads to:** [OA-C0012](#oa-c0012), [OA-C1177](#oa-c1177)
- **Closure test:** Enumerate the center of SU(3) times SU(2) times U(1) on every 27 component at primitive integral normalization and prove that the kernel is cyclic of order six without using an SU(5) embedding.
- **Falsifier:** A noncyclic kernel, an order different from six, or essential use of an SU(5) path refutes path-independent Z6.
- **Scope:** The standard 27 roster at an imposed primitive integral hypercharge normalization. It proves a representation kernel, not object-selection of the physical hypercharge lattice, compact gauge theory, or vacuum.
- **Aliases:** `B1221`, `path-independent Z6 kernel`, `27 global-form kernel`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1221_global_form_path_independence/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1221_global_form_path_independence/FINDINGS.md), [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1221_global_form_path_independence/ADDENDUM_2026-08-31_the_Z6_needs_primitivity.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1221_global_form_path_independence/ADDENDUM_2026-08-31_the_Z6_needs_primitivity.md)
- **Deepest artifacts:** [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1221_global_form_path_independence/kernel_27.py`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1221_global_form_path_independence/kernel_27.py)

<a id="oa-c1177"></a>
### OA-C1177 — `REFUTED`

- **Question:** Do the anomaly-ratio equations and B1221 representation-kernel computation themselves determine the primitive integral normalization y=6Y rather than assume it?
- **Answer:** No. The anomaly equations are homogeneous in the abelian charge and therefore determine ratios only. B1221 explicitly inserts y=6Y before computing the kernel. Its addendum checks rescalings and finds kernel orders 6,12,18,24,36 and 72; order six occurs exactly for rescalings coprime to six. Thus the computation consumes primitivity rather than deriving it. This refutes only the anomaly-plus-kernel route; OA-C1118 retains the broader question of a new object-native charge-lattice selector.
- **Kind/domain:** `implication` / `spectrum`
- **Depends on:** [OA-C1121](#oa-c1121), [OA-C1176](#oa-c1176)
- **Leads to:** [OA-C1118](#oa-c1118)
- **Closure test:** Derive a unique primitive charge lattice or normalization from the stated anomaly and kernel equations without inserting y=6Y or an equivalent convention.
- **Falsifier:** A homogeneous rescaling family preserving the anomaly equations, with different kernel orders after nonunit rescaling, refutes intrinsic normalization by this route.
- **Scope:** The anomaly-ratio and representation-kernel mechanisms actually run. It does not prove that no different arithmetic or global charge-lattice construction could fix normalization.
- **Aliases:** `B1221 primitivity addendum`, `hypercharge normalization wall`, `homogeneous anomaly scale`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1221_global_form_path_independence/ADDENDUM_2026-08-31_the_Z6_needs_primitivity.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1221_global_form_path_independence/ADDENDUM_2026-08-31_the_Z6_needs_primitivity.md), [`../../../memos/HYPERCHARGE_TRINIFICATION_SCOPE.md`](../memos/HYPERCHARGE_TRINIFICATION_SCOPE.md)
- **Deepest artifacts:** [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1221_global_form_path_independence/kernel_27.py`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1221_global_form_path_independence/kernel_27.py)
...
- **Leads to:** [OA-C0014](#oa-c0014), [OA-C1183](#oa-c1183)
...
- **Question:** In the certified split C12 character ledger B=3 Reg_C12+chi_0+chi_11, is B_0 equal to four copies of chi_0 with identity generator action rather than a rank-one cyclotomic scalar module?
- **Answer:** Yes. R031A reads the certified ledger as B_0=4 chi_0, so the marked generator is I_4 and its characteristic polynomial is (t-1)^4. A rational rank-one Q(zeta_12) scalar module instead has characteristic polynomial Phi_12(t)=t^4-t^2+1 and splits as chi_1+chi_5+chi_7+chi_11. The alternatives are inequivalent. R017 does not select a canonical descent field; after physical complexification the line space remains P3(C), of complex dimension three.
- **Kind/domain:** `computation` / `vacuum`
- **Depends on:** [OA-C1034](#oa-c1034)
- **Leads to:** [OA-C1150](#oa-c1150)
- **Closure test:** Recover the exact multiplicity vector and distinguish the two candidate modules by their split characters and rational characteristic polynomials.
- **Falsifier:** A primitive-root action on B_0, a cyclotomic characteristic polynomial Phi_12, or split multiplicities chi_1+chi_5+chi_7+chi_11 refutes the identity branch.
- **Scope:** The conditional R017 split-character ledger and its actual four-dimensional B_0 block. It does not select a Higgs line, prove the stable-spectrum antecedent, or determine physical Yukawa coefficients.
- **Aliases:** `R031A`, `B1230 C-2`, `B0 C12 character`, `identity-versus-scalar fork`
- **Sources:** [`../../../memos/B0_CHARACTER_BASE_FIELD.md`](../memos/B0_CHARACTER_BASE_FIELD.md), [`../../../CODEX_TO_CC_2026-09-01_C2_B0_CHARACTER_FIELD.md`](../CODEX_TO_CC_2026-09-01_C2_B0_CHARACTER_FIELD.md)
- **Deepest artifacts:** [`../../../certificates/r031a_b0_character_field/b0_character_field.py`](../certificates/r031a_b0_character_field/b0_character_field.py), [`../../../outputs/r031a_b0_character_field.txt`](../outputs/r031a_b0_character_field.txt)
...
- **Leads to:** [OA-C0018](#oa-c0018), [OA-C1158](#oa-c1158), [OA-C1161](#oa-c1161), [OA-C1182](#oa-c1182)
...
- **Answer:** Empirical evidence only. No current repo value claim satisfies this strict endpoint criterion; several sealed crossings are negative. The only live laboratory signature, the proposed L173 five-versus-six edge differential, is now structurally refuted as distinctive: reversal-closed two-ended detectors must tie, and the odd-window excess is generic across Sturmian controls rather than golden-specific (OA-C1169).
...
- **Sources:** [`../evidence/WAVE6_BRANCH_DELTA_AUDIT.md`](program-question-map/evidence/WAVE6_BRANCH_DELTA_AUDIT.md), [`https://github.com/originaxiom/origin-axiom/blob/72ace1cf91abae1be356b17e947c08894f255a8b/docs/EDGE_PREREG_SPEC_ADDENDUM_B8146.md`](https://github.com/originaxiom/origin-axiom/blob/72ace1cf91abae1be356b17e947c08894f255a8b/docs/EDGE_PREREG_SPEC_ADDENDUM_B8146.md), [`https://github.com/originaxiom/origin-axiom/blob/d4b4940464cfd3a564900a5b952ccda0527f648b/outside_bench/THE_LAST_CHAIN.md`](https://github.com/originaxiom/origin-axiom/blob/d4b4940464cfd3a564900a5b952ccda0527f648b/outside_bench/THE_LAST_CHAIN.md)
- **Deepest artifacts:** None registered.
...
- **Question:** Is the proposed L173 five-versus-six edge-mode differential a distinctive golden/object prediction under a reflection-symmetric two-ended detector?
- **Answer:** No. Outside memos 137--145 prove J H_L J=H_R for reversal-closed windows, so reflection-invariant spectral/localization observables agree. The specified two-ended detector gives the exact count 7--7; that number is not asserted for every possible detector or threshold. The earlier imbalance comes from a one-ended near-boundary detector. Odd-Fibonacci-window asymmetries are real boundary defects but recur across tested non-golden slopes. In a 15-slope ensemble the golden excess is not multiplicity-corrected significant (Sidak P=0.241), correlates with window size and is exceeded by log(2) at a smaller window. The distinctive five-versus-six prediction is therefore refuted, while OA-C1143 separately retains the external experimental-readout question.
- **Kind/domain:** `theorem` / `values`
- **Depends on:** [OA-C1143](#oa-c1143)
- **Leads to:** None.
- **Closure test:** Define the left and right finite Hamiltonians and one two-ended reflection-symmetric detector, then prove a stable unequal count that survives reversal, window parity and non-golden Sturmian controls.
- **Falsifier:** A conjugacy forcing equal reflection-invariant spectral/localization observables at reversal-closed windows, or the same excess across unrelated Sturmian slopes, refutes distinctive golden content.
- **Scope:** The finite L173/Sturmian analogue and the stated symmetric detector. It does not refute all possible edge observables or provide a Standard-Model prediction.
- **Aliases:** `outside L173 last-chain`, `five-versus-six edge differential`, `reversal-closed detector`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/d4b4940464cfd3a564900a5b952ccda0527f648b/outside_bench/THE_LAST_CHAIN.md`](https://github.com/originaxiom/origin-axiom/blob/d4b4940464cfd3a564900a5b952ccda0527f648b/outside_bench/THE_LAST_CHAIN.md), [`https://github.com/originaxiom/origin-axiom/blob/d4b4940464cfd3a564900a5b952ccda0527f648b/outside_bench/memos/REVERSAL_FORCES_SYMMETRY.md`](https://github.com/originaxiom/origin-axiom/blob/d4b4940464cfd3a564900a5b952ccda0527f648b/outside_bench/memos/REVERSAL_FORCES_SYMMETRY.md), [`https://github.com/originaxiom/origin-axiom/blob/d4b4940464cfd3a564900a5b952ccda0527f648b/outside_bench/memos/GOLDEN_EXCESS_ENSEMBLE.md`](https://github.com/originaxiom/origin-axiom/blob/d4b4940464cfd3a564900a5b952ccda0527f648b/outside_bench/memos/GOLDEN_EXCESS_ENSEMBLE.md)
- **Deepest artifacts:** None registered.

<a id="oa-c1182"></a>
### OA-C1182 — `OPEN`

- **Question:** Does the m004 Chern-Simons two-torsion datum determine whether a named four-dimensional Standard-Model CP phase lies at a CP-even point, without claiming its continuous magnitude?
- **Answer:** Open. B1226 shows that B1027, B1137 and B813 all asked continuous-value questions of a bit-valued channel; those negative verdicts remain valid for their stated value dictionaries. The newly type-matched bit question was registered but not run. B303's internal sign statement does not supply a four-dimensional EFT, a normalized theta or mixing-phase map, or an identification among the three physical CP sectors.
- **Kind/domain:** `comparison` / `values`
- **Depends on:** [OA-C0017](#oa-c0017), [OA-C1180](#oa-c1180)
- **Leads to:** [OA-C0016](#oa-c0016)
- **Closure test:** Construct a four-dimensional EFT/QFT map from the normalized Chern-Simons class to the CP-parity of theta_QCD, delta_CKM or delta_PMNS and prove its invariance under conventions and field redefinitions.
- **Falsifier:** Independence of the physical CP parity from the Chern-Simons class, opposite assignments in equivalent realizations, or absence of a typed four-dimensional map refutes the proposed identification.
- **Scope:** The CP-even-versus-CP-odd status of a named physical phase, not its measured angle. It remains downstream of the absent four-dimensional realization.
- **Aliases:** `B1226 CP-conservation bit`, `beta-odd box`, `CS-to-SM CP parity`
- **Sources:** [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1226_the_beta_odd_box/FINDINGS.md`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1226_the_beta_odd_box/FINDINGS.md)
- **Deepest artifacts:** [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1226_the_beta_odd_box/cell3_type_mismatch.py`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1226_the_beta_odd_box/cell3_type_mismatch.py), [`https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1226_the_beta_odd_box/cell3_results.json`](https://github.com/originaxiom/origin-axiom/blob/6ea67db72ae51efaf2024cd6903702491e17d105/frontier/B1226_the_beta_odd_box/cell3_results.json)
