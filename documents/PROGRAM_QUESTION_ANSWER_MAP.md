...
**Registry SHA-256:** `c05f7c071f18e529994bc1375dddf1e1db15448ec6fe38e4c5cf6caaabd9a9ba`
...
| [OA-C1169](#oa-c1169) | `REFUTED` | `values` | Is the proposed L173 five-versus-six edge-mode differential a distinctive golden/object prediction under a reflection-symmetric two-ended detector? | No. Outside memos 137--145 prove J H_L J=H_R for reversal-closed windows, so every reflection-symmetric two-ended spectral/localization detector ties; the exact count is 7--7. The earlier imbalance comes from a one-ended near-boundary detector. Odd-Fibonacci-window asymmetries are real boundary defects but recur for silver, bronze, log(2), e-2 and pi-3 slopes. In a 15-slope ensemble the golden excess is not multiplicity-corrected significant (Sidak P=0.241), correlates with window size and is exceeded by log(2) at a smaller window. The distinctive five-versus-six prediction is therefore refuted, while OA-C1143 separately retains the external experimental-readout question. |
...
- **Answer:** No. Outside memos 137--145 prove J H_L J=H_R for reversal-closed windows, so every reflection-symmetric two-ended spectral/localization detector ties; the exact count is 7--7. The earlier imbalance comes from a one-ended near-boundary detector. Odd-Fibonacci-window asymmetries are real boundary defects but recur for silver, bronze, log(2), e-2 and pi-3 slopes. In a 15-slope ensemble the golden excess is not multiplicity-corrected significant (Sidak P=0.241), correlates with window size and is exceeded by log(2) at a smaller window. The distinctive five-versus-six prediction is therefore refuted, while OA-C1143 separately retains the external experimental-readout question.
- **Kind/domain:** `theorem` / `values`
...
- **Falsifier:** A conjugacy forcing equal detector spectra/counts at reversal-closed windows, or the same excess across unrelated Sturmian slopes, refutes distinctive golden content.
