...
|---|---|---|---|
| S001 | amphichirality → θ=0 in `T[4₁]` (not 4d QCD; about `φ₁²`; `m=1`-uniqueness UNVERIFIED) | SUPPORTED + pending | B67, B71 |
...
| S006 | Bell/CHSH on the Fricke surface (blocker: trace↔correlator id, NOT tractability) | HELD(value-matching) | — |
...
| S012 | θ=−w₀ predicts the Dehn-filling c-values (FEEDS ρ_n) | ACTIVE | B62, B106 |
